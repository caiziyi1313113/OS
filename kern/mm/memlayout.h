...
struct Page {
    ...
    // --- for SLUB ---
    void *freelist;               // Pointer to the first free object in the slab
    size_t inuse;                 // Number of allocated objects in the slab
    struct kmem_cache *cache;     // Points back to the cache it belongs to
};
