...
ffffffffc020004e:	20650513          	addi	a0,a0,518 # ffffffffc0297250 <buf>
ffffffffc0200052:	0009b617          	auipc	a2,0x9b
ffffffffc0200056:	6ae60613          	addi	a2,a2,1710 # ffffffffc029b700 <end>
{
...
ffffffffc02000ca:	18a98993          	addi	s3,s3,394 # ffffffffc0297250 <buf>
        c = getchar();
...
ffffffffc0200144:	11050513          	addi	a0,a0,272 # ffffffffc0297250 <buf>
...
ffffffffc0200262:	ff258593          	addi	a1,a1,-14 # ffffffffc0297250 <buf>
...
ffffffffc0200276:	48e58593          	addi	a1,a1,1166 # ffffffffc029b700 <end>
...
ffffffffc0200292:	87178793          	addi	a5,a5,-1935 # ffffffffc029baff <end+0x3ff>
...
ffffffffc020044a:	23233303          	ld	t1,562(t1) # ffffffffc029b678 <is_panic>
{
...
ffffffffc0200478:	20e6b223          	sd	a4,516(a3) # ffffffffc029b678 <is_panic>
    va_start(ap, fmt);
...
ffffffffc02004fe:	18f73323          	sd	a5,390(a4) # ffffffffc029b680 <timebase>
...
ffffffffc0200526:	1607b323          	sd	zero,358(a5) # ffffffffc029b688 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc0200534:	1507b783          	ld	a5,336(a5) # ffffffffc029b680 <timebase>
...
ffffffffc020060e:	eed68693          	addi	a3,a3,-275 # ffffffffd00dfeed <end+0xfe447ed>
...
ffffffffc02008dc:	dc97b023          	sd	s1,-576(a5) # ffffffffc029b698 <memory_base>
        memory_size = mem_size;
ffffffffc02008e0:	0009b797          	auipc	a5,0x9b
ffffffffc02008e4:	da87b823          	sd	s0,-592(a5) # ffffffffc029b690 <memory_size>
...
ffffffffc02008ee:	dae53503          	ld	a0,-594(a0) # ffffffffc029b698 <memory_base>
...
ffffffffc02008f8:	d9c53503          	ld	a0,-612(a0) # ffffffffc029b690 <memory_size>
...
ffffffffc0200bb2:	ada78793          	addi	a5,a5,-1318 # ffffffffc029b688 <ticks>
...
ffffffffc0200bec:	ab87b783          	ld	a5,-1352(a5) # ffffffffc029b6a0 <num>
...
ffffffffc0200c26:	a7e7b783          	ld	a5,-1410(a5) # ffffffffc029b6a0 <num>
                current->need_resched = 1;      // 触发调度，而不是原来的关闭
ffffffffc0200c2a:	0009b717          	auipc	a4,0x9b
ffffffffc0200c2e:	abe73703          	ld	a4,-1346(a4) # ffffffffc029b6e8 <current>
ffffffffc0200c32:	4685                	li	a3,1
                num++;         // 记录打印了几次“100 ticks”
ffffffffc0200c34:	97b6                	add	a5,a5,a3
ffffffffc0200c36:	0009b617          	auipc	a2,0x9b
ffffffffc0200c3a:	a6f63523          	sd	a5,-1430(a2) # ffffffffc029b6a0 <num>
                current->need_resched = 1;      // 触发调度，而不是原来的关闭
...
ffffffffc0200c6a:	a827b783          	ld	a5,-1406(a5) # ffffffffc029b6e8 <current>
...
ffffffffc0200d34:	9b873703          	ld	a4,-1608(a4) # ffffffffc029b6e8 <current>
...
ffffffffc0200e00:	8ec73703          	ld	a4,-1812(a4) # ffffffffc029b6e8 <current>
...
ffffffffc0200e30:	8bc68693          	addi	a3,a3,-1860 # ffffffffc029b6e8 <current>
...
ffffffffc0200e56:	0009b697          	auipc	a3,0x9b
ffffffffc0200e5a:	89268693          	addi	a3,a3,-1902 # ffffffffc029b6e8 <current>
...
ffffffffc0200e72:	021030ef          	jal	ffffffffc0204692 <do_exit>
            if (current->need_resched)
ffffffffc0200e76:	0009b717          	auipc	a4,0x9b
ffffffffc0200e7a:	87273703          	ld	a4,-1934(a4) # ffffffffc029b6e8 <current>
...
ffffffffc0200ffa:	65a78793          	addi	a5,a5,1626 # ffffffffc0297650 <free_area>
...
ffffffffc020100c:	65856503          	lwu	a0,1624(a0) # ffffffffc0297660 <free_area+0x10>
...
ffffffffc020101a:	63a90913          	addi	s2,s2,1594 # ffffffffc0297650 <free_area>
...
ffffffffc02010b8:	6247b783          	ld	a5,1572(a5) # ffffffffc029b6d8 <pages>
...
ffffffffc02010c8:	60c6b683          	ld	a3,1548(a3) # ffffffffc029b6d0 <npage>
...
ffffffffc0201106:	55eb2b03          	lw	s6,1374(s6) # ffffffffc0297660 <free_area+0x10>
    elm->prev = elm->next = elm;
ffffffffc020110a:	01293023          	sd	s2,0(s2)
ffffffffc020110e:	01293423          	sd	s2,8(s2)
    nr_free = 0;
ffffffffc0201112:	00096797          	auipc	a5,0x96
ffffffffc0201116:	5407a723          	sw	zero,1358(a5) # ffffffffc0297660 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc020113e:	52672703          	lw	a4,1318(a4) # ffffffffc0297660 <free_area+0x10>
...
ffffffffc02011a0:	4c47a783          	lw	a5,1220(a5) # ffffffffc0297660 <free_area+0x10>
...
ffffffffc0201206:	45ec2c03          	lw	s8,1118(s8) # ffffffffc0297660 <free_area+0x10>
    nr_free = 0;
ffffffffc020120a:	00096797          	auipc	a5,0x96
ffffffffc020120e:	4407ab23          	sw	zero,1110(a5) # ffffffffc0297660 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc02012c8:	39c7a783          	lw	a5,924(a5) # ffffffffc0297660 <free_area+0x10>
...
ffffffffc0201808:	e5c72703          	lw	a4,-420(a4) # ffffffffc0297660 <free_area+0x10>
ffffffffc020180c:	00096697          	auipc	a3,0x96
ffffffffc0201810:	e4468693          	addi	a3,a3,-444 # ffffffffc0297650 <free_area>
...
__list_del(list_entry_t *prev, list_entry_t *next) {
    prev->next = next;
ffffffffc02018b0:	00b83423          	sd	a1,8(a6) # ff0008 <_binary_obj___user_exit_out_size+0xfe5e48>
    return listelm->next;
...
ffffffffc020193a:	d2a5a583          	lw	a1,-726(a1) # ffffffffc0297660 <free_area+0x10>
...
ffffffffc020194e:	d0660613          	addi	a2,a2,-762 # ffffffffc0297650 <free_area>
...
ffffffffc0201a28:	c3c72703          	lw	a4,-964(a4) # ffffffffc0297660 <free_area+0x10>
ffffffffc0201a2c:	00096697          	auipc	a3,0x96
ffffffffc0201a30:	c2468693          	addi	a3,a3,-988 # ffffffffc0297650 <free_area>
    return list->next == list;
...
ffffffffc0201af2:	7527b783          	ld	a5,1874(a5) # ffffffffc0297240 <slobfree>
...
ffffffffc0201b26:	70e7bf23          	sd	a4,1822(a5) # ffffffffc0297240 <slobfree>
    if (flag)
...
ffffffffc0201b58:	6ec7b783          	ld	a5,1772(a5) # ffffffffc0297240 <slobfree>
...
ffffffffc0201b8e:	6ae7bb23          	sd	a4,1718(a5) # ffffffffc0297240 <slobfree>
    if (flag)
...
ffffffffc0201bae:	68e7bb23          	sd	a4,1686(a5) # ffffffffc0297240 <slobfree>
    if (flag)
...
ffffffffc0201c06:	ad66b683          	ld	a3,-1322(a3) # ffffffffc029b6d8 <pages>
...
ffffffffc0201c16:	abe73703          	ld	a4,-1346(a4) # ffffffffc029b6d0 <npage>
    return page - pages + nbase;
...
ffffffffc0201c30:	a9c7b783          	ld	a5,-1380(a5) # ffffffffc029b6c8 <va_pa_offset>
...
ffffffffc0201c7c:	5c848493          	addi	s1,s1,1480 # ffffffffc0297240 <slobfree>
...
ffffffffc0201d68:	ec06                	sd	ra,24(sp)
	if (size < PAGE_SIZE - SLOB_UNIT)
ffffffffc0201d6a:	16bd                	addi	a3,a3,-17 # fef <_binary_obj___user_softint_out_size-0x7bd9>
...
ffffffffc0201da8:	9047b783          	ld	a5,-1788(a5) # ffffffffc029b6a8 <bigblocks>
		bigblocks = bb;
ffffffffc0201dac:	0009a717          	auipc	a4,0x9a
ffffffffc0201db0:	8e873e23          	sd	s0,-1796(a4) # ffffffffc029b6a8 <bigblocks>
		bb->next = bigblocks;
...
ffffffffc0201dda:	8d27b783          	ld	a5,-1838(a5) # ffffffffc029b6a8 <bigblocks>
		bigblocks = bb;
ffffffffc0201dde:	0009a717          	auipc	a4,0x9a
ffffffffc0201de2:	8c873523          	sd	s0,-1846(a4) # ffffffffc029b6a8 <bigblocks>
		bb->next = bigblocks;
...
ffffffffc0201e22:	88a7b783          	ld	a5,-1910(a5) # ffffffffc029b6a8 <bigblocks>
    return 0;
ffffffffc0201e26:	4581                	li	a1,0
ffffffffc0201e28:	cbad                	beqz	a5,ffffffffc0201e9a <kfree+0x90>
	bigblock_t *bb, **last = &bigblocks;
ffffffffc0201e2a:	0009a617          	auipc	a2,0x9a
ffffffffc0201e2e:	87e60613          	addi	a2,a2,-1922 # ffffffffc029b6a8 <bigblocks>
...
ffffffffc0201e50:	0009a797          	auipc	a5,0x9a
ffffffffc0201e54:	8787b783          	ld	a5,-1928(a5) # ffffffffc029b6c8 <va_pa_offset>
    if (PPN(pa) >= npage)
ffffffffc0201e58:	0009a697          	auipc	a3,0x9a
ffffffffc0201e5c:	8786b683          	ld	a3,-1928(a3) # ffffffffc029b6d0 <npage>
    return pa2page(PADDR(kva));
...
ffffffffc0201e72:	0009a517          	auipc	a0,0x9a
ffffffffc0201e76:	86653503          	ld	a0,-1946(a0) # ffffffffc029b6d8 <pages>
...
ffffffffc0201eae:	7fe7b783          	ld	a5,2046(a5) # ffffffffc029b6a8 <bigblocks>
...
ffffffffc0201f32:	7827b783          	ld	a5,1922(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0201f48:	76c7b783          	ld	a5,1900(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0201f6c:	7487b783          	ld	a5,1864(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0201f84:	7307b783          	ld	a5,1840(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0201fa4:	7107b783          	ld	a5,1808(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0201fb8:	6fc7b783          	ld	a5,1788(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0201ff2:	6e248493          	addi	s1,s1,1762 # ffffffffc029b6d0 <npage>
    if (!(*pdep1 & PTE_V))
...
ffffffffc020200a:	6aa7b783          	ld	a5,1706(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0202026:	6b653503          	ld	a0,1718(a0) # ffffffffc029b6d8 <pages>
...
ffffffffc0202032:	6a248493          	addi	s1,s1,1698 # ffffffffc029b6d0 <npage>
...
ffffffffc0202054:	6786b683          	ld	a3,1656(a3) # ffffffffc029b6c8 <va_pa_offset>
...
ffffffffc020206c:	6706b683          	ld	a3,1648(a3) # ffffffffc029b6d8 <pages>
...
ffffffffc020209e:	62e88893          	addi	a7,a7,1582 # ffffffffc029b6c8 <va_pa_offset>
...
ffffffffc02020cc:	5e873703          	ld	a4,1512(a4) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc02020e0:	5ec88893          	addi	a7,a7,1516 # ffffffffc029b6c8 <va_pa_offset>
        if (!create || (page = alloc_page()) == NULL)
ffffffffc02020e4:	c759                	beqz	a4,ffffffffc0202172 <get_pte+0x1a4>
    return page - pages + nbase;
ffffffffc02020e6:	00099697          	auipc	a3,0x99
ffffffffc02020ea:	5f26b683          	ld	a3,1522(a3) # ffffffffc029b6d8 <pages>
...
ffffffffc0202122:	5ba6b683          	ld	a3,1466(a3) # ffffffffc029b6d8 <pages>
...
ffffffffc0202144:	58888893          	addi	a7,a7,1416 # ffffffffc029b6c8 <va_pa_offset>
...
ffffffffc020218a:	52a7b783          	ld	a5,1322(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc02021ac:	50873703          	ld	a4,1288(a4) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc02021c4:	50888893          	addi	a7,a7,1288 # ffffffffc029b6c8 <va_pa_offset>
...
ffffffffc0202256:	47e73703          	ld	a4,1150(a4) # ffffffffc029b6d0 <npage>
...
ffffffffc0202266:	47653503          	ld	a0,1142(a0) # ffffffffc029b6d8 <pages>
...
ffffffffc02022fa:	3da6b683          	ld	a3,986(a3) # ffffffffc029b6d0 <npage>
    return pa2page(PTE_ADDR(pte));
...
ffffffffc020230a:	3d253503          	ld	a0,978(a0) # ffffffffc029b6d8 <pages>
...
ffffffffc020231a:	377d                	addiw	a4,a4,-1 # fffffffffdffffff <end+0x3dd648ff>
...
ffffffffc0202340:	37473703          	ld	a4,884(a4) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc020235c:	35873703          	ld	a4,856(a4) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0202406:	2cea8a93          	addi	s5,s5,718 # ffffffffc029b6d0 <npage>
...
ffffffffc0202462:	26af8f93          	addi	t6,t6,618 # ffffffffc029b6c8 <va_pa_offset>
...
ffffffffc02024ac:	23053503          	ld	a0,560(a0) # ffffffffc029b6d8 <pages>
...
ffffffffc02024c0:	1f47b783          	ld	a5,500(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc020252c:	1b053503          	ld	a0,432(a0) # ffffffffc029b6d8 <pages>
...
ffffffffc020253e:	1767b783          	ld	a5,374(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0202574:	158f8f93          	addi	t6,t6,344 # ffffffffc029b6c8 <va_pa_offset>
...
ffffffffc0202598:	11c7b783          	ld	a5,284(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc02025bc:	110f8f93          	addi	t6,t6,272 # ffffffffc029b6c8 <va_pa_offset>
...
ffffffffc02025da:	0da7b783          	ld	a5,218(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc020268e:	0466b683          	ld	a3,70(a3) # ffffffffc029b6d0 <npage>
    return pa2page(PTE_ADDR(pte));
...
ffffffffc020269e:	03e53503          	ld	a0,62(a0) # ffffffffc029b6d8 <pages>
...
ffffffffc02026d0:	fe473703          	ld	a4,-28(a4) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc02026ec:	fc873703          	ld	a4,-56(a4) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0202722:	0015861b          	addiw	a2,a1,1 # 1001 <_binary_obj___user_softint_out_size-0x7bc7>
...
ffffffffc0202734:	fa863603          	ld	a2,-88(a2) # ffffffffc029b6d8 <pages>
    return page - pages + nbase;
...
ffffffffc0202760:	f7463603          	ld	a2,-140(a2) # ffffffffc029b6d0 <npage>
    return pa2page(PTE_ADDR(pte));
...
ffffffffc0202770:	f6c63603          	ld	a2,-148(a2) # ffffffffc029b6d8 <pages>
...
ffffffffc0202786:	37fd                	addiw	a5,a5,-1 # 1fffffff <_binary_obj___user_exit_out_size+0x1fff5e3f>
...
ffffffffc02027a2:	f127b783          	ld	a5,-238(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc02027b4:	f2863603          	ld	a2,-216(a2) # ffffffffc029b6d8 <pages>
...
ffffffffc02027d0:	ee47b783          	ld	a5,-284(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc02027e4:	ef863603          	ld	a2,-264(a2) # ffffffffc029b6d8 <pages>
...
ffffffffc0202820:	e94b0b13          	addi	s6,s6,-364 # ffffffffc029b6b0 <pmm_manager>
    cprintf("memory management: %s\n", pmm_manager->name);
...
ffffffffc020283c:	e9098993          	addi	s3,s3,-368 # ffffffffc029b6c8 <va_pa_offset>
    pmm_manager->init();
...
ffffffffc0202890:	e7360613          	addi	a2,a2,-397 # ffffffffc029c6ff <end+0xfff>
ffffffffc0202894:	8e7d                	and	a2,a2,a5
    npage = maxpa / PGSIZE;
ffffffffc0202896:	8131                	srli	a0,a0,0xc
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc0202898:	00099b97          	auipc	s7,0x99
ffffffffc020289c:	e40b8b93          	addi	s7,s7,-448 # ffffffffc029b6d8 <pages>
    npage = maxpa / PGSIZE;
ffffffffc02028a0:	00099497          	auipc	s1,0x99
ffffffffc02028a4:	e3048493          	addi	s1,s1,-464 # ffffffffc029b6d0 <npage>
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
...
ffffffffc02028c6:	07a1                	addi	a5,a5,8 # 80008 <_binary_obj___user_exit_out_size+0x75e48>
...
ffffffffc020290c:	db890913          	addi	s2,s2,-584 # ffffffffc029b6c0 <boot_pgdir_va>
    pmm_manager->check();
...
ffffffffc020293e:	d6d7bf23          	sd	a3,-642(a5) # ffffffffc029b6b8 <boot_pgdir_pa>
    if (read_csr(sstatus) & SSTATUS_SIE)
...
ffffffffc02029dc:	000a2683          	lw	a3,0(s4) # 200000 <_binary_obj___user_exit_out_size+0x1f5e40>
...
ffffffffc0202ba6:	0007b023          	sd	zero,0(a5) # fffffffffffff000 <end+0x3fd63900>
...
ffffffffc0202c6e:	10060613          	addi	a2,a2,256 # 1100 <_binary_obj___user_softint_out_size-0x7ac8>
...
ffffffffc0202c98:	10058593          	addi	a1,a1,256 # 1100 <_binary_obj___user_softint_out_size-0x7ac8>
...
ffffffffc0202cd0:	10078023          	sb	zero,256(a5) # 80100 <_binary_obj___user_exit_out_size+0x75f40>
    assert(strlen((const char *)0x100) == 0);
...
ffffffffc0202ce0:	6098                	ld	a4,0(s1)
    return pa2page(PDE_ADDR(pde));
ffffffffc0202ce2:	000a3783          	ld	a5,0(s4) # fffffffffffff000 <end+0x3fd63900>
...
ffffffffc0202df0:	177d                	addi	a4,a4,-1 # fff <_binary_obj___user_softint_out_size-0x7bc9>
...
ffffffffc020348c:	0785                	addi	a5,a5,1 # 200001 <_binary_obj___user_exit_out_size+0x1f5e41>
...
ffffffffc02034a2:	232b0b13          	addi	s6,s6,562 # ffffffffc029b6d0 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02034a6:	00098a97          	auipc	s5,0x98
ffffffffc02034aa:	232a8a93          	addi	s5,s5,562 # ffffffffc029b6d8 <pages>
...
ffffffffc020357e:	1367b783          	ld	a5,310(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc02035c8:	10453503          	ld	a0,260(a0) # ffffffffc029b6c8 <va_pa_offset>
...
ffffffffc02035f4:	0c07b783          	ld	a5,192(a5) # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc020370c:	fa840413          	addi	s0,s0,-88 # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0203782:	f3240413          	addi	s0,s0,-206 # ffffffffc029b6b0 <pmm_manager>
...
ffffffffc0203964:	d807a783          	lw	a5,-640(a5) # ffffffffc029b6e0 <pgfault_num>
ffffffffc0203968:	2785                	addiw	a5,a5,1
ffffffffc020396a:	00098717          	auipc	a4,0x98
ffffffffc020396e:	d6f72b23          	sw	a5,-650(a4) # ffffffffc029b6e0 <pgfault_num>
    if (mm == NULL)
...
ffffffffc02039dc:	cf873703          	ld	a4,-776(a4) # ffffffffc029b6d0 <npage>
    return pa2page(PTE_ADDR(pte));
...
ffffffffc02039f4:	ce84b483          	ld	s1,-792(s1) # ffffffffc029b6d8 <pages>
    {
...
ffffffffc0203a14:	cc85b583          	ld	a1,-824(a1) # ffffffffc029b6d8 <pages>
...
ffffffffc0203a26:	cae63603          	ld	a2,-850(a2) # ffffffffc029b6d0 <npage>
    return page - pages + nbase;
...
ffffffffc0203a4c:	c8053503          	ld	a0,-896(a0) # ffffffffc029b6c8 <va_pa_offset>
            {
                return -E_NO_MEM;
            }
...
ffffffffc0203afe:	17fd                	addi	a5,a5,-1 # fff <_binary_obj___user_softint_out_size-0x7bc9>
...
ffffffffc0203b74:	00098463          	beqz	s3,ffffffffc0203b7c <mm_map+0x80>
    {
        *vma_store = vma;
ffffffffc0203b78:	00b9b023          	sd	a1,0(s3) # 1000 <_binary_obj___user_softint_out_size-0x7bc8>
...
ffffffffc0203d70:	fe87b603          	ld	a2,-24(a5) # 1fffe8 <_binary_obj___user_exit_out_size+0x1f5e28>
...
ffffffffc0204018:	0785                	addi	a5,a5,1 # 200001 <_binary_obj___user_exit_out_size+0x1f5e41>
...
ffffffffc0204078:	0785                	addi	a5,a5,1 # ffffffffc8000001 <end+0x7d64901>
...
ffffffffc02040e2:	5da7b783          	ld	a5,1498(a5) # ffffffffc029b6b8 <boot_pgdir_pa>
        proc->tf = NULL;
...
ffffffffc020412a:	5c27b783          	ld	a5,1474(a5) # ffffffffc029b6e8 <current>
...
ffffffffc0204138:	5b47b783          	ld	a5,1460(a5) # ffffffffc029b6e8 <current>
{
...
ffffffffc020415a:	78278793          	addi	a5,a5,1922 # 98d8 <_binary_obj___user_forktest_out_size>
...
ffffffffc020416c:	51878793          	addi	a5,a5,1304 # ffffffffc0243680 <_binary_obj___user_forktest_out_start>
...
ffffffffc02041c4:	50873703          	ld	a4,1288(a4) # ffffffffc029b6c8 <va_pa_offset>
    if (PPN(pa) >= npage)
ffffffffc02041c8:	00097797          	auipc	a5,0x97
ffffffffc02041cc:	5087b783          	ld	a5,1288(a5) # ffffffffc029b6d0 <npage>
    return pa2page(PADDR(kva));
...
ffffffffc02041e4:	4f853503          	ld	a0,1272(a0) # ffffffffc029b6d8 <pages>
}
...
ffffffffc020422c:	4c078793          	addi	a5,a5,1216 # ffffffffc029b6e8 <current>
...
ffffffffc0204280:	46c78793          	addi	a5,a5,1132 # ffffffffc029b6e8 <current>
...
ffffffffc0204290:	4587a783          	lw	a5,1112(a5) # ffffffffc029b6e4 <nr_process>
{
...
ffffffffc02042be:	42eb8b93          	addi	s7,s7,1070 # ffffffffc029b6e8 <current>
...
ffffffffc02042dc:	400a0a13          	addi	s4,s4,1024 # ffffffffc029b6d8 <pages>
...
ffffffffc02042fc:	3d8b0b13          	addi	s6,s6,984 # ffffffffc029b6d0 <npage>
...
ffffffffc0204324:	3a8b8b93          	addi	s7,s7,936 # ffffffffc029b6c8 <va_pa_offset>
...
{
    mm->mm_count += 1;
ffffffffc0204340:	030c2703          	lw	a4,48(s8) # fffffffffff80030 <end+0x3fce4930>
...
ffffffffc0204366:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_softint_out_size-0x6ce8>
...
ffffffffc020439e:	eb252503          	lw	a0,-334(a0) # ffffffffc029724c <last_pid.1>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
...
ffffffffc02043b8:	e8a72c23          	sw	a0,-360(a4) # ffffffffc029724c <last_pid.1>
...
ffffffffc02043c6:	e867a783          	lw	a5,-378(a5) # ffffffffc0297248 <next_safe.0>
ffffffffc02043ca:	00097497          	auipc	s1,0x97
ffffffffc02043ce:	29e48493          	addi	s1,s1,670 # ffffffffc029b668 <proc_list>
ffffffffc02043d2:	06f54563          	blt	a0,a5,ffffffffc020443c <do_fork+0x1b0>
    return listelm->next;
ffffffffc02043d6:	00097497          	auipc	s1,0x97
ffffffffc02043da:	29248493          	addi	s1,s1,658 # ffffffffc029b668 <proc_list>
ffffffffc02043de:	0084b883          	ld	a7,8(s1)
        next_safe = MAX_PID;
ffffffffc02043e2:	6789                	lui	a5,0x2
ffffffffc02043e4:	00093717          	auipc	a4,0x93
ffffffffc02043e8:	e6f72223          	sw	a5,-412(a4) # ffffffffc0297248 <next_safe.0>
...
ffffffffc020440e:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_softint_out_size-0x6c8c>
...
ffffffffc020442c:	e2c7a023          	sw	a2,-480(a5) # ffffffffc0297248 <next_safe.0>
ffffffffc0204430:	c591                	beqz	a1,ffffffffc020443c <do_fork+0x1b0>
ffffffffc0204432:	00093797          	auipc	a5,0x93
ffffffffc0204436:	e0d7ad23          	sw	a3,-486(a5) # ffffffffc029724c <last_pid.1>
            else if (proc->pid > last_pid && next_safe > proc->pid)
...
ffffffffc0204450:	21c78793          	addi	a5,a5,540 # ffffffffc0297668 <hash_list>
...
ffffffffc0204488:	2607a783          	lw	a5,608(a5) # ffffffffc029b6e4 <nr_process>
    proc->parent->cptr = proc;
...
ffffffffc0204496:	24f72923          	sw	a5,594(a4) # ffffffffc029b6e4 <nr_process>
    wakeup_proc(proc);                        // 内部会把 state 置为 PROC_RUNNABLE
...
ffffffffc02044f2:	1d25b583          	ld	a1,466(a1) # ffffffffc029b6c0 <boot_pgdir_va>
...
ffffffffc02045b2:	c8a7af23          	sw	a0,-866(a5) # ffffffffc029724c <last_pid.1>
        goto inside;
...
ffffffffc020469a:	05240413          	addi	s0,s0,82 # ffffffffc029b6e8 <current>
ffffffffc020469e:	601c                	ld	a5,0(s0)
ffffffffc02046a0:	00097717          	auipc	a4,0x97
ffffffffc02046a4:	05873703          	ld	a4,88(a4) # ffffffffc029b6f8 <idleproc>
{
...
ffffffffc02046b4:	04048493          	addi	s1,s1,64 # ffffffffc029b6f0 <initproc>
...
ffffffffc02046ca:	ff27b783          	ld	a5,-14(a5) # ffffffffc029b6b8 <boot_pgdir_pa>
...
ffffffffc0204700:	0785                	addi	a5,a5,1 # ffffffff80000001 <_binary_obj___user_exit_out_size+0xffffffff7fff5e41>
        proc = current->parent;
...
ffffffffc0204712:	0585                	addi	a1,a1,1 # ffffffff80000001 <_binary_obj___user_exit_out_size+0xffffffff7fff5e41>
        while (current->cptr != NULL)
...
ffffffffc0204752:	0585                	addi	a1,a1,1 # ffffffff80000001 <_binary_obj___user_exit_out_size+0xffffffff7fff5e41>
...
ffffffffc02047ea:	f0298993          	addi	s3,s3,-254 # ffffffffc029b6e8 <current>
    if (pid != 0)
ffffffffc02047ee:	cd19                	beqz	a0,ffffffffc020480c <do_wait.part.0+0x36>
    if (0 < pid && pid < MAX_PID)
ffffffffc02047f0:	6789                	lui	a5,0x2
ffffffffc02047f2:	17f9                	addi	a5,a5,-2 # 1ffe <_binary_obj___user_softint_out_size-0x6bca>
...
ffffffffc0204828:	ed47b783          	ld	a5,-300(a5) # ffffffffc029b6f8 <idleproc>
ffffffffc020482c:	14878263          	beq	a5,s0,ffffffffc0204970 <do_wait.part.0+0x19a>
ffffffffc0204830:	00097797          	auipc	a5,0x97
ffffffffc0204834:	ec07b783          	ld	a5,-320(a5) # ffffffffc029b6f0 <initproc>
...
ffffffffc020487e:	e6a7a783          	lw	a5,-406(a5) # ffffffffc029b6e4 <nr_process>
ffffffffc0204882:	37fd                	addiw	a5,a5,-1
ffffffffc0204884:	00097717          	auipc	a4,0x97
ffffffffc0204888:	e6f72023          	sw	a5,-416(a4) # ffffffffc029b6e4 <nr_process>
    if (flag)
...
ffffffffc020489c:	e3073703          	ld	a4,-464(a4) # ffffffffc029b6c8 <va_pa_offset>
    if (PPN(pa) >= npage)
ffffffffc02048a0:	00097797          	auipc	a5,0x97
ffffffffc02048a4:	e307b783          	ld	a5,-464(a5) # ffffffffc029b6d0 <npage>
    return pa2page(PADDR(kva));
...
ffffffffc02048bc:	e2053503          	ld	a0,-480(a0) # ffffffffc029b6d8 <pages>
...
ffffffffc02048e6:	e0698993          	addi	s3,s3,-506 # ffffffffc029b6e8 <current>
...
ffffffffc0204904:	0785                	addi	a5,a5,1 # ffffffff80000001 <_binary_obj___user_exit_out_size+0xffffffff7fff5e41>
...
ffffffffc0204936:	d3678793          	addi	a5,a5,-714 # ffffffffc0297668 <hash_list>
...
ffffffffc02049f8:	cfc7b783          	ld	a5,-772(a5) # ffffffffc029b6f0 <initproc>
...
ffffffffc0204a0e:	cda6a683          	lw	a3,-806(a3) # ffffffffc029b6e4 <nr_process>
...
ffffffffc0204a1c:	c5068693          	addi	a3,a3,-944 # ffffffffc029b668 <proc_list>
...
ffffffffc0204ae4:	c08d0d13          	addi	s10,s10,-1016 # ffffffffc029b6e8 <current>
...
ffffffffc0204b3c:	b807b783          	ld	a5,-1152(a5) # ffffffffc029b6b8 <boot_pgdir_pa>
...
ffffffffc0204b7c:	b60c0c13          	addi	s8,s8,-1184 # ffffffffc029b6d8 <pages>
...
ffffffffc0204b98:	b3cc8c93          	addi	s9,s9,-1220 # ffffffffc029b6d0 <npage>
...
ffffffffc0204bbc:	b10a8a93          	addi	s5,s5,-1264 # ffffffffc029b6c8 <va_pa_offset>
ffffffffc0204bc0:	000ab783          	ld	a5,0(s5)
    memcpy(pgdir, boot_pgdir_va, PGSIZE);
ffffffffc0204bc4:	00097597          	auipc	a1,0x97
ffffffffc0204bc8:	afc5b583          	ld	a1,-1284(a1) # ffffffffc029b6c0 <boot_pgdir_va>
...
ffffffffc0204be4:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464ba3bf>
...
ffffffffc0204cfc:	02f92823          	sw	a5,48(s2)
    current->mm = mm;
ffffffffc0204d00:	03263423          	sd	s2,40(a2) # 100028 <_binary_obj___user_exit_out_size+0xf5e68>
    current->pgdir = PADDR(mm->pgdir);
...
ffffffffc020507c:	6707b783          	ld	a5,1648(a5) # ffffffffc029b6e8 <current>
...
ffffffffc0205092:	65a53503          	ld	a0,1626(a0) # ffffffffc029b6e8 <current>
...
ffffffffc02050c8:	17f9                	addi	a5,a5,-2 # 1ffe <_binary_obj___user_softint_out_size-0x6bca>
...
ffffffffc02050e6:	58678793          	addi	a5,a5,1414 # ffffffffc0297668 <hash_list>
...
ffffffffc0205142:	52a78793          	addi	a5,a5,1322 # ffffffffc029b668 <proc_list>
...
ffffffffc0205150:	51c48493          	addi	s1,s1,1308 # ffffffffc0297668 <hash_list>
...
ffffffffc020515c:	51070713          	addi	a4,a4,1296 # ffffffffc029b668 <proc_list>
...
ffffffffc0205174:	58890913          	addi	s2,s2,1416 # ffffffffc029b6f8 <idleproc>
...
ffffffffc02051b4:	5347a783          	lw	a5,1332(a5) # ffffffffc029b6e4 <nr_process>
...
ffffffffc02051ce:	50e6bf23          	sd	a4,1310(a3) # ffffffffc029b6e8 <current>
    nr_process++;
ffffffffc02051d2:	00096717          	auipc	a4,0x96
ffffffffc02051d6:	50f72923          	sw	a5,1298(a4) # ffffffffc029b6e4 <nr_process>
    int pid = kernel_thread(init_main, NULL, 0);
...
ffffffffc02051e6:	17f9                	addi	a5,a5,-2 # 1ffe <_binary_obj___user_softint_out_size-0x6bca>
...
ffffffffc0205224:	4cf73823          	sd	a5,1232(a4) # ffffffffc029b6f0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
...
ffffffffc020524a:	4aa7b783          	ld	a5,1194(a5) # ffffffffc029b6f0 <initproc>
...
ffffffffc02052e4:	40840413          	addi	s0,s0,1032 # ffffffffc029b6e8 <current>
    while (1)
    {
        if (current->need_resched)
...
ffffffffc0205404:	2e88b883          	ld	a7,744(a7) # ffffffffc029b6e8 <current>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205408:	00096517          	auipc	a0,0x96
ffffffffc020540c:	2f053503          	ld	a0,752(a0) # ffffffffc029b6f8 <idleproc>
        current->need_resched = 0;
...
ffffffffc0205420:	24c60613          	addi	a2,a2,588 # ffffffffc029b668 <proc_list>
        le = last;
...
ffffffffc0205476:	1f660613          	addi	a2,a2,502 # ffffffffc029b668 <proc_list>
...
ffffffffc020548a:	2627b783          	ld	a5,610(a5) # ffffffffc029b6e8 <current>
}
...
ffffffffc02054ca:	2227b783          	ld	a5,546(a5) # ffffffffc029b6e8 <current>
...
ffffffffc02054e2:	20a6b683          	ld	a3,522(a3) # ffffffffc029b6e8 <current>
syscall(void) {
...
ffffffffc0205536:	1b67b783          	ld	a5,438(a5) # ffffffffc029b6e8 <current>
...
ffffffffc020555e:	2785                	addiw	a5,a5,1 # ffffffff9e370001 <_binary_obj___user_exit_out_size+0xffffffff9e365e41>
