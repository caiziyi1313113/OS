...
ffffffffc020004e:	96e50513          	addi	a0,a0,-1682 # ffffffffc02c29b8 <buf>
ffffffffc0200052:	000c7617          	auipc	a2,0xc7
ffffffffc0200056:	e4660613          	addi	a2,a2,-442 # ffffffffc02c6e98 <end>
{
...
ffffffffc0200060:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc0200062:	74c050ef          	jal	ra,ffffffffc02057ae <memset>
...
ffffffffc020006e:	76e58593          	addi	a1,a1,1902 # ffffffffc02057d8 <etext>
ffffffffc0200072:	00005517          	auipc	a0,0x5
ffffffffc0200076:	78650513          	addi	a0,a0,1926 # ffffffffc02057f8 <etext+0x20>
...
ffffffffc0200092:	065030ef          	jal	ra,ffffffffc02038f6 <vmm_init>
    sched_init();
ffffffffc0200096:	7af040ef          	jal	ra,ffffffffc0205044 <sched_init>
    proc_init(); // init process table
ffffffffc020009a:	445040ef          	jal	ra,ffffffffc0204cde <proc_init>
...
ffffffffc02000a6:	5d1040ef          	jal	ra,ffffffffc0204e76 <cpu_idle>
...
ffffffffc02000c4:	74050513          	addi	a0,a0,1856 # ffffffffc0205800 <etext+0x28>
...
ffffffffc02000d4:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc02000d6:	000c3b97          	auipc	s7,0xc3
ffffffffc02000da:	8e2b8b93          	addi	s7,s7,-1822 # ffffffffc02c29b8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
...
ffffffffc020012e:	0a0000ef          	jal	ra,ffffffffc02001ce <cputchar>
            buf[i] = '\0';
ffffffffc0200132:	000c3517          	auipc	a0,0xc3
ffffffffc0200136:	88650513          	addi	a0,a0,-1914 # ffffffffc02c29b8 <buf>
...
ffffffffc020018a:	c602                	sw	zero,12(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc020018c:	1fe050ef          	jal	ra,ffffffffc020538a <vprintfmt>
    return cnt;
}
...
ffffffffc02001c0:	c202                	sw	zero,4(sp)
    vprintfmt((void *)cputch, &cnt, fmt, ap);
ffffffffc02001c2:	1c8050ef          	jal	ra,ffffffffc020538a <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200226:	5e650513          	addi	a0,a0,1510 # ffffffffc0205808 <etext+0x30>
void print_kerninfo(void) {
...
ffffffffc020023c:	5f050513          	addi	a0,a0,1520 # ffffffffc0205828 <etext+0x50>
ffffffffc0200240:	f59ff0ef          	jal	ra,ffffffffc0200198 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200244:	00005597          	auipc	a1,0x5
ffffffffc0200248:	59458593          	addi	a1,a1,1428 # ffffffffc02057d8 <etext>
ffffffffc020024c:	00005517          	auipc	a0,0x5
ffffffffc0200250:	5fc50513          	addi	a0,a0,1532 # ffffffffc0205848 <etext+0x70>
ffffffffc0200254:	f45ff0ef          	jal	ra,ffffffffc0200198 <cprintf>
    cprintf("  edata  0x%08x (virtual)\n", edata);
ffffffffc0200258:	000c2597          	auipc	a1,0xc2
ffffffffc020025c:	76058593          	addi	a1,a1,1888 # ffffffffc02c29b8 <buf>
ffffffffc0200260:	00005517          	auipc	a0,0x5
ffffffffc0200264:	60850513          	addi	a0,a0,1544 # ffffffffc0205868 <etext+0x90>
ffffffffc0200268:	f31ff0ef          	jal	ra,ffffffffc0200198 <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc020026c:	000c7597          	auipc	a1,0xc7
ffffffffc0200270:	c2c58593          	addi	a1,a1,-980 # ffffffffc02c6e98 <end>
ffffffffc0200274:	00005517          	auipc	a0,0x5
ffffffffc0200278:	61450513          	addi	a0,a0,1556 # ffffffffc0205888 <etext+0xb0>
ffffffffc020027c:	f1dff0ef          	jal	ra,ffffffffc0200198 <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc0200280:	000c7597          	auipc	a1,0xc7
ffffffffc0200284:	01758593          	addi	a1,a1,23 # ffffffffc02c7297 <end+0x3ff>
...
ffffffffc02002a6:	60650513          	addi	a0,a0,1542 # ffffffffc02058a8 <etext+0xd0>
}
...
ffffffffc02002b4:	62860613          	addi	a2,a2,1576 # ffffffffc02058d8 <etext+0x100>
ffffffffc02002b8:	04d00593          	li	a1,77
ffffffffc02002bc:	00005517          	auipc	a0,0x5
ffffffffc02002c0:	63450513          	addi	a0,a0,1588 # ffffffffc02058f0 <etext+0x118>
void print_stackframe(void) {
...
ffffffffc02002d0:	63c60613          	addi	a2,a2,1596 # ffffffffc0205908 <etext+0x130>
ffffffffc02002d4:	00005597          	auipc	a1,0x5
ffffffffc02002d8:	65458593          	addi	a1,a1,1620 # ffffffffc0205928 <etext+0x150>
ffffffffc02002dc:	00005517          	auipc	a0,0x5
ffffffffc02002e0:	65450513          	addi	a0,a0,1620 # ffffffffc0205930 <etext+0x158>
mon_help(int argc, char **argv, struct trapframe *tf) {
ffffffffc02002e4:	e406                	sd	ra,8(sp)
        cprintf("%s - %s\n", commands[i].name, commands[i].desc);
ffffffffc02002e6:	eb3ff0ef          	jal	ra,ffffffffc0200198 <cprintf>
ffffffffc02002ea:	00005617          	auipc	a2,0x5
ffffffffc02002ee:	65660613          	addi	a2,a2,1622 # ffffffffc0205940 <etext+0x168>
ffffffffc02002f2:	00005597          	auipc	a1,0x5
ffffffffc02002f6:	67658593          	addi	a1,a1,1654 # ffffffffc0205968 <etext+0x190>
ffffffffc02002fa:	00005517          	auipc	a0,0x5
ffffffffc02002fe:	63650513          	addi	a0,a0,1590 # ffffffffc0205930 <etext+0x158>
ffffffffc0200302:	e97ff0ef          	jal	ra,ffffffffc0200198 <cprintf>
ffffffffc0200306:	00005617          	auipc	a2,0x5
ffffffffc020030a:	67260613          	addi	a2,a2,1650 # ffffffffc0205978 <etext+0x1a0>
ffffffffc020030e:	00005597          	auipc	a1,0x5
ffffffffc0200312:	68a58593          	addi	a1,a1,1674 # ffffffffc0205998 <etext+0x1c0>
ffffffffc0200316:	00005517          	auipc	a0,0x5
ffffffffc020031a:	61a50513          	addi	a0,a0,1562 # ffffffffc0205930 <etext+0x158>
...
ffffffffc0200354:	65850513          	addi	a0,a0,1624 # ffffffffc02059a8 <etext+0x1d0>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200376:	65e50513          	addi	a0,a0,1630 # ffffffffc02059d0 <etext+0x1f8>
...
ffffffffc0200394:	66890913          	addi	s2,s2,1640 # ffffffffc02059f8 <etext+0x220>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200398:	00005497          	auipc	s1,0x5
ffffffffc020039c:	66848493          	addi	s1,s1,1640 # ffffffffc0205a00 <etext+0x228>
        if (argc == MAXARGS - 1) {
ffffffffc02003a0:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc02003a2:	00005b17          	auipc	s6,0x5
ffffffffc02003a6:	666b0b13          	addi	s6,s6,1638 # ffffffffc0205a08 <etext+0x230>
        argv[argc ++] = buf;
ffffffffc02003aa:	00005a17          	auipc	s4,0x5
ffffffffc02003ae:	57ea0a13          	addi	s4,s4,1406 # ffffffffc0205928 <etext+0x150>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003d8:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003da:	37a050ef          	jal	ra,ffffffffc0205754 <strcmp>
...
ffffffffc02003ec:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003ee:	366050ef          	jal	ra,ffffffffc0205754 <strcmp>
...
ffffffffc020042c:	36c050ef          	jal	ra,ffffffffc0205798 <strchr>
...
ffffffffc020046a:	32e050ef          	jal	ra,ffffffffc0205798 <strchr>
...
ffffffffc0200488:	5a450513          	addi	a0,a0,1444 # ffffffffc0205a28 <etext+0x250>
...
ffffffffc0200496:	97e30313          	addi	t1,t1,-1666 # ffffffffc02c6e10 <is_panic>
...
ffffffffc0200560:	56c50513          	addi	a0,a0,1388 # ffffffffc0205ac8 <commands+0x88>
    ticks = 0;
ffffffffc0200564:	000c7797          	auipc	a5,0xc7
ffffffffc0200568:	8a07ba23          	sd	zero,-1868(a5) # ffffffffc02c6e18 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc0200694:	2581                	sext.w	a1,a1
    if (magic != 0xd00dfeed) {
ffffffffc0200696:	eed78793          	addi	a5,a5,-275 # ffffffffd00dfeed <end+0xfe19055>
...
ffffffffc02007c4:	749040ef          	jal	ra,ffffffffc020570c <strlen>
...
ffffffffc02007d0:	2a01                	sext.w	s4,s4
                if (strncmp(name, "memory", 6) == 0) {
ffffffffc02007d2:	7a1040ef          	jal	ra,ffffffffc0205772 <strncmp>
...
ffffffffc0200868:	6ed040ef          	jal	ra,ffffffffc0205754 <strcmp>
...
ffffffffc0200986:	4887bf23          	sd	s0,1182(a5) # ffffffffc02c6e20 <memory_base>
        memory_size = mem_size;
ffffffffc020098a:	000c6797          	auipc	a5,0xc6
ffffffffc020098e:	4967bf23          	sd	s6,1182(a5) # ffffffffc02c6e28 <memory_size>
    cprintf("DTB init completed\n");
...
ffffffffc0200998:	48c53503          	ld	a0,1164(a0) # ffffffffc02c6e20 <memory_base>
...
ffffffffc02009a2:	48a53503          	ld	a0,1162(a0) # ffffffffc02c6e28 <memory_size>
...
ffffffffc0200c5c:	1c070713          	addi	a4,a4,448 # ffffffffc02c6e18 <ticks>
...
ffffffffc0200c68:	20453503          	ld	a0,516(a0) # ffffffffc02c6e68 <current>
        ++ticks;
...
ffffffffc0200c70:	0141                	addi	sp,sp,16
        sched_class_proc_tick(current);
ffffffffc0200c72:	3aa0406f          	j	ffffffffc020501c <sched_class_proc_tick>
...
ffffffffc0200cc2:	0141                	addi	sp,sp,16
        syscall();
ffffffffc0200cc4:	5c20406f          	j	ffffffffc0205286 <syscall>
...
ffffffffc0200d5a:	0bb00593          	li	a1,187
...
ffffffffc0200d72:	0fa40413          	addi	s0,s0,250 # ffffffffc02c6e68 <current>
...
ffffffffc0200d9c:	0b27b023          	sd	s2,160(a5) # 400a0 <_binary_obj___user_matrix_out_size+0x33968>
        if (!in_kernel)
...
ffffffffc0200de4:	6105                	addi	sp,sp,32
                schedule();
ffffffffc0200de6:	3620406f          	j	ffffffffc0205148 <schedule>
                do_exit(-E_KILLED);
ffffffffc0200dea:	555d                	li	a0,-9
ffffffffc0200dec:	43e030ef          	jal	ra,ffffffffc020422a <do_exit>
            if (current->need_resched)
...
ffffffffc0200ec6:	ef678793          	addi	a5,a5,-266 # ffffffffc02c2db8 <free_area>
...
ffffffffc0200ed8:	ef456503          	lwu	a0,-268(a0) # ffffffffc02c2dc8 <free_area+0x10>
...
ffffffffc0200ee6:	ed640413          	addi	s0,s0,-298 # ffffffffc02c2db8 <free_area>
...
ffffffffc0200fc8:	e007a223          	sw	zero,-508(a5) # ffffffffc02c2dc8 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc02010aa:	d207a123          	sw	zero,-734(a5) # ffffffffc02c2dc8 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc02016a6:	71668693          	addi	a3,a3,1814 # ffffffffc02c2db8 <free_area>
...
ffffffffc02017d2:	5ea58593          	addi	a1,a1,1514 # ffffffffc02c2db8 <free_area>
...
ffffffffc02018be:	4fe68693          	addi	a3,a3,1278 # ffffffffc02c2db8 <free_area>
...
ffffffffc020198a:	02260613          	addi	a2,a2,34 # ffffffffc02c29a8 <slobfree>
...
ffffffffc0201a38:	41c6b683          	ld	a3,1052(a3) # ffffffffc02c6e50 <pages>
ffffffffc0201a3c:	8d15                	sub	a0,a0,a3
ffffffffc0201a3e:	8519                	srai	a0,a0,0x6
ffffffffc0201a40:	00006697          	auipc	a3,0x6
ffffffffc0201a44:	6786b683          	ld	a3,1656(a3) # ffffffffc02080b8 <nbase>
...
ffffffffc0201a54:	3f873703          	ld	a4,1016(a4) # ffffffffc02c6e48 <npage>
    return page2ppn(page) << PGSHIFT;
...
ffffffffc0201a62:	4026b683          	ld	a3,1026(a3) # ffffffffc02c6e60 <va_pa_offset>
...
ffffffffc0201ab0:	efc90913          	addi	s2,s2,-260 # ffffffffc02c29a8 <slobfree>
...
ffffffffc0201bac:	e426                	sd	s1,8(sp)
	if (size < PAGE_SIZE - SLOB_UNIT)
ffffffffc0201bae:	fef90793          	addi	a5,s2,-17 # fef <_binary_obj___user_faultread_out_size-0x8f71>
{
...
ffffffffc0201bee:	24678793          	addi	a5,a5,582 # ffffffffc02c6e30 <bigblocks>
...
ffffffffc0201c2a:	20a78793          	addi	a5,a5,522 # ffffffffc02c6e30 <bigblocks>
...
ffffffffc0201c70:	1c47b783          	ld	a5,452(a5) # ffffffffc02c6e30 <bigblocks>
    return 0;
...
ffffffffc0201c7c:	1b868693          	addi	a3,a3,440 # ffffffffc02c6e30 <bigblocks>
...
ffffffffc0201d00:	1347b783          	ld	a5,308(a5) # ffffffffc02c6e30 <bigblocks>
        return 1;
...
ffffffffc0201d8c:	0d07b783          	ld	a5,208(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0201da4:	0b87b783          	ld	a5,184(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0201dca:	0927b783          	ld	a5,146(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0201de6:	0767b783          	ld	a5,118(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0201e0a:	0527b783          	ld	a5,82(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0201e20:	03c7b783          	ld	a5,60(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0201e66:	fe698993          	addi	s3,s3,-26 # ffffffffc02c6e48 <npage>
    if (!(*pdep1 & PTE_V))
...
ffffffffc0201e7e:	fde7b783          	ld	a5,-34(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0201e92:	fc2b0b13          	addi	s6,s6,-62 # ffffffffc02c6e50 <pages>
...
ffffffffc0201ea2:	faa98993          	addi	s3,s3,-86 # ffffffffc02c6e48 <npage>
...
ffffffffc0201ec6:	f9e7b783          	ld	a5,-98(a5) # ffffffffc02c6e60 <va_pa_offset>
ffffffffc0201eca:	6605                	lui	a2,0x1
ffffffffc0201ecc:	4581                	li	a1,0
ffffffffc0201ece:	953e                	add	a0,a0,a5
ffffffffc0201ed0:	0df030ef          	jal	ra,ffffffffc02057ae <memset>
    return page - pages + nbase;
...
ffffffffc0201efe:	f66a8a93          	addi	s5,s5,-154 # ffffffffc02c6e60 <va_pa_offset>
...
ffffffffc0201f2e:	f2e7b783          	ld	a5,-210(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0201f40:	f14b0b13          	addi	s6,s6,-236 # ffffffffc02c6e50 <pages>
...
ffffffffc0201f72:	03d030ef          	jal	ra,ffffffffc02057ae <memset>
    return page - pages + nbase;
...
ffffffffc0201fd0:	e8c7b783          	ld	a5,-372(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0201fea:	e727b783          	ld	a5,-398(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc020208e:	dbe73703          	ld	a4,-578(a4) # ffffffffc02c6e48 <npage>
...
ffffffffc02020a6:	dae53503          	ld	a0,-594(a0) # ffffffffc02c6e50 <pages>
...
ffffffffc02020f6:	d56c8c93          	addi	s9,s9,-682 # ffffffffc02c6e48 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02020fa:	000c5c17          	auipc	s8,0xc5
ffffffffc02020fe:	d56c0c13          	addi	s8,s8,-682 # ffffffffc02c6e50 <pages>
ffffffffc0202102:	fff80bb7          	lui	s7,0xfff80
        pmm_manager->free_pages(base, n);
ffffffffc0202106:	000c5d17          	auipc	s10,0xc5
ffffffffc020210a:	d52d0d13          	addi	s10,s10,-686 # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0202254:	bf8d0d13          	addi	s10,s10,-1032 # ffffffffc02c6e48 <npage>
    return KADDR(page2pa(page));
ffffffffc0202258:	00ccdc93          	srli	s9,s9,0xc
    return &pages[PPN(pa) - nbase];
ffffffffc020225c:	000c5717          	auipc	a4,0xc5
ffffffffc0202260:	bf470713          	addi	a4,a4,-1036 # ffffffffc02c6e50 <pages>
        pmm_manager->free_pages(base, n);
ffffffffc0202264:	000c5d97          	auipc	s11,0xc5
ffffffffc0202268:	bf4d8d93          	addi	s11,s11,-1036 # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc020227c:	00043a03          	ld	s4,0(s0) # ffffffffc0000000 <_binary_obj___user_matrix_out_size+0xffffffffbfff38c8>
        if (pde1 & PTE_V)
...
ffffffffc02022c4:	ba080813          	addi	a6,a6,-1120 # ffffffffc02c6e60 <va_pa_offset>
...
ffffffffc0202358:	b0c80813          	addi	a6,a6,-1268 # ffffffffc02c6e60 <va_pa_offset>
...
ffffffffc020236a:	aea70713          	addi	a4,a4,-1302 # ffffffffc02c6e50 <pages>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc02023a2:	ab270713          	addi	a4,a4,-1358 # ffffffffc02c6e50 <pages>
...
ffffffffc02023f0:	a6470713          	addi	a4,a4,-1436 # ffffffffc02c6e50 <pages>
...
ffffffffc0202402:	a6280813          	addi	a6,a6,-1438 # ffffffffc02c6e60 <va_pa_offset>
                        pd0[PDX0(d0start)] = 0;
...
ffffffffc0202426:	a2e70713          	addi	a4,a4,-1490 # ffffffffc02c6e50 <pages>
                pgdir[PDX1(d1start)] = 0;
...
ffffffffc02024b4:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage)
ffffffffc02024b6:	000c5717          	auipc	a4,0xc5
ffffffffc02024ba:	99273703          	ld	a4,-1646(a4) # ffffffffc02c6e48 <npage>
...
ffffffffc02024ca:	000c5517          	auipc	a0,0xc5
ffffffffc02024ce:	98653503          	ld	a0,-1658(a0) # ffffffffc02c6e50 <pages>
...
ffffffffc02024f6:	eb89                	bnez	a5,ffffffffc0202508 <page_remove+0x7c>
        pmm_manager->free_pages(base, n);
ffffffffc02024f8:	000c5797          	auipc	a5,0xc5
ffffffffc02024fc:	9607b783          	ld	a5,-1696(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc020250e:	000c5797          	auipc	a5,0xc5
ffffffffc0202512:	94a7b783          	ld	a5,-1718(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc020255e:	8f673703          	ld	a4,-1802(a4) # ffffffffc02c6e50 <pages>
...
ffffffffc0202574:	0099b023          	sd	s1,0(s3) # ffffffffc0000000 <_binary_obj___user_matrix_out_size+0xffffffffbfff38c8>
    asm volatile("sfence.vma %0" : : "r"(la));
...
ffffffffc0202592:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage)
ffffffffc0202594:	000c5717          	auipc	a4,0xc5
ffffffffc0202598:	8b473703          	ld	a4,-1868(a4) # ffffffffc02c6e48 <npage>
ffffffffc020259c:	06e7ff63          	bgeu	a5,a4,ffffffffc020261a <page_insert+0xf2>
    return &pages[PPN(pa) - nbase];
ffffffffc02025a0:	000c5a97          	auipc	s5,0xc5
ffffffffc02025a4:	8b0a8a93          	addi	s5,s5,-1872 # ffffffffc02c6e50 <pages>
...
ffffffffc02025b6:	01240c63          	beq	s0,s2,ffffffffc02025ce <page_insert+0xa6>
    page->ref -= 1;
ffffffffc02025ba:	00092783          	lw	a5,0(s2) # fffffffffff80000 <end+0x3fcb9168>
...
ffffffffc02025d8:	ef91                	bnez	a5,ffffffffc02025f4 <page_insert+0xcc>
        pmm_manager->free_pages(base, n);
ffffffffc02025da:	000c5797          	auipc	a5,0xc5
ffffffffc02025de:	87e7b783          	ld	a5,-1922(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc02025f4:	bbafe0ef          	jal	ra,ffffffffc02009ae <intr_disable>
        pmm_manager->free_pages(base, n);
ffffffffc02025f8:	000c5797          	auipc	a5,0xc5
ffffffffc02025fc:	8607b783          	ld	a5,-1952(a5) # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0202630:	18450513          	addi	a0,a0,388 # ffffffffc02067b0 <default_pmm_manager+0x1a8>
    pmm_manager = &default_pmm_manager;
ffffffffc0202634:	000c5b17          	auipc	s6,0xc5
ffffffffc0202638:	824b0b13          	addi	s6,s6,-2012 # ffffffffc02c6e58 <pmm_manager>
{
...
ffffffffc020265c:	000c5997          	auipc	s3,0xc5
ffffffffc0202660:	80498993          	addi	s3,s3,-2044 # ffffffffc02c6e60 <va_pa_offset>
    pmm_manager->init();
...
ffffffffc02026b4:	7e760613          	addi	a2,a2,2023 # ffffffffc02c7e97 <end+0xfff>
ffffffffc02026b8:	8e69                	and	a2,a2,a0
ffffffffc02026ba:	000c4497          	auipc	s1,0xc4
ffffffffc02026be:	78e48493          	addi	s1,s1,1934 # ffffffffc02c6e48 <npage>
ffffffffc02026c2:	00c7d513          	srli	a0,a5,0xc
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc02026c6:	000c4b97          	auipc	s7,0xc4
ffffffffc02026ca:	78ab8b93          	addi	s7,s7,1930 # ffffffffc02c6e50 <pages>
    npage = maxpa / PGSIZE;
...
ffffffffc02026ec:	00850713          	addi	a4,a0,8 # fffffffffffff008 <end+0x3fd38170>
...
ffffffffc0202734:	71090913          	addi	s2,s2,1808 # ffffffffc02c6e40 <boot_pgdir_va>
    pmm_manager->check();
...
ffffffffc0202766:	6cd7bb23          	sd	a3,1750(a5) # ffffffffc02c6e38 <boot_pgdir_pa>
    if (read_csr(sstatus) & SSTATUS_SIE)
...
ffffffffc0202804:	000a2683          	lw	a3,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8f60>
...
ffffffffc02029d2:	0007b023          	sd	zero,0(a5) # fffffffffffff000 <end+0x3fd38168>
...
ffffffffc0202a88:	44051e63          	bnez	a0,ffffffffc0202ee4 <pmm_init+0x8c6>
    assert(page_ref(p) == 1);
ffffffffc0202a8c:	000a2703          	lw	a4,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8f60>
...
ffffffffc0202a9e:	10040613          	addi	a2,s0,256 # 1100 <_binary_obj___user_faultread_out_size-0x8e60>
...
ffffffffc0202ac2:	481020ef          	jal	ra,ffffffffc0205742 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202ac6:	10040593          	addi	a1,s0,256
ffffffffc0202aca:	10000513          	li	a0,256
ffffffffc0202ace:	487020ef          	jal	ra,ffffffffc0205754 <strcmp>
...
ffffffffc0202b00:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202b04:	409020ef          	jal	ra,ffffffffc020570c <strlen>
...
ffffffffc0202b10:	609c                	ld	a5,0(s1)
    return pa2page(PDE_ADDR(pde));
ffffffffc0202b12:	000ab683          	ld	a3,0(s5) # fffffffffffff000 <end+0x3fd38168>
...
ffffffffc0202d34:	25700593          	li	a1,599
...
ffffffffc0202d54:	25800593          	li	a1,600
...
ffffffffc0202d74:	25700593          	li	a1,599
...
ffffffffc0202d9c:	22700593          	li	a1,551
...
ffffffffc0202dbc:	21a00593          	li	a1,538
...
ffffffffc0202ddc:	21900593          	li	a1,537
...
ffffffffc0202dfc:	21800593          	li	a1,536
...
ffffffffc0202e34:	24000593          	li	a1,576
...
ffffffffc0202e54:	23e00593          	li	a1,574
...
ffffffffc0202e74:	23d00593          	li	a1,573
...
ffffffffc0202e94:	25b00593          	li	a1,603
...
ffffffffc0202eb4:	24800593          	li	a1,584
...
ffffffffc0202ed4:	26000593          	li	a1,608
...
ffffffffc0202ef4:	25f00593          	li	a1,607
...
ffffffffc0202f54:	23600593          	li	a1,566
...
ffffffffc0202f74:	23500593          	li	a1,565
...
ffffffffc0202f94:	23400593          	li	a1,564
...
ffffffffc0202fb4:	23300593          	li	a1,563
...
ffffffffc0202fd4:	23200593          	li	a1,562
...
ffffffffc0202ff4:	23100593          	li	a1,561
...
ffffffffc0203014:	22f00593          	li	a1,559
...
ffffffffc0203034:	22e00593          	li	a1,558
...
ffffffffc0203054:	22d00593          	li	a1,557
...
ffffffffc0203074:	22c00593          	li	a1,556
...
ffffffffc02030ac:	27200593          	li	a1,626
...
ffffffffc02030cc:	22b00593          	li	a1,555
...
ffffffffc02030ec:	22a00593          	li	a1,554
...
ffffffffc0203106:	22600593          	li	a1,550
...
ffffffffc020311e:	22500593          	li	a1,549
...
ffffffffc020313e:	22300593          	li	a1,547
...
ffffffffc020315e:	22200593          	li	a1,546
...
ffffffffc020317e:	26900593          	li	a1,617
...
ffffffffc020319e:	26600593          	li	a1,614
...
ffffffffc02031be:	26200593          	li	a1,610
...
ffffffffc02031de:	26100593          	li	a1,609
...
ffffffffc020324e:	21e00593          	li	a1,542
...
ffffffffc02032a8:	ba4c0c13          	addi	s8,s8,-1116 # ffffffffc02c6e48 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02032ac:	000c4b97          	auipc	s7,0xc4
ffffffffc02032b0:	ba4b8b93          	addi	s7,s7,-1116 # ffffffffc02c6e50 <pages>
    return KADDR(page2pa(page));
ffffffffc02032b4:	00cb5b13          	srli	s6,s6,0xc
        page = pmm_manager->alloc_pages(n);
ffffffffc02032b8:	000c4c97          	auipc	s9,0xc4
ffffffffc02032bc:	ba0c8c93          	addi	s9,s9,-1120 # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0203376:	aee70713          	addi	a4,a4,-1298 # ffffffffc02c6e60 <va_pa_offset>
...
ffffffffc0203392:	42e020ef          	jal	ra,ffffffffc02057c0 <memcpy>
...
ffffffffc02033b4:	1b600593          	li	a1,438
...
ffffffffc02034d6:	8b89                	andi	a5,a5,2
        page = pmm_manager->alloc_pages(n);
ffffffffc02034d8:	000c4997          	auipc	s3,0xc4
ffffffffc02034dc:	98098993          	addi	s3,s3,-1664 # ffffffffc02c6e58 <pmm_manager>
...
ffffffffc0203570:	1ff00593          	li	a1,511
...
ffffffffc02035e8:	fe87b703          	ld	a4,-24(a5) # 1fffe8 <_binary_obj___user_matrix_out_size+0x1f38b0>
...
ffffffffc0203616:	0105b803          	ld	a6,16(a1) # 80010 <_binary_obj___user_matrix_out_size+0x738d8>
{
...
ffffffffc02037a8:	000a0463          	beqz	s4,ffffffffc02037b0 <mm_map+0x7a>
        *vma_store = vma;
ffffffffc02037ac:	012a3023          	sd	s2,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8f60>
...
ffffffffc0203802:	854a                	mv	a0,s2
        vma->vm_start = vm_start;
ffffffffc0203804:	0155b423          	sd	s5,8(a1) # 200008 <_binary_obj___user_matrix_out_size+0x1f38d0>
        vma->vm_end = vm_end;
...
ffffffffc0203814:	ff043683          	ld	a3,-16(s0) # ff0 <_binary_obj___user_faultread_out_size-0x8f70>
...
ffffffffc02039d2:	fe87b603          	ld	a2,-24(a5) # ffffffffffffefe8 <end+0x3fd38150>
...
ffffffffc0203cb0:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0203cb2:	578000ef          	jal	ra,ffffffffc020422a <do_exit>
...
ffffffffc0203cd2:	4581                	li	a1,0
        proc->runs = 0;
ffffffffc0203cd4:	00052423          	sw	zero,8(a0) # ffffffffc8000008 <end+0x7d39170>
        proc->kstack = 0;
...
ffffffffc0203cec:	2c3010ef          	jal	ra,ffffffffc02057ae <memset>
        proc->tf = NULL;
        proc->pgdir = boot_pgdir_pa;
ffffffffc0203cf0:	000c3797          	auipc	a5,0xc3
ffffffffc0203cf4:	1487b783          	ld	a5,328(a5) # ffffffffc02c6e38 <boot_pgdir_pa>
...
ffffffffc0203d02:	463d                	li	a2,15
ffffffffc0203d04:	4581                	li	a1,0
ffffffffc0203d06:	0b440513          	addi	a0,s0,180
ffffffffc0203d0a:	2a5010ef          	jal	ra,ffffffffc02057ae <memset>
        // lab5 add:
        proc->wait_state = 0;
...
ffffffffc0203d12:	0e042623          	sw	zero,236(s0)
        proc->cptr = proc->optr = proc->yptr = NULL;
ffffffffc0203d16:	0e043c23          	sd	zero,248(s0)
ffffffffc0203d1a:	10043023          	sd	zero,256(s0)
ffffffffc0203d1e:	0e043823          	sd	zero,240(s0)
        proc->rq = NULL;              // 初始化运行队列为空
...
ffffffffc0203d2e:	12042023          	sw	zero,288(s0)
        proc->lab6_run_pool.left = proc->lab6_run_pool.right = proc->lab6_run_pool.parent = NULL;//优先队列
...
ffffffffc0203d50:	11c7b783          	ld	a5,284(a5) # ffffffffc02c6e68 <current>
...
ffffffffc0203d92:	0c253503          	ld	a0,194(a0) # ffffffffc02c6e50 <pages>
...
ffffffffc0203da4:	94860613          	addi	a2,a2,-1720 # ffffffffc02066e8 <default_pmm_manager+0xe0>
ffffffffc0203da8:	07700593          	li	a1,119
ffffffffc0203dac:	00003517          	auipc	a0,0x3
ffffffffc0203db0:	8bc50513          	addi	a0,a0,-1860 # ffffffffc0206668 <default_pmm_manager+0x60>
ffffffffc0203db4:	edefc0ef          	jal	ra,ffffffffc0200492 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203db8:	00003617          	auipc	a2,0x3
ffffffffc0203dbc:	95860613          	addi	a2,a2,-1704 # ffffffffc0206710 <default_pmm_manager+0x108>
ffffffffc0203dc0:	06900593          	li	a1,105
ffffffffc0203dc4:	00003517          	auipc	a0,0x3
ffffffffc0203dc8:	8a450513          	addi	a0,a0,-1884 # ffffffffc0206668 <default_pmm_manager+0x60>
ffffffffc0203dcc:	ec6fc0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc0203dd0 <proc_run>:
{
ffffffffc0203dd0:	7179                	addi	sp,sp,-48
ffffffffc0203dd2:	f026                	sd	s1,32(sp)
    if (proc != current)
ffffffffc0203dd4:	000c3497          	auipc	s1,0xc3
ffffffffc0203dd8:	09448493          	addi	s1,s1,148 # ffffffffc02c6e68 <current>
ffffffffc0203ddc:	6098                	ld	a4,0(s1)
{
ffffffffc0203dde:	f406                	sd	ra,40(sp)
ffffffffc0203de0:	ec4a                	sd	s2,24(sp)
    if (proc != current)
ffffffffc0203de2:	02a70763          	beq	a4,a0,ffffffffc0203e10 <proc_run+0x40>
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0203de6:	100027f3          	csrr	a5,sstatus
ffffffffc0203dea:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0203dec:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0203dee:	ef85                	bnez	a5,ffffffffc0203e26 <proc_run+0x56>
...
ffffffffc0203df0:	755c                	ld	a5,168(a0)
ffffffffc0203df2:	56fd                	li	a3,-1
ffffffffc0203df4:	16fe                	slli	a3,a3,0x3f
ffffffffc0203df6:	83b1                	srli	a5,a5,0xc
        current = proc;
ffffffffc0203df8:	e088                	sd	a0,0(s1)
ffffffffc0203dfa:	8fd5                	or	a5,a5,a3
ffffffffc0203dfc:	18079073          	csrw	satp,a5
        switch_to(&(prev->context), &(proc->context));
ffffffffc0203e00:	03050593          	addi	a1,a0,48
ffffffffc0203e04:	03070513          	addi	a0,a4,48
ffffffffc0203e08:	0c2010ef          	jal	ra,ffffffffc0204eca <switch_to>
    if (flag)
ffffffffc0203e0c:	00091763          	bnez	s2,ffffffffc0203e1a <proc_run+0x4a>
}
ffffffffc0203e10:	70a2                	ld	ra,40(sp)
ffffffffc0203e12:	7482                	ld	s1,32(sp)
ffffffffc0203e14:	6962                	ld	s2,24(sp)
...
ffffffffc0203e20:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0203e22:	b87fc06f          	j	ffffffffc02009a8 <intr_enable>
ffffffffc0203e26:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0203e28:	b87fc0ef          	jal	ra,ffffffffc02009ae <intr_disable>
        struct proc_struct *prev = current;
ffffffffc0203e2c:	6098                	ld	a4,0(s1)
        return 1;
ffffffffc0203e2e:	6522                	ld	a0,8(sp)
ffffffffc0203e30:	4905                	li	s2,1
ffffffffc0203e32:	bf7d                	j	ffffffffc0203df0 <proc_run+0x20>

ffffffffc0203e34 <do_fork>:
...
{
ffffffffc0203e34:	7119                	addi	sp,sp,-128
ffffffffc0203e36:	f0ca                	sd	s2,96(sp)
    int ret = -E_NO_FREE_PROC;
    struct proc_struct *proc;
    if (nr_process >= MAX_PROCESS)
ffffffffc0203e38:	000c3917          	auipc	s2,0xc3
ffffffffc0203e3c:	04890913          	addi	s2,s2,72 # ffffffffc02c6e80 <nr_process>
ffffffffc0203e40:	00092703          	lw	a4,0(s2)
{
ffffffffc0203e44:	fc86                	sd	ra,120(sp)
ffffffffc0203e46:	f8a2                	sd	s0,112(sp)
ffffffffc0203e48:	f4a6                	sd	s1,104(sp)
ffffffffc0203e4a:	ecce                	sd	s3,88(sp)
ffffffffc0203e4c:	e8d2                	sd	s4,80(sp)
ffffffffc0203e4e:	e4d6                	sd	s5,72(sp)
ffffffffc0203e50:	e0da                	sd	s6,64(sp)
ffffffffc0203e52:	fc5e                	sd	s7,56(sp)
ffffffffc0203e54:	f862                	sd	s8,48(sp)
ffffffffc0203e56:	f466                	sd	s9,40(sp)
ffffffffc0203e58:	f06a                	sd	s10,32(sp)
ffffffffc0203e5a:	ec6e                	sd	s11,24(sp)
    if (nr_process >= MAX_PROCESS)
ffffffffc0203e5c:	6785                	lui	a5,0x1
ffffffffc0203e5e:	2ef75c63          	bge	a4,a5,ffffffffc0204156 <do_fork+0x322>
ffffffffc0203e62:	8a2a                	mv	s4,a0
ffffffffc0203e64:	89ae                	mv	s3,a1
ffffffffc0203e66:	8432                	mv	s0,a2
...
ffffffffc0203e68:	e4fff0ef          	jal	ra,ffffffffc0203cb6 <alloc_proc>
ffffffffc0203e6c:	84aa                	mv	s1,a0
ffffffffc0203e6e:	2c050863          	beqz	a0,ffffffffc020413e <do_fork+0x30a>
        goto fork_out;
    }

    // new 设置父子关系和让当前进程的的wait_state清0
    proc->parent = current;
ffffffffc0203e72:	000c3c17          	auipc	s8,0xc3
ffffffffc0203e76:	ff6c0c13          	addi	s8,s8,-10 # ffffffffc02c6e68 <current>
ffffffffc0203e7a:	000c3783          	ld	a5,0(s8)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0203e7e:	4509                	li	a0,2
    proc->parent = current;
ffffffffc0203e80:	f09c                	sd	a5,32(s1)
    current->wait_state = 0;   // 确保父进程 wait_state 清零
ffffffffc0203e82:	0e07a623          	sw	zero,236(a5) # 10ec <_binary_obj___user_faultread_out_size-0x8e74>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0203e86:	efbfd0ef          	jal	ra,ffffffffc0201d80 <alloc_pages>
    if (page != NULL)
ffffffffc0203e8a:	2a050763          	beqz	a0,ffffffffc0204138 <do_fork+0x304>
    return page - pages + nbase;
ffffffffc0203e8e:	000c3a97          	auipc	s5,0xc3
ffffffffc0203e92:	fc2a8a93          	addi	s5,s5,-62 # ffffffffc02c6e50 <pages>
ffffffffc0203e96:	000ab683          	ld	a3,0(s5)
ffffffffc0203e9a:	00004b17          	auipc	s6,0x4
ffffffffc0203e9e:	21eb0b13          	addi	s6,s6,542 # ffffffffc02080b8 <nbase>
ffffffffc0203ea2:	000b3783          	ld	a5,0(s6)
ffffffffc0203ea6:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc0203eaa:	000c3b97          	auipc	s7,0xc3
ffffffffc0203eae:	f9eb8b93          	addi	s7,s7,-98 # ffffffffc02c6e48 <npage>
    return page - pages + nbase;
ffffffffc0203eb2:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0203eb4:	5dfd                	li	s11,-1
ffffffffc0203eb6:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0203eba:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0203ebc:	00cddd93          	srli	s11,s11,0xc
ffffffffc0203ec0:	01b6f633          	and	a2,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc0203ec4:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0203ec6:	2ce67563          	bgeu	a2,a4,ffffffffc0204190 <do_fork+0x35c>
    struct mm_struct *mm, *oldmm = current->mm;
ffffffffc0203eca:	000c3603          	ld	a2,0(s8)
ffffffffc0203ece:	000c3c17          	auipc	s8,0xc3
ffffffffc0203ed2:	f92c0c13          	addi	s8,s8,-110 # ffffffffc02c6e60 <va_pa_offset>
ffffffffc0203ed6:	000c3703          	ld	a4,0(s8)
ffffffffc0203eda:	02863d03          	ld	s10,40(a2)
ffffffffc0203ede:	e43e                	sd	a5,8(sp)
ffffffffc0203ee0:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc0203ee2:	e894                	sd	a3,16(s1)
    if (oldmm == NULL)
ffffffffc0203ee4:	020d0863          	beqz	s10,ffffffffc0203f14 <do_fork+0xe0>
    if (clone_flags & CLONE_VM)
ffffffffc0203ee8:	100a7a13          	andi	s4,s4,256
ffffffffc0203eec:	180a0863          	beqz	s4,ffffffffc020407c <do_fork+0x248>
}
...
{
    mm->mm_count += 1;
ffffffffc0203ef0:	030d2703          	lw	a4,48(s10)
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc0203ef4:	018d3783          	ld	a5,24(s10)
ffffffffc0203ef8:	c02006b7          	lui	a3,0xc0200
ffffffffc0203efc:	2705                	addiw	a4,a4,1
ffffffffc0203efe:	02ed2823          	sw	a4,48(s10)
    proc->mm = mm;
ffffffffc0203f02:	03a4b423          	sd	s10,40(s1)
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc0203f06:	2ad7e163          	bltu	a5,a3,ffffffffc02041a8 <do_fork+0x374>
ffffffffc0203f0a:	000c3703          	ld	a4,0(s8)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0203f0e:	6894                	ld	a3,16(s1)
    proc->pgdir = PADDR(mm->pgdir);
ffffffffc0203f10:	8f99                	sub	a5,a5,a4
ffffffffc0203f12:	f4dc                	sd	a5,168(s1)
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0203f14:	6789                	lui	a5,0x2
ffffffffc0203f16:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x8080>
ffffffffc0203f1a:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc0203f1c:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE) - 1;
ffffffffc0203f1e:	f0d4                	sd	a3,160(s1)
    *(proc->tf) = *tf;
ffffffffc0203f20:	87b6                	mv	a5,a3
ffffffffc0203f22:	12040893          	addi	a7,s0,288
ffffffffc0203f26:	00063803          	ld	a6,0(a2)
ffffffffc0203f2a:	6608                	ld	a0,8(a2)
ffffffffc0203f2c:	6a0c                	ld	a1,16(a2)
ffffffffc0203f2e:	6e18                	ld	a4,24(a2)
ffffffffc0203f30:	0107b023          	sd	a6,0(a5)
ffffffffc0203f34:	e788                	sd	a0,8(a5)
ffffffffc0203f36:	eb8c                	sd	a1,16(a5)
ffffffffc0203f38:	ef98                	sd	a4,24(a5)
ffffffffc0203f3a:	02060613          	addi	a2,a2,32
ffffffffc0203f3e:	02078793          	addi	a5,a5,32
ffffffffc0203f42:	ff1612e3          	bne	a2,a7,ffffffffc0203f26 <do_fork+0xf2>
    proc->tf->gpr.a0 = 0;
ffffffffc0203f46:	0406b823          	sd	zero,80(a3) # ffffffffc0200050 <kern_init+0x6>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0203f4a:	12098763          	beqz	s3,ffffffffc0204078 <do_fork+0x244>
    if (++last_pid >= MAX_PID)
ffffffffc0203f4e:	000bf817          	auipc	a6,0xbf
ffffffffc0203f52:	a6280813          	addi	a6,a6,-1438 # ffffffffc02c29b0 <last_pid.1>
ffffffffc0203f56:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0203f5a:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0203f5e:	00000717          	auipc	a4,0x0
ffffffffc0203f62:	dee70713          	addi	a4,a4,-530 # ffffffffc0203d4c <forkret>
    if (++last_pid >= MAX_PID)
ffffffffc0203f66:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0203f6a:	f898                	sd	a4,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0203f6c:	fc94                	sd	a3,56(s1)
    if (++last_pid >= MAX_PID)
ffffffffc0203f6e:	00a82023          	sw	a0,0(a6)
ffffffffc0203f72:	6789                	lui	a5,0x2
ffffffffc0203f74:	08f55b63          	bge	a0,a5,ffffffffc020400a <do_fork+0x1d6>
    if (last_pid >= next_safe)
ffffffffc0203f78:	000bf317          	auipc	t1,0xbf
ffffffffc0203f7c:	a3c30313          	addi	t1,t1,-1476 # ffffffffc02c29b4 <next_safe.0>
ffffffffc0203f80:	00032783          	lw	a5,0(t1)
ffffffffc0203f84:	000c3417          	auipc	s0,0xc3
ffffffffc0203f88:	e4c40413          	addi	s0,s0,-436 # ffffffffc02c6dd0 <proc_list>
ffffffffc0203f8c:	08f55763          	bge	a0,a5,ffffffffc020401a <do_fork+0x1e6>
    //         设计context的ra返回地址为指定的forkret函数
    //         复制父进程的其他tr现场
    copy_thread(proc, stack, tf);

    // 设定父子关系与 PID，并挂入全局结构
    proc->pid = get_pid();// 返回独特pid
ffffffffc0203f90:	c0c8                	sw	a0,4(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0203f92:	45a9                	li	a1,10
ffffffffc0203f94:	2501                	sext.w	a0,a0
ffffffffc0203f96:	372010ef          	jal	ra,ffffffffc0205308 <hash32>
ffffffffc0203f9a:	02051793          	slli	a5,a0,0x20
ffffffffc0203f9e:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0203fa2:	000bf797          	auipc	a5,0xbf
ffffffffc0203fa6:	e2e78793          	addi	a5,a5,-466 # ffffffffc02c2dd0 <hash_list>
ffffffffc0203faa:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0203fac:	650c                	ld	a1,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL)
ffffffffc0203fae:	7094                	ld	a3,32(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0203fb0:	0d848793          	addi	a5,s1,216
    prev->next = next->prev = elm;
ffffffffc0203fb4:	e19c                	sd	a5,0(a1)
    __list_add(elm, listelm, listelm->next);
ffffffffc0203fb6:	6410                	ld	a2,8(s0)
    prev->next = next->prev = elm;
ffffffffc0203fb8:	e51c                	sd	a5,8(a0)
    if ((proc->optr = proc->parent->cptr) != NULL)
ffffffffc0203fba:	7af8                	ld	a4,240(a3)
    list_add(&proc_list, &(proc->list_link));
ffffffffc0203fbc:	0c848793          	addi	a5,s1,200
    elm->next = next;
ffffffffc0203fc0:	f0ec                	sd	a1,224(s1)
    elm->prev = prev;
ffffffffc0203fc2:	ece8                	sd	a0,216(s1)
    prev->next = next->prev = elm;
ffffffffc0203fc4:	e21c                	sd	a5,0(a2)
ffffffffc0203fc6:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc0203fc8:	e8f0                	sd	a2,208(s1)
    elm->prev = prev;
ffffffffc0203fca:	e4e0                	sd	s0,200(s1)
    proc->yptr = NULL;
ffffffffc0203fcc:	0e04bc23          	sd	zero,248(s1)
    if ((proc->optr = proc->parent->cptr) != NULL)
ffffffffc0203fd0:	10e4b023          	sd	a4,256(s1)
ffffffffc0203fd4:	c311                	beqz	a4,ffffffffc0203fd8 <do_fork+0x1a4>
        proc->optr->yptr = proc;
ffffffffc0203fd6:	ff64                	sd	s1,248(a4)
    nr_process++;
ffffffffc0203fd8:	00092783          	lw	a5,0(s2)
    //父子进程链：cptr / yptr / optr,需要维护
    set_links(proc);    // Lab5 的要求：建立父子链 + 插入 proc_list
...
ffffffffc0203fde:	fae4                	sd	s1,240(a3)
    nr_process++;
ffffffffc0203fe0:	2785                	addiw	a5,a5,1
ffffffffc0203fe2:	00f92023          	sw	a5,0(s2)
    wakeup_proc(proc);                        // 内部会把 state 置为 PROC_RUNNABLE
ffffffffc0203fe6:	0b0010ef          	jal	ra,ffffffffc0205096 <wakeup_proc>

    // 7) 统计与返回
    // nr_process++;set_links(proc)中已经成功设置了nr_process
    ret = proc->pid;
ffffffffc0203fea:	40c8                	lw	a0,4(s1)
...
ffffffffc0203fec:	70e6                	ld	ra,120(sp)
ffffffffc0203fee:	7446                	ld	s0,112(sp)
ffffffffc0203ff0:	74a6                	ld	s1,104(sp)
ffffffffc0203ff2:	7906                	ld	s2,96(sp)
ffffffffc0203ff4:	69e6                	ld	s3,88(sp)
ffffffffc0203ff6:	6a46                	ld	s4,80(sp)
ffffffffc0203ff8:	6aa6                	ld	s5,72(sp)
ffffffffc0203ffa:	6b06                	ld	s6,64(sp)
ffffffffc0203ffc:	7be2                	ld	s7,56(sp)
ffffffffc0203ffe:	7c42                	ld	s8,48(sp)
ffffffffc0204000:	7ca2                	ld	s9,40(sp)
ffffffffc0204002:	7d02                	ld	s10,32(sp)
ffffffffc0204004:	6de2                	ld	s11,24(sp)
ffffffffc0204006:	6109                	addi	sp,sp,128
ffffffffc0204008:	8082                	ret
        last_pid = 1;
ffffffffc020400a:	4785                	li	a5,1
ffffffffc020400c:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc0204010:	4505                	li	a0,1
ffffffffc0204012:	000bf317          	auipc	t1,0xbf
ffffffffc0204016:	9a230313          	addi	t1,t1,-1630 # ffffffffc02c29b4 <next_safe.0>
    return listelm->next;
ffffffffc020401a:	000c3417          	auipc	s0,0xc3
ffffffffc020401e:	db640413          	addi	s0,s0,-586 # ffffffffc02c6dd0 <proc_list>
ffffffffc0204022:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc0204026:	6789                	lui	a5,0x2
ffffffffc0204028:	00f32023          	sw	a5,0(t1)
ffffffffc020402c:	86aa                	mv	a3,a0
ffffffffc020402e:	4581                	li	a1,0
        while ((le = list_next(le)) != list)
ffffffffc0204030:	6e89                	lui	t4,0x2
ffffffffc0204032:	108e0d63          	beq	t3,s0,ffffffffc020414c <do_fork+0x318>
ffffffffc0204036:	88ae                	mv	a7,a1
ffffffffc0204038:	87f2                	mv	a5,t3
ffffffffc020403a:	6609                	lui	a2,0x2
ffffffffc020403c:	a811                	j	ffffffffc0204050 <do_fork+0x21c>
            else if (proc->pid > last_pid && next_safe > proc->pid)
ffffffffc020403e:	00e6d663          	bge	a3,a4,ffffffffc020404a <do_fork+0x216>
ffffffffc0204042:	00c75463          	bge	a4,a2,ffffffffc020404a <do_fork+0x216>
ffffffffc0204046:	863a                	mv	a2,a4
ffffffffc0204048:	4885                	li	a7,1
ffffffffc020404a:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc020404c:	00878d63          	beq	a5,s0,ffffffffc0204066 <do_fork+0x232>
            if (proc->pid == last_pid)
ffffffffc0204050:	f3c7a703          	lw	a4,-196(a5) # 1f3c <_binary_obj___user_faultread_out_size-0x8024>
ffffffffc0204054:	fed715e3          	bne	a4,a3,ffffffffc020403e <do_fork+0x20a>
                if (++last_pid >= next_safe)
ffffffffc0204058:	2685                	addiw	a3,a3,1
ffffffffc020405a:	0ec6d463          	bge	a3,a2,ffffffffc0204142 <do_fork+0x30e>
ffffffffc020405e:	679c                	ld	a5,8(a5)
ffffffffc0204060:	4585                	li	a1,1
        while ((le = list_next(le)) != list)
ffffffffc0204062:	fe8797e3          	bne	a5,s0,ffffffffc0204050 <do_fork+0x21c>
ffffffffc0204066:	c581                	beqz	a1,ffffffffc020406e <do_fork+0x23a>
ffffffffc0204068:	00d82023          	sw	a3,0(a6)
ffffffffc020406c:	8536                	mv	a0,a3
ffffffffc020406e:	f20881e3          	beqz	a7,ffffffffc0203f90 <do_fork+0x15c>
ffffffffc0204072:	00c32023          	sw	a2,0(t1)
ffffffffc0204076:	bf29                	j	ffffffffc0203f90 <do_fork+0x15c>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204078:	89b6                	mv	s3,a3
ffffffffc020407a:	bdd1                	j	ffffffffc0203f4e <do_fork+0x11a>
    if ((mm = mm_create()) == NULL)
ffffffffc020407c:	d28ff0ef          	jal	ra,ffffffffc02035a4 <mm_create>
ffffffffc0204080:	8caa                	mv	s9,a0
ffffffffc0204082:	c159                	beqz	a0,ffffffffc0204108 <do_fork+0x2d4>
    if ((page = alloc_page()) == NULL)
ffffffffc0204084:	4505                	li	a0,1
ffffffffc0204086:	cfbfd0ef          	jal	ra,ffffffffc0201d80 <alloc_pages>
ffffffffc020408a:	cd25                	beqz	a0,ffffffffc0204102 <do_fork+0x2ce>
    return page - pages + nbase;
ffffffffc020408c:	000ab683          	ld	a3,0(s5)
ffffffffc0204090:	67a2                	ld	a5,8(sp)
    return KADDR(page2pa(page));
ffffffffc0204092:	000bb703          	ld	a4,0(s7)
    return page - pages + nbase;
ffffffffc0204096:	40d506b3          	sub	a3,a0,a3
ffffffffc020409a:	8699                	srai	a3,a3,0x6
ffffffffc020409c:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc020409e:	01b6fdb3          	and	s11,a3,s11
    return page2ppn(page) << PGSHIFT;
ffffffffc02040a2:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02040a4:	0eedf663          	bgeu	s11,a4,ffffffffc0204190 <do_fork+0x35c>
ffffffffc02040a8:	000c3a03          	ld	s4,0(s8)
    memcpy(pgdir, boot_pgdir_va, PGSIZE);
ffffffffc02040ac:	6605                	lui	a2,0x1
ffffffffc02040ae:	000c3597          	auipc	a1,0xc3
ffffffffc02040b2:	d925b583          	ld	a1,-622(a1) # ffffffffc02c6e40 <boot_pgdir_va>
ffffffffc02040b6:	9a36                	add	s4,s4,a3
ffffffffc02040b8:	8552                	mv	a0,s4
ffffffffc02040ba:	706010ef          	jal	ra,ffffffffc02057c0 <memcpy>
static inline void
lock_mm(struct mm_struct *mm)
{
    ...
    {
        lock(&(mm->mm_lock));
ffffffffc02040be:	038d0d93          	addi	s11,s10,56
    mm->pgdir = pgdir;
ffffffffc02040c2:	014cbc23          	sd	s4,24(s9)
...
ffffffffc02040c6:	4785                	li	a5,1
ffffffffc02040c8:	40fdb7af          	amoor.d	a5,a5,(s11)
}
...
{
    while (!try_lock(lock))
ffffffffc02040cc:	8b85                	andi	a5,a5,1
ffffffffc02040ce:	4a05                	li	s4,1
ffffffffc02040d0:	c799                	beqz	a5,ffffffffc02040de <do_fork+0x2aa>
    {
        schedule();
ffffffffc02040d2:	076010ef          	jal	ra,ffffffffc0205148 <schedule>
ffffffffc02040d6:	414db7af          	amoor.d	a5,s4,(s11)
    while (!try_lock(lock))
ffffffffc02040da:	8b85                	andi	a5,a5,1
ffffffffc02040dc:	fbfd                	bnez	a5,ffffffffc02040d2 <do_fork+0x29e>
        ret = dup_mmap(mm, oldmm);
ffffffffc02040de:	85ea                	mv	a1,s10
ffffffffc02040e0:	8566                	mv	a0,s9
ffffffffc02040e2:	f04ff0ef          	jal	ra,ffffffffc02037e6 <dup_mmap>
...
ffffffffc02040e6:	57f9                	li	a5,-2
ffffffffc02040e8:	60fdb7af          	amoand.d	a5,a5,(s11)
ffffffffc02040ec:	8b85                	andi	a5,a5,1
}
...
ffffffffc02040ee:	cbad                	beqz	a5,ffffffffc0204160 <do_fork+0x32c>
good_mm:
ffffffffc02040f0:	8d66                	mv	s10,s9
    if (ret != 0)
ffffffffc02040f2:	de050fe3          	beqz	a0,ffffffffc0203ef0 <do_fork+0xbc>
    exit_mmap(mm);
ffffffffc02040f6:	8566                	mv	a0,s9
ffffffffc02040f8:	f88ff0ef          	jal	ra,ffffffffc0203880 <exit_mmap>
    put_pgdir(mm);
ffffffffc02040fc:	8566                	mv	a0,s9
ffffffffc02040fe:	c5dff0ef          	jal	ra,ffffffffc0203d5a <put_pgdir>
    mm_destroy(mm);
ffffffffc0204102:	8566                	mv	a0,s9
ffffffffc0204104:	de0ff0ef          	jal	ra,ffffffffc02036e4 <mm_destroy>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0204108:	6894                	ld	a3,16(s1)
    return pa2page(PADDR(kva));
ffffffffc020410a:	c02007b7          	lui	a5,0xc0200
ffffffffc020410e:	0af6ea63          	bltu	a3,a5,ffffffffc02041c2 <do_fork+0x38e>
ffffffffc0204112:	000c3783          	ld	a5,0(s8)
    if (PPN(pa) >= npage)
ffffffffc0204116:	000bb703          	ld	a4,0(s7)
    return pa2page(PADDR(kva));
ffffffffc020411a:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage)
ffffffffc020411e:	83b1                	srli	a5,a5,0xc
ffffffffc0204120:	04e7fc63          	bgeu	a5,a4,ffffffffc0204178 <do_fork+0x344>
    return &pages[PPN(pa) - nbase];
ffffffffc0204124:	000b3703          	ld	a4,0(s6)
ffffffffc0204128:	000ab503          	ld	a0,0(s5)
ffffffffc020412c:	4589                	li	a1,2
ffffffffc020412e:	8f99                	sub	a5,a5,a4
ffffffffc0204130:	079a                	slli	a5,a5,0x6
ffffffffc0204132:	953e                	add	a0,a0,a5
ffffffffc0204134:	c8bfd0ef          	jal	ra,ffffffffc0201dbe <free_pages>
    kfree(proc);
ffffffffc0204138:	8526                	mv	a0,s1
ffffffffc020413a:	b19fd0ef          	jal	ra,ffffffffc0201c52 <kfree>
    ret = -E_NO_MEM;
ffffffffc020413e:	5571                	li	a0,-4
    return ret;
ffffffffc0204140:	b575                	j	ffffffffc0203fec <do_fork+0x1b8>
                    if (last_pid >= MAX_PID)
ffffffffc0204142:	01d6c363          	blt	a3,t4,ffffffffc0204148 <do_fork+0x314>
                        last_pid = 1;
ffffffffc0204146:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204148:	4585                	li	a1,1
ffffffffc020414a:	b5e5                	j	ffffffffc0204032 <do_fork+0x1fe>
ffffffffc020414c:	c599                	beqz	a1,ffffffffc020415a <do_fork+0x326>
ffffffffc020414e:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc0204152:	8536                	mv	a0,a3
ffffffffc0204154:	bd35                	j	ffffffffc0203f90 <do_fork+0x15c>
    int ret = -E_NO_FREE_PROC;
ffffffffc0204156:	556d                	li	a0,-5
ffffffffc0204158:	bd51                	j	ffffffffc0203fec <do_fork+0x1b8>
    return last_pid;
ffffffffc020415a:	00082503          	lw	a0,0(a6)
ffffffffc020415e:	bd0d                	j	ffffffffc0203f90 <do_fork+0x15c>
    {
        panic("Unlock failed.\n");
ffffffffc0204160:	00003617          	auipc	a2,0x3
ffffffffc0204164:	eb060613          	addi	a2,a2,-336 # ffffffffc0207010 <default_pmm_manager+0xa08>
ffffffffc0204168:	04000593          	li	a1,64
ffffffffc020416c:	00003517          	auipc	a0,0x3
ffffffffc0204170:	eb450513          	addi	a0,a0,-332 # ffffffffc0207020 <default_pmm_manager+0xa18>
ffffffffc0204174:	b1efc0ef          	jal	ra,ffffffffc0200492 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204178:	00002617          	auipc	a2,0x2
ffffffffc020417c:	59860613          	addi	a2,a2,1432 # ffffffffc0206710 <default_pmm_manager+0x108>
ffffffffc0204180:	06900593          	li	a1,105
ffffffffc0204184:	00002517          	auipc	a0,0x2
ffffffffc0204188:	4e450513          	addi	a0,a0,1252 # ffffffffc0206668 <default_pmm_manager+0x60>
ffffffffc020418c:	b06fc0ef          	jal	ra,ffffffffc0200492 <__panic>
    return KADDR(page2pa(page));
ffffffffc0204190:	00002617          	auipc	a2,0x2
ffffffffc0204194:	4b060613          	addi	a2,a2,1200 # ffffffffc0206640 <default_pmm_manager+0x38>
ffffffffc0204198:	07100593          	li	a1,113
ffffffffc020419c:	00002517          	auipc	a0,0x2
ffffffffc02041a0:	4cc50513          	addi	a0,a0,1228 # ffffffffc0206668 <default_pmm_manager+0x60>
...
ffffffffc02041ae:	53e60613          	addi	a2,a2,1342 # ffffffffc02066e8 <default_pmm_manager+0xe0>
ffffffffc02041b2:	1ab00593          	li	a1,427
ffffffffc02041b6:	00003517          	auipc	a0,0x3
ffffffffc02041ba:	e8250513          	addi	a0,a0,-382 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc02041be:	ad4fc0ef          	jal	ra,ffffffffc0200492 <__panic>
    return pa2page(PADDR(kva));
ffffffffc02041c2:	00002617          	auipc	a2,0x2
ffffffffc02041c6:	52660613          	addi	a2,a2,1318 # ffffffffc02066e8 <default_pmm_manager+0xe0>
ffffffffc02041ca:	07700593          	li	a1,119
ffffffffc02041ce:	00002517          	auipc	a0,0x2
ffffffffc02041d2:	49a50513          	addi	a0,a0,1178 # ffffffffc0206668 <default_pmm_manager+0x60>
ffffffffc02041d6:	abcfc0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc02041da <kernel_thread>:
{
ffffffffc02041da:	7129                	addi	sp,sp,-320
ffffffffc02041dc:	fa22                	sd	s0,304(sp)
ffffffffc02041de:	f626                	sd	s1,296(sp)
ffffffffc02041e0:	f24a                	sd	s2,288(sp)
ffffffffc02041e2:	84ae                	mv	s1,a1
ffffffffc02041e4:	892a                	mv	s2,a0
ffffffffc02041e6:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02041e8:	4581                	li	a1,0
ffffffffc02041ea:	12000613          	li	a2,288
ffffffffc02041ee:	850a                	mv	a0,sp
{
ffffffffc02041f0:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02041f2:	5bc010ef          	jal	ra,ffffffffc02057ae <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02041f6:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02041f8:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02041fa:	100027f3          	csrr	a5,sstatus
ffffffffc02041fe:	edd7f793          	andi	a5,a5,-291
ffffffffc0204202:	1207e793          	ori	a5,a5,288
ffffffffc0204206:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204208:	860a                	mv	a2,sp
ffffffffc020420a:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020420e:	00000797          	auipc	a5,0x0
ffffffffc0204212:	aa078793          	addi	a5,a5,-1376 # ffffffffc0203cae <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204216:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204218:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020421a:	c1bff0ef          	jal	ra,ffffffffc0203e34 <do_fork>
}
ffffffffc020421e:	70f2                	ld	ra,312(sp)
ffffffffc0204220:	7452                	ld	s0,304(sp)
ffffffffc0204222:	74b2                	ld	s1,296(sp)
ffffffffc0204224:	7912                	ld	s2,288(sp)
ffffffffc0204226:	6131                	addi	sp,sp,320
ffffffffc0204228:	8082                	ret

ffffffffc020422a <do_exit>:
...
{
ffffffffc020422a:	7179                	addi	sp,sp,-48
ffffffffc020422c:	f022                	sd	s0,32(sp)
    if (current == idleproc)
ffffffffc020422e:	000c3417          	auipc	s0,0xc3
ffffffffc0204232:	c3a40413          	addi	s0,s0,-966 # ffffffffc02c6e68 <current>
ffffffffc0204236:	601c                	ld	a5,0(s0)
{
ffffffffc0204238:	f406                	sd	ra,40(sp)
...
ffffffffc0204240:	e052                	sd	s4,0(sp)
    if (current == idleproc)
ffffffffc0204242:	000c3717          	auipc	a4,0xc3
ffffffffc0204246:	c2e73703          	ld	a4,-978(a4) # ffffffffc02c6e70 <idleproc>
ffffffffc020424a:	0ce78c63          	beq	a5,a4,ffffffffc0204322 <do_exit+0xf8>
    {
        panic("idleproc exit.\n");
    }
    if (current == initproc)
ffffffffc020424e:	000c3497          	auipc	s1,0xc3
ffffffffc0204252:	c2a48493          	addi	s1,s1,-982 # ffffffffc02c6e78 <initproc>
ffffffffc0204256:	6098                	ld	a4,0(s1)
ffffffffc0204258:	0ee78b63          	beq	a5,a4,ffffffffc020434e <do_exit+0x124>
    {
        panic("initproc exit.\n");
    }
    struct mm_struct *mm = current->mm;
ffffffffc020425c:	0287b983          	ld	s3,40(a5)
ffffffffc0204260:	892a                	mv	s2,a0
    if (mm != NULL)
ffffffffc0204262:	02098663          	beqz	s3,ffffffffc020428e <do_exit+0x64>
ffffffffc0204266:	000c3797          	auipc	a5,0xc3
ffffffffc020426a:	bd27b783          	ld	a5,-1070(a5) # ffffffffc02c6e38 <boot_pgdir_pa>
ffffffffc020426e:	577d                	li	a4,-1
ffffffffc0204270:	177e                	slli	a4,a4,0x3f
ffffffffc0204272:	83b1                	srli	a5,a5,0xc
ffffffffc0204274:	8fd9                	or	a5,a5,a4
ffffffffc0204276:	18079073          	csrw	satp,a5
    mm->mm_count -= 1;
ffffffffc020427a:	0309a783          	lw	a5,48(s3)
ffffffffc020427e:	fff7871b          	addiw	a4,a5,-1
ffffffffc0204282:	02e9a823          	sw	a4,48(s3)
    {
        lsatp(boot_pgdir_pa);
        if (mm_count_dec(mm) == 0)
ffffffffc0204286:	cb55                	beqz	a4,ffffffffc020433a <do_exit+0x110>
        {
            exit_mmap(mm);
            put_pgdir(mm);
            mm_destroy(mm);
        ...
        current->mm = NULL;
ffffffffc0204288:	601c                	ld	a5,0(s0)
ffffffffc020428a:	0207b423          	sd	zero,40(a5)
    }
    current->state = PROC_ZOMBIE;
ffffffffc020428e:	601c                	ld	a5,0(s0)
ffffffffc0204290:	470d                	li	a4,3
ffffffffc0204292:	c398                	sw	a4,0(a5)
    current->exit_code = error_code;
ffffffffc0204294:	0f27a423          	sw	s2,232(a5)
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0204298:	100027f3          	csrr	a5,sstatus
ffffffffc020429c:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc020429e:	4a01                	li	s4,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02042a0:	e3f9                	bnez	a5,ffffffffc0204366 <do_exit+0x13c>
    bool intr_flag;
    struct proc_struct *proc;
    local_intr_save(intr_flag);
    {
        proc = current->parent;
ffffffffc02042a2:	6018                	ld	a4,0(s0)
        if (proc->wait_state == WT_CHILD)
ffffffffc02042a4:	800007b7          	lui	a5,0x80000
ffffffffc02042a8:	0785                	addi	a5,a5,1
        proc = current->parent;
ffffffffc02042aa:	7308                	ld	a0,32(a4)
        if (proc->wait_state == WT_CHILD)
ffffffffc02042ac:	0ec52703          	lw	a4,236(a0)
ffffffffc02042b0:	0af70f63          	beq	a4,a5,ffffffffc020436e <do_exit+0x144>
        {
            wakeup_proc(proc);
        }
        while (current->cptr != NULL)
ffffffffc02042b4:	6018                	ld	a4,0(s0)
ffffffffc02042b6:	7b7c                	ld	a5,240(a4)
ffffffffc02042b8:	c3a1                	beqz	a5,ffffffffc02042f8 <do_exit+0xce>
            }
...
ffffffffc02042ba:	800009b7          	lui	s3,0x80000
            if (proc->state == PROC_ZOMBIE)
ffffffffc02042be:	490d                	li	s2,3
                if (initproc->wait_state == WT_CHILD)
ffffffffc02042c0:	0985                	addi	s3,s3,1
ffffffffc02042c2:	a021                	j	ffffffffc02042ca <do_exit+0xa0>
        while (current->cptr != NULL)
ffffffffc02042c4:	6018                	ld	a4,0(s0)
ffffffffc02042c6:	7b7c                	ld	a5,240(a4)
ffffffffc02042c8:	cb85                	beqz	a5,ffffffffc02042f8 <do_exit+0xce>
            current->cptr = proc->optr;
ffffffffc02042ca:	1007b683          	ld	a3,256(a5) # ffffffff80000100 <_binary_obj___user_matrix_out_size+0xffffffff7fff39c8>
            if ((proc->optr = initproc->cptr) != NULL)
ffffffffc02042ce:	6088                	ld	a0,0(s1)
            current->cptr = proc->optr;
ffffffffc02042d0:	fb74                	sd	a3,240(a4)
            if ((proc->optr = initproc->cptr) != NULL)
ffffffffc02042d2:	7978                	ld	a4,240(a0)
            proc->yptr = NULL;
ffffffffc02042d4:	0e07bc23          	sd	zero,248(a5)
            if ((proc->optr = initproc->cptr) != NULL)
ffffffffc02042d8:	10e7b023          	sd	a4,256(a5)
ffffffffc02042dc:	c311                	beqz	a4,ffffffffc02042e0 <do_exit+0xb6>
                initproc->cptr->yptr = proc;
ffffffffc02042de:	ff7c                	sd	a5,248(a4)
            if (proc->state == PROC_ZOMBIE)
ffffffffc02042e0:	4398                	lw	a4,0(a5)
            proc->parent = initproc;
ffffffffc02042e2:	f388                	sd	a0,32(a5)
            initproc->cptr = proc;
ffffffffc02042e4:	f97c                	sd	a5,240(a0)
            if (proc->state == PROC_ZOMBIE)
ffffffffc02042e6:	fd271fe3          	bne	a4,s2,ffffffffc02042c4 <do_exit+0x9a>
                if (initproc->wait_state == WT_CHILD)
ffffffffc02042ea:	0ec52783          	lw	a5,236(a0)
ffffffffc02042ee:	fd379be3          	bne	a5,s3,ffffffffc02042c4 <do_exit+0x9a>
                {
                    wakeup_proc(initproc);
ffffffffc02042f2:	5a5000ef          	jal	ra,ffffffffc0205096 <wakeup_proc>
ffffffffc02042f6:	b7f9                	j	ffffffffc02042c4 <do_exit+0x9a>
    if (flag)
ffffffffc02042f8:	020a1263          	bnez	s4,ffffffffc020431c <do_exit+0xf2>
                }
            }
        }
    }
    local_intr_restore(intr_flag);
    schedule();
ffffffffc02042fc:	64d000ef          	jal	ra,ffffffffc0205148 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc0204300:	601c                	ld	a5,0(s0)
ffffffffc0204302:	00003617          	auipc	a2,0x3
ffffffffc0204306:	d6e60613          	addi	a2,a2,-658 # ffffffffc0207070 <default_pmm_manager+0xa68>
ffffffffc020430a:	27100593          	li	a1,625
ffffffffc020430e:	43d4                	lw	a3,4(a5)
ffffffffc0204310:	00003517          	auipc	a0,0x3
ffffffffc0204314:	d2850513          	addi	a0,a0,-728 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204318:	97afc0ef          	jal	ra,ffffffffc0200492 <__panic>
        intr_enable();
ffffffffc020431c:	e8cfc0ef          	jal	ra,ffffffffc02009a8 <intr_enable>
ffffffffc0204320:	bff1                	j	ffffffffc02042fc <do_exit+0xd2>
        panic("idleproc exit.\n");
ffffffffc0204322:	00003617          	auipc	a2,0x3
ffffffffc0204326:	d2e60613          	addi	a2,a2,-722 # ffffffffc0207050 <default_pmm_manager+0xa48>
ffffffffc020432a:	23d00593          	li	a1,573
ffffffffc020432e:	00003517          	auipc	a0,0x3
ffffffffc0204332:	d0a50513          	addi	a0,a0,-758 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204336:	95cfc0ef          	jal	ra,ffffffffc0200492 <__panic>
            exit_mmap(mm);
ffffffffc020433a:	854e                	mv	a0,s3
ffffffffc020433c:	d44ff0ef          	jal	ra,ffffffffc0203880 <exit_mmap>
            put_pgdir(mm);
ffffffffc0204340:	854e                	mv	a0,s3
ffffffffc0204342:	a19ff0ef          	jal	ra,ffffffffc0203d5a <put_pgdir>
            mm_destroy(mm);
ffffffffc0204346:	854e                	mv	a0,s3
ffffffffc0204348:	b9cff0ef          	jal	ra,ffffffffc02036e4 <mm_destroy>
ffffffffc020434c:	bf35                	j	ffffffffc0204288 <do_exit+0x5e>
        panic("initproc exit.\n");
ffffffffc020434e:	00003617          	auipc	a2,0x3
ffffffffc0204352:	d1260613          	addi	a2,a2,-750 # ffffffffc0207060 <default_pmm_manager+0xa58>
ffffffffc0204356:	24100593          	li	a1,577
ffffffffc020435a:	00003517          	auipc	a0,0x3
ffffffffc020435e:	cde50513          	addi	a0,a0,-802 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204362:	930fc0ef          	jal	ra,ffffffffc0200492 <__panic>
        intr_disable();
ffffffffc0204366:	e48fc0ef          	jal	ra,ffffffffc02009ae <intr_disable>
        return 1;
ffffffffc020436a:	4a05                	li	s4,1
ffffffffc020436c:	bf1d                	j	ffffffffc02042a2 <do_exit+0x78>
            wakeup_proc(proc);
ffffffffc020436e:	529000ef          	jal	ra,ffffffffc0205096 <wakeup_proc>
ffffffffc0204372:	b789                	j	ffffffffc02042b4 <do_exit+0x8a>

ffffffffc0204374 <do_wait.part.0>:
}
...
ffffffffc0204376:	f84a                	sd	s2,48(sp)
ffffffffc0204378:	f44e                	sd	s3,40(sp)
        }
    }
    if (haskid)
    {
...
ffffffffc020437a:	80000937          	lui	s2,0x80000
    if (0 < pid && pid < MAX_PID)
ffffffffc020437e:	6989                	lui	s3,0x2
int do_wait(int pid, int *code_store)
ffffffffc0204380:	fc26                	sd	s1,56(sp)
ffffffffc0204382:	f052                	sd	s4,32(sp)
ffffffffc0204384:	ec56                	sd	s5,24(sp)
ffffffffc0204386:	e85a                	sd	s6,16(sp)
ffffffffc0204388:	e45e                	sd	s7,8(sp)
ffffffffc020438a:	e486                	sd	ra,72(sp)
ffffffffc020438c:	e0a2                	sd	s0,64(sp)
ffffffffc020438e:	84aa                	mv	s1,a0
ffffffffc0204390:	8a2e                	mv	s4,a1
        proc = current->cptr;
ffffffffc0204392:	000c3b97          	auipc	s7,0xc3
ffffffffc0204396:	ad6b8b93          	addi	s7,s7,-1322 # ffffffffc02c6e68 <current>
    if (0 < pid && pid < MAX_PID)
ffffffffc020439a:	00050b1b          	sext.w	s6,a0
ffffffffc020439e:	fff50a9b          	addiw	s5,a0,-1
ffffffffc02043a2:	19f9                	addi	s3,s3,-2
        current->wait_state = WT_CHILD;
ffffffffc02043a4:	0905                	addi	s2,s2,1
    if (pid != 0)
ffffffffc02043a6:	ccbd                	beqz	s1,ffffffffc0204424 <do_wait.part.0+0xb0>
    if (0 < pid && pid < MAX_PID)
ffffffffc02043a8:	0359e863          	bltu	s3,s5,ffffffffc02043d8 <do_wait.part.0+0x64>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02043ac:	45a9                	li	a1,10
ffffffffc02043ae:	855a                	mv	a0,s6
ffffffffc02043b0:	759000ef          	jal	ra,ffffffffc0205308 <hash32>
ffffffffc02043b4:	02051793          	slli	a5,a0,0x20
ffffffffc02043b8:	01c7d513          	srli	a0,a5,0x1c
ffffffffc02043bc:	000bf797          	auipc	a5,0xbf
ffffffffc02043c0:	a1478793          	addi	a5,a5,-1516 # ffffffffc02c2dd0 <hash_list>
ffffffffc02043c4:	953e                	add	a0,a0,a5
ffffffffc02043c6:	842a                	mv	s0,a0
        while ((le = list_next(le)) != list)
ffffffffc02043c8:	a029                	j	ffffffffc02043d2 <do_wait.part.0+0x5e>
            if (proc->pid == pid)
ffffffffc02043ca:	f2c42783          	lw	a5,-212(s0)
ffffffffc02043ce:	02978163          	beq	a5,s1,ffffffffc02043f0 <do_wait.part.0+0x7c>
ffffffffc02043d2:	6400                	ld	s0,8(s0)
        while ((le = list_next(le)) != list)
ffffffffc02043d4:	fe851be3          	bne	a0,s0,ffffffffc02043ca <do_wait.part.0+0x56>
        {
            do_exit(-E_KILLED);
        }
        goto repeat;
...
ffffffffc02043dc:	6406                	ld	s0,64(sp)
ffffffffc02043de:	74e2                	ld	s1,56(sp)
ffffffffc02043e0:	7942                	ld	s2,48(sp)
ffffffffc02043e2:	79a2                	ld	s3,40(sp)
ffffffffc02043e4:	7a02                	ld	s4,32(sp)
ffffffffc02043e6:	6ae2                	ld	s5,24(sp)
ffffffffc02043e8:	6b42                	ld	s6,16(sp)
ffffffffc02043ea:	6ba2                	ld	s7,8(sp)
ffffffffc02043ec:	6161                	addi	sp,sp,80
ffffffffc02043ee:	8082                	ret
        if (proc != NULL && proc->parent == current)
ffffffffc02043f0:	000bb683          	ld	a3,0(s7)
ffffffffc02043f4:	f4843783          	ld	a5,-184(s0)
ffffffffc02043f8:	fed790e3          	bne	a5,a3,ffffffffc02043d8 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE)
ffffffffc02043fc:	f2842703          	lw	a4,-216(s0)
ffffffffc0204400:	478d                	li	a5,3
ffffffffc0204402:	0ef70b63          	beq	a4,a5,ffffffffc02044f8 <do_wait.part.0+0x184>
        current->state = PROC_SLEEPING;
ffffffffc0204406:	4785                	li	a5,1
ffffffffc0204408:	c29c                	sw	a5,0(a3)
        current->wait_state = WT_CHILD;
ffffffffc020440a:	0f26a623          	sw	s2,236(a3)
        schedule();
ffffffffc020440e:	53b000ef          	jal	ra,ffffffffc0205148 <schedule>
        if (current->flags & PF_EXITING)
ffffffffc0204412:	000bb783          	ld	a5,0(s7)
ffffffffc0204416:	0b07a783          	lw	a5,176(a5)
ffffffffc020441a:	8b85                	andi	a5,a5,1
ffffffffc020441c:	d7c9                	beqz	a5,ffffffffc02043a6 <do_wait.part.0+0x32>
            do_exit(-E_KILLED);
ffffffffc020441e:	555d                	li	a0,-9
ffffffffc0204420:	e0bff0ef          	jal	ra,ffffffffc020422a <do_exit>
        proc = current->cptr;
ffffffffc0204424:	000bb683          	ld	a3,0(s7)
ffffffffc0204428:	7ae0                	ld	s0,240(a3)
        for (; proc != NULL; proc = proc->optr)
ffffffffc020442a:	d45d                	beqz	s0,ffffffffc02043d8 <do_wait.part.0+0x64>
            if (proc->state == PROC_ZOMBIE)
ffffffffc020442c:	470d                	li	a4,3
ffffffffc020442e:	a021                	j	ffffffffc0204436 <do_wait.part.0+0xc2>
        for (; proc != NULL; proc = proc->optr)
ffffffffc0204430:	10043403          	ld	s0,256(s0)
ffffffffc0204434:	d869                	beqz	s0,ffffffffc0204406 <do_wait.part.0+0x92>
            if (proc->state == PROC_ZOMBIE)
ffffffffc0204436:	401c                	lw	a5,0(s0)
ffffffffc0204438:	fee79ce3          	bne	a5,a4,ffffffffc0204430 <do_wait.part.0+0xbc>
    if (proc == idleproc || proc == initproc)
ffffffffc020443c:	000c3797          	auipc	a5,0xc3
ffffffffc0204440:	a347b783          	ld	a5,-1484(a5) # ffffffffc02c6e70 <idleproc>
ffffffffc0204444:	0c878963          	beq	a5,s0,ffffffffc0204516 <do_wait.part.0+0x1a2>
ffffffffc0204448:	000c3797          	auipc	a5,0xc3
ffffffffc020444c:	a307b783          	ld	a5,-1488(a5) # ffffffffc02c6e78 <initproc>
ffffffffc0204450:	0cf40363          	beq	s0,a5,ffffffffc0204516 <do_wait.part.0+0x1a2>
    if (code_store != NULL)
ffffffffc0204454:	000a0663          	beqz	s4,ffffffffc0204460 <do_wait.part.0+0xec>
        *code_store = proc->exit_code;
ffffffffc0204458:	0e842783          	lw	a5,232(s0)
ffffffffc020445c:	00fa2023          	sw	a5,0(s4) # 1000 <_binary_obj___user_faultread_out_size-0x8f60>
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0204460:	100027f3          	csrr	a5,sstatus
ffffffffc0204464:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204466:	4581                	li	a1,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0204468:	e7c1                	bnez	a5,ffffffffc02044f0 <do_wait.part.0+0x17c>
    __list_del(listelm->prev, listelm->next);
ffffffffc020446a:	6c70                	ld	a2,216(s0)
ffffffffc020446c:	7074                	ld	a3,224(s0)
    if (proc->optr != NULL)
ffffffffc020446e:	10043703          	ld	a4,256(s0)
        proc->optr->yptr = proc->yptr;
ffffffffc0204472:	7c7c                	ld	a5,248(s0)
    prev->next = next;
ffffffffc0204474:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc0204476:	e290                	sd	a2,0(a3)
    __list_del(listelm->prev, listelm->next);
ffffffffc0204478:	6470                	ld	a2,200(s0)
ffffffffc020447a:	6874                	ld	a3,208(s0)
    prev->next = next;
ffffffffc020447c:	e614                	sd	a3,8(a2)
    next->prev = prev;
ffffffffc020447e:	e290                	sd	a2,0(a3)
    if (proc->optr != NULL)
ffffffffc0204480:	c319                	beqz	a4,ffffffffc0204486 <do_wait.part.0+0x112>
        proc->optr->yptr = proc->yptr;
ffffffffc0204482:	ff7c                	sd	a5,248(a4)
    if (proc->yptr != NULL)
ffffffffc0204484:	7c7c                	ld	a5,248(s0)
ffffffffc0204486:	c3b5                	beqz	a5,ffffffffc02044ea <do_wait.part.0+0x176>
        proc->yptr->optr = proc->optr;
ffffffffc0204488:	10e7b023          	sd	a4,256(a5)
    nr_process--;
ffffffffc020448c:	000c3717          	auipc	a4,0xc3
ffffffffc0204490:	9f470713          	addi	a4,a4,-1548 # ffffffffc02c6e80 <nr_process>
ffffffffc0204494:	431c                	lw	a5,0(a4)
ffffffffc0204496:	37fd                	addiw	a5,a5,-1
ffffffffc0204498:	c31c                	sw	a5,0(a4)
    if (flag)
ffffffffc020449a:	e5a9                	bnez	a1,ffffffffc02044e4 <do_wait.part.0+0x170>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc020449c:	6814                	ld	a3,16(s0)
ffffffffc020449e:	c02007b7          	lui	a5,0xc0200
ffffffffc02044a2:	04f6ee63          	bltu	a3,a5,ffffffffc02044fe <do_wait.part.0+0x18a>
ffffffffc02044a6:	000c3797          	auipc	a5,0xc3
ffffffffc02044aa:	9ba7b783          	ld	a5,-1606(a5) # ffffffffc02c6e60 <va_pa_offset>
ffffffffc02044ae:	8e9d                	sub	a3,a3,a5
    if (PPN(pa) >= npage)
ffffffffc02044b0:	82b1                	srli	a3,a3,0xc
ffffffffc02044b2:	000c3797          	auipc	a5,0xc3
ffffffffc02044b6:	9967b783          	ld	a5,-1642(a5) # ffffffffc02c6e48 <npage>
ffffffffc02044ba:	06f6fa63          	bgeu	a3,a5,ffffffffc020452e <do_wait.part.0+0x1ba>
    return &pages[PPN(pa) - nbase];
ffffffffc02044be:	00004517          	auipc	a0,0x4
ffffffffc02044c2:	bfa53503          	ld	a0,-1030(a0) # ffffffffc02080b8 <nbase>
ffffffffc02044c6:	8e89                	sub	a3,a3,a0
ffffffffc02044c8:	069a                	slli	a3,a3,0x6
ffffffffc02044ca:	000c3517          	auipc	a0,0xc3
ffffffffc02044ce:	98653503          	ld	a0,-1658(a0) # ffffffffc02c6e50 <pages>
ffffffffc02044d2:	9536                	add	a0,a0,a3
ffffffffc02044d4:	4589                	li	a1,2
ffffffffc02044d6:	8e9fd0ef          	jal	ra,ffffffffc0201dbe <free_pages>
    kfree(proc);
ffffffffc02044da:	8522                	mv	a0,s0
ffffffffc02044dc:	f76fd0ef          	jal	ra,ffffffffc0201c52 <kfree>
    return 0;
ffffffffc02044e0:	4501                	li	a0,0
ffffffffc02044e2:	bde5                	j	ffffffffc02043da <do_wait.part.0+0x66>
        intr_enable();
ffffffffc02044e4:	cc4fc0ef          	jal	ra,ffffffffc02009a8 <intr_enable>
ffffffffc02044e8:	bf55                	j	ffffffffc020449c <do_wait.part.0+0x128>
        proc->parent->cptr = proc->optr;
ffffffffc02044ea:	701c                	ld	a5,32(s0)
ffffffffc02044ec:	fbf8                	sd	a4,240(a5)
ffffffffc02044ee:	bf79                	j	ffffffffc020448c <do_wait.part.0+0x118>
        intr_disable();
ffffffffc02044f0:	cbefc0ef          	jal	ra,ffffffffc02009ae <intr_disable>
        return 1;
ffffffffc02044f4:	4585                	li	a1,1
ffffffffc02044f6:	bf95                	j	ffffffffc020446a <do_wait.part.0+0xf6>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02044f8:	f2840413          	addi	s0,s0,-216
ffffffffc02044fc:	b781                	j	ffffffffc020443c <do_wait.part.0+0xc8>
    return pa2page(PADDR(kva));
ffffffffc02044fe:	00002617          	auipc	a2,0x2
ffffffffc0204502:	1ea60613          	addi	a2,a2,490 # ffffffffc02066e8 <default_pmm_manager+0xe0>
ffffffffc0204506:	07700593          	li	a1,119
ffffffffc020450a:	00002517          	auipc	a0,0x2
ffffffffc020450e:	15e50513          	addi	a0,a0,350 # ffffffffc0206668 <default_pmm_manager+0x60>
ffffffffc0204512:	f81fb0ef          	jal	ra,ffffffffc0200492 <__panic>
        panic("wait idleproc or initproc.\n");
ffffffffc0204516:	00003617          	auipc	a2,0x3
ffffffffc020451a:	b7a60613          	addi	a2,a2,-1158 # ffffffffc0207090 <default_pmm_manager+0xa88>
ffffffffc020451e:	39500593          	li	a1,917
ffffffffc0204522:	00003517          	auipc	a0,0x3
ffffffffc0204526:	b1650513          	addi	a0,a0,-1258 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc020452a:	f69fb0ef          	jal	ra,ffffffffc0200492 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc020452e:	00002617          	auipc	a2,0x2
ffffffffc0204532:	1e260613          	addi	a2,a2,482 # ffffffffc0206710 <default_pmm_manager+0x108>
ffffffffc0204536:	06900593          	li	a1,105
ffffffffc020453a:	00002517          	auipc	a0,0x2
ffffffffc020453e:	12e50513          	addi	a0,a0,302 # ffffffffc0206668 <default_pmm_manager+0x60>
ffffffffc0204542:	f51fb0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc0204546 <init_main>:
}
...
init_main(void *arg)
{
ffffffffc0204546:	1141                	addi	sp,sp,-16
ffffffffc0204548:	e406                	sd	ra,8(sp)
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc020454a:	8b5fd0ef          	jal	ra,ffffffffc0201dfe <nr_free_pages>
    size_t kernel_allocated_store = kallocated();
ffffffffc020454e:	e50fd0ef          	jal	ra,ffffffffc0201b9e <kallocated>

    int pid = kernel_thread(user_main, NULL, 0);
ffffffffc0204552:	4601                	li	a2,0
ffffffffc0204554:	4581                	li	a1,0
ffffffffc0204556:	00000517          	auipc	a0,0x0
ffffffffc020455a:	62850513          	addi	a0,a0,1576 # ffffffffc0204b7e <user_main>
ffffffffc020455e:	c7dff0ef          	jal	ra,ffffffffc02041da <kernel_thread>
    if (pid <= 0)
ffffffffc0204562:	00a04563          	bgtz	a0,ffffffffc020456c <init_main+0x26>
ffffffffc0204566:	a071                	j	ffffffffc02045f2 <init_main+0xac>
    ...
    {
        schedule();
ffffffffc0204568:	3e1000ef          	jal	ra,ffffffffc0205148 <schedule>
    if (code_store != NULL)
ffffffffc020456c:	4581                	li	a1,0
ffffffffc020456e:	4501                	li	a0,0
ffffffffc0204570:	e05ff0ef          	jal	ra,ffffffffc0204374 <do_wait.part.0>
    while (do_wait(0, NULL) == 0)
ffffffffc0204574:	d975                	beqz	a0,ffffffffc0204568 <init_main+0x22>
    }

    cprintf("all user-mode processes have quit.\n");
ffffffffc0204576:	00003517          	auipc	a0,0x3
ffffffffc020457a:	b5a50513          	addi	a0,a0,-1190 # ffffffffc02070d0 <default_pmm_manager+0xac8>
ffffffffc020457e:	c1bfb0ef          	jal	ra,ffffffffc0200198 <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc0204582:	000c3797          	auipc	a5,0xc3
ffffffffc0204586:	8f67b783          	ld	a5,-1802(a5) # ffffffffc02c6e78 <initproc>
ffffffffc020458a:	7bf8                	ld	a4,240(a5)
ffffffffc020458c:	e339                	bnez	a4,ffffffffc02045d2 <init_main+0x8c>
ffffffffc020458e:	7ff8                	ld	a4,248(a5)
ffffffffc0204590:	e329                	bnez	a4,ffffffffc02045d2 <init_main+0x8c>
ffffffffc0204592:	1007b703          	ld	a4,256(a5)
ffffffffc0204596:	ef15                	bnez	a4,ffffffffc02045d2 <init_main+0x8c>
    assert(nr_process == 2);
ffffffffc0204598:	000c3697          	auipc	a3,0xc3
ffffffffc020459c:	8e86a683          	lw	a3,-1816(a3) # ffffffffc02c6e80 <nr_process>
ffffffffc02045a0:	4709                	li	a4,2
ffffffffc02045a2:	0ae69463          	bne	a3,a4,ffffffffc020464a <init_main+0x104>
    return listelm->next;
ffffffffc02045a6:	000c3697          	auipc	a3,0xc3
ffffffffc02045aa:	82a68693          	addi	a3,a3,-2006 # ffffffffc02c6dd0 <proc_list>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc02045ae:	6698                	ld	a4,8(a3)
ffffffffc02045b0:	0c878793          	addi	a5,a5,200
ffffffffc02045b4:	06f71b63          	bne	a4,a5,ffffffffc020462a <init_main+0xe4>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc02045b8:	629c                	ld	a5,0(a3)
ffffffffc02045ba:	04f71863          	bne	a4,a5,ffffffffc020460a <init_main+0xc4>

    cprintf("init check memory pass.\n");
ffffffffc02045be:	00003517          	auipc	a0,0x3
ffffffffc02045c2:	bfa50513          	addi	a0,a0,-1030 # ffffffffc02071b8 <default_pmm_manager+0xbb0>
ffffffffc02045c6:	bd3fb0ef          	jal	ra,ffffffffc0200198 <cprintf>
    return 0;
}
ffffffffc02045ca:	60a2                	ld	ra,8(sp)
ffffffffc02045cc:	4501                	li	a0,0
ffffffffc02045ce:	0141                	addi	sp,sp,16
ffffffffc02045d0:	8082                	ret
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc02045d2:	00003697          	auipc	a3,0x3
ffffffffc02045d6:	b2668693          	addi	a3,a3,-1242 # ffffffffc02070f8 <default_pmm_manager+0xaf0>
ffffffffc02045da:	00002617          	auipc	a2,0x2
ffffffffc02045de:	c7e60613          	addi	a2,a2,-898 # ffffffffc0206258 <commands+0x818>
ffffffffc02045e2:	40100593          	li	a1,1025
ffffffffc02045e6:	00003517          	auipc	a0,0x3
ffffffffc02045ea:	a5250513          	addi	a0,a0,-1454 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc02045ee:	ea5fb0ef          	jal	ra,ffffffffc0200492 <__panic>
        panic("create user_main failed.\n");
ffffffffc02045f2:	00003617          	auipc	a2,0x3
ffffffffc02045f6:	abe60613          	addi	a2,a2,-1346 # ffffffffc02070b0 <default_pmm_manager+0xaa8>
ffffffffc02045fa:	3f800593          	li	a1,1016
ffffffffc02045fe:	00003517          	auipc	a0,0x3
ffffffffc0204602:	a3a50513          	addi	a0,a0,-1478 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204606:	e8dfb0ef          	jal	ra,ffffffffc0200492 <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc020460a:	00003697          	auipc	a3,0x3
ffffffffc020460e:	b7e68693          	addi	a3,a3,-1154 # ffffffffc0207188 <default_pmm_manager+0xb80>
ffffffffc0204612:	00002617          	auipc	a2,0x2
ffffffffc0204616:	c4660613          	addi	a2,a2,-954 # ffffffffc0206258 <commands+0x818>
ffffffffc020461a:	40400593          	li	a1,1028
ffffffffc020461e:	00003517          	auipc	a0,0x3
ffffffffc0204622:	a1a50513          	addi	a0,a0,-1510 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204626:	e6dfb0ef          	jal	ra,ffffffffc0200492 <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc020462a:	00003697          	auipc	a3,0x3
ffffffffc020462e:	b2e68693          	addi	a3,a3,-1234 # ffffffffc0207158 <default_pmm_manager+0xb50>
ffffffffc0204632:	00002617          	auipc	a2,0x2
ffffffffc0204636:	c2660613          	addi	a2,a2,-986 # ffffffffc0206258 <commands+0x818>
ffffffffc020463a:	40300593          	li	a1,1027
ffffffffc020463e:	00003517          	auipc	a0,0x3
ffffffffc0204642:	9fa50513          	addi	a0,a0,-1542 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204646:	e4dfb0ef          	jal	ra,ffffffffc0200492 <__panic>
    assert(nr_process == 2);
ffffffffc020464a:	00003697          	auipc	a3,0x3
ffffffffc020464e:	afe68693          	addi	a3,a3,-1282 # ffffffffc0207148 <default_pmm_manager+0xb40>
ffffffffc0204652:	00002617          	auipc	a2,0x2
ffffffffc0204656:	c0660613          	addi	a2,a2,-1018 # ffffffffc0206258 <commands+0x818>
ffffffffc020465a:	40200593          	li	a1,1026
ffffffffc020465e:	00003517          	auipc	a0,0x3
ffffffffc0204662:	9da50513          	addi	a0,a0,-1574 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204666:	e2dfb0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc020466a <do_execve>:
{
ffffffffc020466a:	7171                	addi	sp,sp,-176
ffffffffc020466c:	e4ee                	sd	s11,72(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020466e:	000c2d97          	auipc	s11,0xc2
ffffffffc0204672:	7fad8d93          	addi	s11,s11,2042 # ffffffffc02c6e68 <current>
ffffffffc0204676:	000db783          	ld	a5,0(s11)
{
ffffffffc020467a:	e54e                	sd	s3,136(sp)
ffffffffc020467c:	ed26                	sd	s1,152(sp)
    struct mm_struct *mm = current->mm;
ffffffffc020467e:	0287b983          	ld	s3,40(a5)
{
ffffffffc0204682:	e94a                	sd	s2,144(sp)
ffffffffc0204684:	f4de                	sd	s7,104(sp)
ffffffffc0204686:	892a                	mv	s2,a0
ffffffffc0204688:	8bb2                	mv	s7,a2
ffffffffc020468a:	84ae                	mv	s1,a1
    if (!user_mem_check(mm, (uintptr_t)name, len, 0))
ffffffffc020468c:	862e                	mv	a2,a1
ffffffffc020468e:	4681                	li	a3,0
ffffffffc0204690:	85aa                	mv	a1,a0
ffffffffc0204692:	854e                	mv	a0,s3
{
ffffffffc0204694:	f506                	sd	ra,168(sp)
ffffffffc0204696:	f122                	sd	s0,160(sp)
ffffffffc0204698:	e152                	sd	s4,128(sp)
ffffffffc020469a:	fcd6                	sd	s5,120(sp)
ffffffffc020469c:	f8da                	sd	s6,112(sp)
ffffffffc020469e:	f0e2                	sd	s8,96(sp)
ffffffffc02046a0:	ece6                	sd	s9,88(sp)
ffffffffc02046a2:	e8ea                	sd	s10,80(sp)
ffffffffc02046a4:	f05e                	sd	s7,32(sp)
    if (!user_mem_check(mm, (uintptr_t)name, len, 0))
ffffffffc02046a6:	d74ff0ef          	jal	ra,ffffffffc0203c1a <user_mem_check>
ffffffffc02046aa:	40050a63          	beqz	a0,ffffffffc0204abe <do_execve+0x454>
    memset(local_name, 0, sizeof(local_name));
ffffffffc02046ae:	4641                	li	a2,16
ffffffffc02046b0:	4581                	li	a1,0
ffffffffc02046b2:	1808                	addi	a0,sp,48
ffffffffc02046b4:	0fa010ef          	jal	ra,ffffffffc02057ae <memset>
    memcpy(local_name, name, len);
ffffffffc02046b8:	47bd                	li	a5,15
ffffffffc02046ba:	8626                	mv	a2,s1
ffffffffc02046bc:	1e97e263          	bltu	a5,s1,ffffffffc02048a0 <do_execve+0x236>
ffffffffc02046c0:	85ca                	mv	a1,s2
ffffffffc02046c2:	1808                	addi	a0,sp,48
ffffffffc02046c4:	0fc010ef          	jal	ra,ffffffffc02057c0 <memcpy>
    if (mm != NULL)
ffffffffc02046c8:	1e098363          	beqz	s3,ffffffffc02048ae <do_execve+0x244>
        cputs("mm != NULL");
ffffffffc02046cc:	00002517          	auipc	a0,0x2
ffffffffc02046d0:	76c50513          	addi	a0,a0,1900 # ffffffffc0206e38 <default_pmm_manager+0x830>
ffffffffc02046d4:	afdfb0ef          	jal	ra,ffffffffc02001d0 <cputs>
ffffffffc02046d8:	000c2797          	auipc	a5,0xc2
ffffffffc02046dc:	7607b783          	ld	a5,1888(a5) # ffffffffc02c6e38 <boot_pgdir_pa>
ffffffffc02046e0:	577d                	li	a4,-1
ffffffffc02046e2:	177e                	slli	a4,a4,0x3f
ffffffffc02046e4:	83b1                	srli	a5,a5,0xc
ffffffffc02046e6:	8fd9                	or	a5,a5,a4
ffffffffc02046e8:	18079073          	csrw	satp,a5
ffffffffc02046ec:	0309a783          	lw	a5,48(s3) # 2030 <_binary_obj___user_faultread_out_size-0x7f30>
ffffffffc02046f0:	fff7871b          	addiw	a4,a5,-1
ffffffffc02046f4:	02e9a823          	sw	a4,48(s3)
        if (mm_count_dec(mm) == 0)
ffffffffc02046f8:	2c070463          	beqz	a4,ffffffffc02049c0 <do_execve+0x356>
        current->mm = NULL;
ffffffffc02046fc:	000db783          	ld	a5,0(s11)
ffffffffc0204700:	0207b423          	sd	zero,40(a5)
    if ((mm = mm_create()) == NULL)
ffffffffc0204704:	ea1fe0ef          	jal	ra,ffffffffc02035a4 <mm_create>
ffffffffc0204708:	84aa                	mv	s1,a0
ffffffffc020470a:	1c050d63          	beqz	a0,ffffffffc02048e4 <do_execve+0x27a>
    if ((page = alloc_page()) == NULL)
ffffffffc020470e:	4505                	li	a0,1
ffffffffc0204710:	e70fd0ef          	jal	ra,ffffffffc0201d80 <alloc_pages>
ffffffffc0204714:	3a050963          	beqz	a0,ffffffffc0204ac6 <do_execve+0x45c>
    return page - pages + nbase;
ffffffffc0204718:	000c2c97          	auipc	s9,0xc2
ffffffffc020471c:	738c8c93          	addi	s9,s9,1848 # ffffffffc02c6e50 <pages>
ffffffffc0204720:	000cb683          	ld	a3,0(s9)
    return KADDR(page2pa(page));
ffffffffc0204724:	000c2c17          	auipc	s8,0xc2
ffffffffc0204728:	724c0c13          	addi	s8,s8,1828 # ffffffffc02c6e48 <npage>
    return page - pages + nbase;
ffffffffc020472c:	00004717          	auipc	a4,0x4
ffffffffc0204730:	98c73703          	ld	a4,-1652(a4) # ffffffffc02080b8 <nbase>
ffffffffc0204734:	40d506b3          	sub	a3,a0,a3
ffffffffc0204738:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc020473a:	5afd                	li	s5,-1
ffffffffc020473c:	000c3783          	ld	a5,0(s8)
    return page - pages + nbase;
ffffffffc0204740:	96ba                	add	a3,a3,a4
ffffffffc0204742:	e83a                	sd	a4,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204744:	00cad713          	srli	a4,s5,0xc
ffffffffc0204748:	ec3a                	sd	a4,24(sp)
ffffffffc020474a:	8f75                	and	a4,a4,a3
    return page2ppn(page) << PGSHIFT;
ffffffffc020474c:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020474e:	38f77063          	bgeu	a4,a5,ffffffffc0204ace <do_execve+0x464>
ffffffffc0204752:	000c2b17          	auipc	s6,0xc2
ffffffffc0204756:	70eb0b13          	addi	s6,s6,1806 # ffffffffc02c6e60 <va_pa_offset>
ffffffffc020475a:	000b3903          	ld	s2,0(s6)
    memcpy(pgdir, boot_pgdir_va, PGSIZE);
ffffffffc020475e:	6605                	lui	a2,0x1
ffffffffc0204760:	000c2597          	auipc	a1,0xc2
ffffffffc0204764:	6e05b583          	ld	a1,1760(a1) # ffffffffc02c6e40 <boot_pgdir_va>
ffffffffc0204768:	9936                	add	s2,s2,a3
ffffffffc020476a:	854a                	mv	a0,s2
ffffffffc020476c:	054010ef          	jal	ra,ffffffffc02057c0 <memcpy>
    if (elf->e_magic != ELF_MAGIC)
ffffffffc0204770:	7782                	ld	a5,32(sp)
ffffffffc0204772:	4398                	lw	a4,0(a5)
ffffffffc0204774:	464c47b7          	lui	a5,0x464c4
    mm->pgdir = pgdir;
ffffffffc0204778:	0124bc23          	sd	s2,24(s1)
    if (elf->e_magic != ELF_MAGIC)
ffffffffc020477c:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_matrix_out_size+0x464b7e47>
ffffffffc0204780:	14f71863          	bne	a4,a5,ffffffffc02048d0 <do_execve+0x266>
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0204784:	7682                	ld	a3,32(sp)
ffffffffc0204786:	0386d703          	lhu	a4,56(a3)
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc020478a:	0206b983          	ld	s3,32(a3)
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc020478e:	00371793          	slli	a5,a4,0x3
ffffffffc0204792:	8f99                	sub	a5,a5,a4
    struct proghdr *ph = (struct proghdr *)(binary + elf->e_phoff);
ffffffffc0204794:	99b6                	add	s3,s3,a3
    struct proghdr *ph_end = ph + elf->e_phnum;
ffffffffc0204796:	078e                	slli	a5,a5,0x3
ffffffffc0204798:	97ce                	add	a5,a5,s3
ffffffffc020479a:	f43e                	sd	a5,40(sp)
    for (; ph < ph_end; ph++)
ffffffffc020479c:	00f9fc63          	bgeu	s3,a5,ffffffffc02047b4 <do_execve+0x14a>
        if (ph->p_type != ELF_PT_LOAD)
ffffffffc02047a0:	0009a783          	lw	a5,0(s3)
ffffffffc02047a4:	4705                	li	a4,1
ffffffffc02047a6:	14e78163          	beq	a5,a4,ffffffffc02048e8 <do_execve+0x27e>
    for (; ph < ph_end; ph++)
ffffffffc02047aa:	77a2                	ld	a5,40(sp)
ffffffffc02047ac:	03898993          	addi	s3,s3,56
ffffffffc02047b0:	fef9e8e3          	bltu	s3,a5,ffffffffc02047a0 <do_execve+0x136>
    if ((ret = mm_map(mm, USTACKTOP - USTACKSIZE, USTACKSIZE, vm_flags, NULL)) != 0)
ffffffffc02047b4:	4701                	li	a4,0
ffffffffc02047b6:	46ad                	li	a3,11
ffffffffc02047b8:	00100637          	lui	a2,0x100
ffffffffc02047bc:	7ff005b7          	lui	a1,0x7ff00
ffffffffc02047c0:	8526                	mv	a0,s1
ffffffffc02047c2:	f75fe0ef          	jal	ra,ffffffffc0203736 <mm_map>
ffffffffc02047c6:	8a2a                	mv	s4,a0
ffffffffc02047c8:	1e051263          	bnez	a0,ffffffffc02049ac <do_execve+0x342>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - PGSIZE, PTE_USER) != NULL);
ffffffffc02047cc:	6c88                	ld	a0,24(s1)
ffffffffc02047ce:	467d                	li	a2,31
ffffffffc02047d0:	7ffff5b7          	lui	a1,0x7ffff
ffffffffc02047d4:	cebfe0ef          	jal	ra,ffffffffc02034be <pgdir_alloc_page>
ffffffffc02047d8:	38050363          	beqz	a0,ffffffffc0204b5e <do_execve+0x4f4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 2 * PGSIZE, PTE_USER) != NULL);
ffffffffc02047dc:	6c88                	ld	a0,24(s1)
ffffffffc02047de:	467d                	li	a2,31
ffffffffc02047e0:	7fffe5b7          	lui	a1,0x7fffe
ffffffffc02047e4:	cdbfe0ef          	jal	ra,ffffffffc02034be <pgdir_alloc_page>
ffffffffc02047e8:	34050b63          	beqz	a0,ffffffffc0204b3e <do_execve+0x4d4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 3 * PGSIZE, PTE_USER) != NULL);
ffffffffc02047ec:	6c88                	ld	a0,24(s1)
ffffffffc02047ee:	467d                	li	a2,31
ffffffffc02047f0:	7fffd5b7          	lui	a1,0x7fffd
ffffffffc02047f4:	ccbfe0ef          	jal	ra,ffffffffc02034be <pgdir_alloc_page>
ffffffffc02047f8:	32050363          	beqz	a0,ffffffffc0204b1e <do_execve+0x4b4>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 4 * PGSIZE, PTE_USER) != NULL);
ffffffffc02047fc:	6c88                	ld	a0,24(s1)
ffffffffc02047fe:	467d                	li	a2,31
ffffffffc0204800:	7fffc5b7          	lui	a1,0x7fffc
ffffffffc0204804:	cbbfe0ef          	jal	ra,ffffffffc02034be <pgdir_alloc_page>
ffffffffc0204808:	2e050b63          	beqz	a0,ffffffffc0204afe <do_execve+0x494>
    mm->mm_count += 1;
ffffffffc020480c:	589c                	lw	a5,48(s1)
    current->mm = mm;
ffffffffc020480e:	000db603          	ld	a2,0(s11)
    current->pgdir = PADDR(mm->pgdir);
ffffffffc0204812:	6c94                	ld	a3,24(s1)
ffffffffc0204814:	2785                	addiw	a5,a5,1
ffffffffc0204816:	d89c                	sw	a5,48(s1)
    current->mm = mm;
ffffffffc0204818:	f604                	sd	s1,40(a2)
    current->pgdir = PADDR(mm->pgdir);
ffffffffc020481a:	c02007b7          	lui	a5,0xc0200
ffffffffc020481e:	2cf6e463          	bltu	a3,a5,ffffffffc0204ae6 <do_execve+0x47c>
ffffffffc0204822:	000b3783          	ld	a5,0(s6)
ffffffffc0204826:	577d                	li	a4,-1
ffffffffc0204828:	177e                	slli	a4,a4,0x3f
ffffffffc020482a:	8e9d                	sub	a3,a3,a5
ffffffffc020482c:	00c6d793          	srli	a5,a3,0xc
ffffffffc0204830:	f654                	sd	a3,168(a2)
ffffffffc0204832:	8fd9                	or	a5,a5,a4
ffffffffc0204834:	18079073          	csrw	satp,a5
    struct trapframe *tf = current->tf;
ffffffffc0204838:	7240                	ld	s0,160(a2)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc020483a:	4581                	li	a1,0
ffffffffc020483c:	12000613          	li	a2,288
ffffffffc0204840:	8522                	mv	a0,s0
    uintptr_t sstatus = tf->status;
ffffffffc0204842:	10043483          	ld	s1,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc0204846:	769000ef          	jal	ra,ffffffffc02057ae <memset>
    tf->epc = elf->e_entry;      // ELF 程序入口，sret 会跳转到这里执行指令
ffffffffc020484a:	7782                	ld	a5,32(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020484c:	000db903          	ld	s2,0(s11)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc0204850:	edf4f493          	andi	s1,s1,-289
    tf->epc = elf->e_entry;      // ELF 程序入口，sret 会跳转到这里执行指令
ffffffffc0204854:	6f98                	ld	a4,24(a5)
    tf->gpr.sp = USTACKTOP;      // 设置用户栈顶
ffffffffc0204856:	4785                	li	a5,1
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204858:	0b490913          	addi	s2,s2,180 # ffffffff800000b4 <_binary_obj___user_matrix_out_size+0xffffffff7fff397c>
    tf->gpr.sp = USTACKTOP;      // 设置用户栈顶
ffffffffc020485c:	07fe                	slli	a5,a5,0x1f
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc020485e:	0204e493          	ori	s1,s1,32
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204862:	4641                	li	a2,16
ffffffffc0204864:	4581                	li	a1,0
    tf->gpr.sp = USTACKTOP;      // 设置用户栈顶
ffffffffc0204866:	e81c                	sd	a5,16(s0)
    tf->epc = elf->e_entry;      // ELF 程序入口，sret 会跳转到这里执行指令
ffffffffc0204868:	10e43423          	sd	a4,264(s0)
    tf->status = (sstatus & ~SSTATUS_SPP) | SSTATUS_SPIE;
ffffffffc020486c:	10943023          	sd	s1,256(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204870:	854a                	mv	a0,s2
ffffffffc0204872:	73d000ef          	jal	ra,ffffffffc02057ae <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204876:	463d                	li	a2,15
ffffffffc0204878:	180c                	addi	a1,sp,48
ffffffffc020487a:	854a                	mv	a0,s2
ffffffffc020487c:	745000ef          	jal	ra,ffffffffc02057c0 <memcpy>
}
ffffffffc0204880:	70aa                	ld	ra,168(sp)
ffffffffc0204882:	740a                	ld	s0,160(sp)
ffffffffc0204884:	64ea                	ld	s1,152(sp)
ffffffffc0204886:	694a                	ld	s2,144(sp)
ffffffffc0204888:	69aa                	ld	s3,136(sp)
ffffffffc020488a:	7ae6                	ld	s5,120(sp)
ffffffffc020488c:	7b46                	ld	s6,112(sp)
ffffffffc020488e:	7ba6                	ld	s7,104(sp)
ffffffffc0204890:	7c06                	ld	s8,96(sp)
ffffffffc0204892:	6ce6                	ld	s9,88(sp)
ffffffffc0204894:	6d46                	ld	s10,80(sp)
ffffffffc0204896:	6da6                	ld	s11,72(sp)
ffffffffc0204898:	8552                	mv	a0,s4
ffffffffc020489a:	6a0a                	ld	s4,128(sp)
ffffffffc020489c:	614d                	addi	sp,sp,176
ffffffffc020489e:	8082                	ret
    memcpy(local_name, name, len);
ffffffffc02048a0:	463d                	li	a2,15
ffffffffc02048a2:	85ca                	mv	a1,s2
ffffffffc02048a4:	1808                	addi	a0,sp,48
ffffffffc02048a6:	71b000ef          	jal	ra,ffffffffc02057c0 <memcpy>
    if (mm != NULL)
ffffffffc02048aa:	e20991e3          	bnez	s3,ffffffffc02046cc <do_execve+0x62>
    if (current->mm != NULL)
ffffffffc02048ae:	000db783          	ld	a5,0(s11)
ffffffffc02048b2:	779c                	ld	a5,40(a5)
ffffffffc02048b4:	e40788e3          	beqz	a5,ffffffffc0204704 <do_execve+0x9a>
        panic("load_icode: current->mm must be empty.\n");
ffffffffc02048b8:	00003617          	auipc	a2,0x3
ffffffffc02048bc:	92060613          	addi	a2,a2,-1760 # ffffffffc02071d8 <default_pmm_manager+0xbd0>
ffffffffc02048c0:	27d00593          	li	a1,637
ffffffffc02048c4:	00002517          	auipc	a0,0x2
ffffffffc02048c8:	77450513          	addi	a0,a0,1908 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc02048cc:	bc7fb0ef          	jal	ra,ffffffffc0200492 <__panic>
    put_pgdir(mm);
ffffffffc02048d0:	8526                	mv	a0,s1
ffffffffc02048d2:	c88ff0ef          	jal	ra,ffffffffc0203d5a <put_pgdir>
    mm_destroy(mm);
ffffffffc02048d6:	8526                	mv	a0,s1
ffffffffc02048d8:	e0dfe0ef          	jal	ra,ffffffffc02036e4 <mm_destroy>
        ret = -E_INVAL_ELF;
ffffffffc02048dc:	5a61                	li	s4,-8
    do_exit(ret);
ffffffffc02048de:	8552                	mv	a0,s4
ffffffffc02048e0:	94bff0ef          	jal	ra,ffffffffc020422a <do_exit>
    int ret = -E_NO_MEM;
ffffffffc02048e4:	5a71                	li	s4,-4
ffffffffc02048e6:	bfe5                	j	ffffffffc02048de <do_execve+0x274>
        if (ph->p_filesz > ph->p_memsz)
ffffffffc02048e8:	0289b603          	ld	a2,40(s3)
ffffffffc02048ec:	0209b783          	ld	a5,32(s3)
ffffffffc02048f0:	1cf66d63          	bltu	a2,a5,ffffffffc0204aca <do_execve+0x460>
        if (ph->p_flags & ELF_PF_X)
ffffffffc02048f4:	0049a783          	lw	a5,4(s3)
ffffffffc02048f8:	0017f693          	andi	a3,a5,1
ffffffffc02048fc:	c291                	beqz	a3,ffffffffc0204900 <do_execve+0x296>
            vm_flags |= VM_EXEC;
ffffffffc02048fe:	4691                	li	a3,4
        if (ph->p_flags & ELF_PF_W)
ffffffffc0204900:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_R)
ffffffffc0204904:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W)
ffffffffc0204906:	e779                	bnez	a4,ffffffffc02049d4 <do_execve+0x36a>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0204908:	4d45                	li	s10,17
        if (ph->p_flags & ELF_PF_R)
ffffffffc020490a:	c781                	beqz	a5,ffffffffc0204912 <do_execve+0x2a8>
            vm_flags |= VM_READ;
ffffffffc020490c:	0016e693          	ori	a3,a3,1
            perm |= PTE_R;
ffffffffc0204910:	4d4d                	li	s10,19
        if (vm_flags & VM_WRITE)
ffffffffc0204912:	0026f793          	andi	a5,a3,2
ffffffffc0204916:	e3f1                	bnez	a5,ffffffffc02049da <do_execve+0x370>
        if (vm_flags & VM_EXEC)
ffffffffc0204918:	0046f793          	andi	a5,a3,4
ffffffffc020491c:	c399                	beqz	a5,ffffffffc0204922 <do_execve+0x2b8>
            perm |= PTE_X;
ffffffffc020491e:	008d6d13          	ori	s10,s10,8
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0)
ffffffffc0204922:	0109b583          	ld	a1,16(s3)
ffffffffc0204926:	4701                	li	a4,0
ffffffffc0204928:	8526                	mv	a0,s1
ffffffffc020492a:	e0dfe0ef          	jal	ra,ffffffffc0203736 <mm_map>
ffffffffc020492e:	8a2a                	mv	s4,a0
ffffffffc0204930:	ed35                	bnez	a0,ffffffffc02049ac <do_execve+0x342>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0204932:	0109bb83          	ld	s7,16(s3)
ffffffffc0204936:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0204938:	0209ba03          	ld	s4,32(s3)
        unsigned char *from = binary + ph->p_offset;
ffffffffc020493c:	0089b903          	ld	s2,8(s3)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0204940:	00fbfab3          	and	s5,s7,a5
        unsigned char *from = binary + ph->p_offset;
ffffffffc0204944:	7782                	ld	a5,32(sp)
        end = ph->p_va + ph->p_filesz;
ffffffffc0204946:	9a5e                	add	s4,s4,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0204948:	993e                	add	s2,s2,a5
        while (start < end)
ffffffffc020494a:	054be963          	bltu	s7,s4,ffffffffc020499c <do_execve+0x332>
ffffffffc020494e:	aa95                	j	ffffffffc0204ac2 <do_execve+0x458>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0204950:	6785                	lui	a5,0x1
ffffffffc0204952:	415b8533          	sub	a0,s7,s5
ffffffffc0204956:	9abe                	add	s5,s5,a5
ffffffffc0204958:	417a8633          	sub	a2,s5,s7
            if (end < la)
ffffffffc020495c:	015a7463          	bgeu	s4,s5,ffffffffc0204964 <do_execve+0x2fa>
                size -= la - end;
ffffffffc0204960:	417a0633          	sub	a2,s4,s7
    return page - pages + nbase;
ffffffffc0204964:	000cb683          	ld	a3,0(s9)
ffffffffc0204968:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc020496a:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
ffffffffc020496e:	40d406b3          	sub	a3,s0,a3
ffffffffc0204972:	8699                	srai	a3,a3,0x6
ffffffffc0204974:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204976:	67e2                	ld	a5,24(sp)
ffffffffc0204978:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc020497c:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc020497e:	14b87863          	bgeu	a6,a1,ffffffffc0204ace <do_execve+0x464>
ffffffffc0204982:	000b3803          	ld	a6,0(s6)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0204986:	85ca                	mv	a1,s2
            start += size, from += size;
ffffffffc0204988:	9bb2                	add	s7,s7,a2
ffffffffc020498a:	96c2                	add	a3,a3,a6
            memcpy(page2kva(page) + off, from, size);
ffffffffc020498c:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc020498e:	e432                	sd	a2,8(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0204990:	631000ef          	jal	ra,ffffffffc02057c0 <memcpy>
            start += size, from += size;
ffffffffc0204994:	6622                	ld	a2,8(sp)
ffffffffc0204996:	9932                	add	s2,s2,a2
        while (start < end)
ffffffffc0204998:	054bf363          	bgeu	s7,s4,ffffffffc02049de <do_execve+0x374>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL)
ffffffffc020499c:	6c88                	ld	a0,24(s1)
ffffffffc020499e:	866a                	mv	a2,s10
ffffffffc02049a0:	85d6                	mv	a1,s5
ffffffffc02049a2:	b1dfe0ef          	jal	ra,ffffffffc02034be <pgdir_alloc_page>
ffffffffc02049a6:	842a                	mv	s0,a0
ffffffffc02049a8:	f545                	bnez	a0,ffffffffc0204950 <do_execve+0x2e6>
        ret = -E_NO_MEM;
ffffffffc02049aa:	5a71                	li	s4,-4
    exit_mmap(mm);
ffffffffc02049ac:	8526                	mv	a0,s1
ffffffffc02049ae:	ed3fe0ef          	jal	ra,ffffffffc0203880 <exit_mmap>
    put_pgdir(mm);
ffffffffc02049b2:	8526                	mv	a0,s1
ffffffffc02049b4:	ba6ff0ef          	jal	ra,ffffffffc0203d5a <put_pgdir>
    mm_destroy(mm);
ffffffffc02049b8:	8526                	mv	a0,s1
ffffffffc02049ba:	d2bfe0ef          	jal	ra,ffffffffc02036e4 <mm_destroy>
    return ret;
ffffffffc02049be:	b705                	j	ffffffffc02048de <do_execve+0x274>
            exit_mmap(mm);
ffffffffc02049c0:	854e                	mv	a0,s3
ffffffffc02049c2:	ebffe0ef          	jal	ra,ffffffffc0203880 <exit_mmap>
            put_pgdir(mm);
ffffffffc02049c6:	854e                	mv	a0,s3
ffffffffc02049c8:	b92ff0ef          	jal	ra,ffffffffc0203d5a <put_pgdir>
            mm_destroy(mm);
ffffffffc02049cc:	854e                	mv	a0,s3
ffffffffc02049ce:	d17fe0ef          	jal	ra,ffffffffc02036e4 <mm_destroy>
ffffffffc02049d2:	b32d                	j	ffffffffc02046fc <do_execve+0x92>
            vm_flags |= VM_WRITE;
ffffffffc02049d4:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R)
ffffffffc02049d8:	fb95                	bnez	a5,ffffffffc020490c <do_execve+0x2a2>
            perm |= (PTE_W | PTE_R);
ffffffffc02049da:	4d5d                	li	s10,23
ffffffffc02049dc:	bf35                	j	ffffffffc0204918 <do_execve+0x2ae>
        end = ph->p_va + ph->p_memsz;
ffffffffc02049de:	0109b683          	ld	a3,16(s3)
ffffffffc02049e2:	0289b903          	ld	s2,40(s3)
ffffffffc02049e6:	9936                	add	s2,s2,a3
        if (start < la)
ffffffffc02049e8:	075bfd63          	bgeu	s7,s5,ffffffffc0204a62 <do_execve+0x3f8>
            if (start == end)
ffffffffc02049ec:	db790fe3          	beq	s2,s7,ffffffffc02047aa <do_execve+0x140>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc02049f0:	6785                	lui	a5,0x1
ffffffffc02049f2:	00fb8533          	add	a0,s7,a5
ffffffffc02049f6:	41550533          	sub	a0,a0,s5
                size -= la - end;
ffffffffc02049fa:	41790a33          	sub	s4,s2,s7
            if (end < la)
ffffffffc02049fe:	0b597d63          	bgeu	s2,s5,ffffffffc0204ab8 <do_execve+0x44e>
    return page - pages + nbase;
ffffffffc0204a02:	000cb683          	ld	a3,0(s9)
ffffffffc0204a06:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204a08:	000c3603          	ld	a2,0(s8)
    return page - pages + nbase;
ffffffffc0204a0c:	40d406b3          	sub	a3,s0,a3
ffffffffc0204a10:	8699                	srai	a3,a3,0x6
ffffffffc0204a12:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc0204a14:	67e2                	ld	a5,24(sp)
ffffffffc0204a16:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0204a1a:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204a1c:	0ac5f963          	bgeu	a1,a2,ffffffffc0204ace <do_execve+0x464>
ffffffffc0204a20:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0204a24:	8652                	mv	a2,s4
ffffffffc0204a26:	4581                	li	a1,0
ffffffffc0204a28:	96c2                	add	a3,a3,a6
ffffffffc0204a2a:	9536                	add	a0,a0,a3
ffffffffc0204a2c:	583000ef          	jal	ra,ffffffffc02057ae <memset>
            start += size;
ffffffffc0204a30:	017a0733          	add	a4,s4,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0204a34:	03597463          	bgeu	s2,s5,ffffffffc0204a5c <do_execve+0x3f2>
ffffffffc0204a38:	d6e909e3          	beq	s2,a4,ffffffffc02047aa <do_execve+0x140>
ffffffffc0204a3c:	00002697          	auipc	a3,0x2
ffffffffc0204a40:	7c468693          	addi	a3,a3,1988 # ffffffffc0207200 <default_pmm_manager+0xbf8>
ffffffffc0204a44:	00002617          	auipc	a2,0x2
ffffffffc0204a48:	81460613          	addi	a2,a2,-2028 # ffffffffc0206258 <commands+0x818>
ffffffffc0204a4c:	2e600593          	li	a1,742
ffffffffc0204a50:	00002517          	auipc	a0,0x2
ffffffffc0204a54:	5e850513          	addi	a0,a0,1512 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204a58:	a3bfb0ef          	jal	ra,ffffffffc0200492 <__panic>
ffffffffc0204a5c:	ff5710e3          	bne	a4,s5,ffffffffc0204a3c <do_execve+0x3d2>
ffffffffc0204a60:	8bd6                	mv	s7,s5
        while (start < end)
ffffffffc0204a62:	d52bf4e3          	bgeu	s7,s2,ffffffffc02047aa <do_execve+0x140>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL)
ffffffffc0204a66:	6c88                	ld	a0,24(s1)
ffffffffc0204a68:	866a                	mv	a2,s10
ffffffffc0204a6a:	85d6                	mv	a1,s5
ffffffffc0204a6c:	a53fe0ef          	jal	ra,ffffffffc02034be <pgdir_alloc_page>
ffffffffc0204a70:	842a                	mv	s0,a0
ffffffffc0204a72:	dd05                	beqz	a0,ffffffffc02049aa <do_execve+0x340>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0204a74:	6785                	lui	a5,0x1
ffffffffc0204a76:	415b8533          	sub	a0,s7,s5
ffffffffc0204a7a:	9abe                	add	s5,s5,a5
ffffffffc0204a7c:	417a8633          	sub	a2,s5,s7
            if (end < la)
ffffffffc0204a80:	01597463          	bgeu	s2,s5,ffffffffc0204a88 <do_execve+0x41e>
                size -= la - end;
ffffffffc0204a84:	41790633          	sub	a2,s2,s7
    return page - pages + nbase;
ffffffffc0204a88:	000cb683          	ld	a3,0(s9)
ffffffffc0204a8c:	67c2                	ld	a5,16(sp)
    return KADDR(page2pa(page));
ffffffffc0204a8e:	000c3583          	ld	a1,0(s8)
    return page - pages + nbase;
...
ffffffffc0204a9c:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0204aa0:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0204aa2:	02b87663          	bgeu	a6,a1,ffffffffc0204ace <do_execve+0x464>
ffffffffc0204aa6:	000b3803          	ld	a6,0(s6)
            memset(page2kva(page) + off, 0, size);
ffffffffc0204aaa:	4581                	li	a1,0
            start += size;
ffffffffc0204aac:	9bb2                	add	s7,s7,a2
ffffffffc0204aae:	96c2                	add	a3,a3,a6
            memset(page2kva(page) + off, 0, size);
ffffffffc0204ab0:	9536                	add	a0,a0,a3
ffffffffc0204ab2:	4fd000ef          	jal	ra,ffffffffc02057ae <memset>
ffffffffc0204ab6:	b775                	j	ffffffffc0204a62 <do_execve+0x3f8>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0204ab8:	417a8a33          	sub	s4,s5,s7
ffffffffc0204abc:	b799                	j	ffffffffc0204a02 <do_execve+0x398>
        return -E_INVAL;
ffffffffc0204abe:	5a75                	li	s4,-3
ffffffffc0204ac0:	b3c1                	j	ffffffffc0204880 <do_execve+0x216>
        while (start < end)
ffffffffc0204ac2:	86de                	mv	a3,s7
ffffffffc0204ac4:	bf39                	j	ffffffffc02049e2 <do_execve+0x378>
    int ret = -E_NO_MEM;
ffffffffc0204ac6:	5a71                	li	s4,-4
ffffffffc0204ac8:	bdc5                	j	ffffffffc02049b8 <do_execve+0x34e>
            ret = -E_INVAL_ELF;
ffffffffc0204aca:	5a61                	li	s4,-8
ffffffffc0204acc:	b5c5                	j	ffffffffc02049ac <do_execve+0x342>
ffffffffc0204ace:	00002617          	auipc	a2,0x2
ffffffffc0204ad2:	b7260613          	addi	a2,a2,-1166 # ffffffffc0206640 <default_pmm_manager+0x38>
ffffffffc0204ad6:	07100593          	li	a1,113
ffffffffc0204ada:	00002517          	auipc	a0,0x2
ffffffffc0204ade:	b8e50513          	addi	a0,a0,-1138 # ffffffffc0206668 <default_pmm_manager+0x60>
ffffffffc0204ae2:	9b1fb0ef          	jal	ra,ffffffffc0200492 <__panic>
    current->pgdir = PADDR(mm->pgdir);
ffffffffc0204ae6:	00002617          	auipc	a2,0x2
ffffffffc0204aea:	c0260613          	addi	a2,a2,-1022 # ffffffffc02066e8 <default_pmm_manager+0xe0>
ffffffffc0204aee:	30500593          	li	a1,773
ffffffffc0204af2:	00002517          	auipc	a0,0x2
ffffffffc0204af6:	54650513          	addi	a0,a0,1350 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204afa:	999fb0ef          	jal	ra,ffffffffc0200492 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 4 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204afe:	00003697          	auipc	a3,0x3
ffffffffc0204b02:	81a68693          	addi	a3,a3,-2022 # ffffffffc0207318 <default_pmm_manager+0xd10>
ffffffffc0204b06:	00001617          	auipc	a2,0x1
ffffffffc0204b0a:	75260613          	addi	a2,a2,1874 # ffffffffc0206258 <commands+0x818>
ffffffffc0204b0e:	30000593          	li	a1,768
ffffffffc0204b12:	00002517          	auipc	a0,0x2
ffffffffc0204b16:	52650513          	addi	a0,a0,1318 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204b1a:	979fb0ef          	jal	ra,ffffffffc0200492 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 3 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204b1e:	00002697          	auipc	a3,0x2
ffffffffc0204b22:	7b268693          	addi	a3,a3,1970 # ffffffffc02072d0 <default_pmm_manager+0xcc8>
ffffffffc0204b26:	00001617          	auipc	a2,0x1
ffffffffc0204b2a:	73260613          	addi	a2,a2,1842 # ffffffffc0206258 <commands+0x818>
ffffffffc0204b2e:	2ff00593          	li	a1,767
ffffffffc0204b32:	00002517          	auipc	a0,0x2
ffffffffc0204b36:	50650513          	addi	a0,a0,1286 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204b3a:	959fb0ef          	jal	ra,ffffffffc0200492 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - 2 * PGSIZE, PTE_USER) != NULL);
ffffffffc0204b3e:	00002697          	auipc	a3,0x2
ffffffffc0204b42:	74a68693          	addi	a3,a3,1866 # ffffffffc0207288 <default_pmm_manager+0xc80>
ffffffffc0204b46:	00001617          	auipc	a2,0x1
ffffffffc0204b4a:	71260613          	addi	a2,a2,1810 # ffffffffc0206258 <commands+0x818>
ffffffffc0204b4e:	2fe00593          	li	a1,766
ffffffffc0204b52:	00002517          	auipc	a0,0x2
ffffffffc0204b56:	4e650513          	addi	a0,a0,1254 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204b5a:	939fb0ef          	jal	ra,ffffffffc0200492 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP - PGSIZE, PTE_USER) != NULL);
ffffffffc0204b5e:	00002697          	auipc	a3,0x2
ffffffffc0204b62:	6e268693          	addi	a3,a3,1762 # ffffffffc0207240 <default_pmm_manager+0xc38>
ffffffffc0204b66:	00001617          	auipc	a2,0x1
ffffffffc0204b6a:	6f260613          	addi	a2,a2,1778 # ffffffffc0206258 <commands+0x818>
ffffffffc0204b6e:	2fd00593          	li	a1,765
ffffffffc0204b72:	00002517          	auipc	a0,0x2
ffffffffc0204b76:	4c650513          	addi	a0,a0,1222 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204b7a:	919fb0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc0204b7e <user_main>:
{
ffffffffc0204b7e:	1101                	addi	sp,sp,-32
ffffffffc0204b80:	e04a                	sd	s2,0(sp)
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204b82:	000c2917          	auipc	s2,0xc2
ffffffffc0204b86:	2e690913          	addi	s2,s2,742 # ffffffffc02c6e68 <current>
ffffffffc0204b8a:	00093783          	ld	a5,0(s2)
ffffffffc0204b8e:	00002617          	auipc	a2,0x2
ffffffffc0204b92:	7d260613          	addi	a2,a2,2002 # ffffffffc0207360 <default_pmm_manager+0xd58>
ffffffffc0204b96:	00002517          	auipc	a0,0x2
ffffffffc0204b9a:	7da50513          	addi	a0,a0,2010 # ffffffffc0207370 <default_pmm_manager+0xd68>
ffffffffc0204b9e:	43cc                	lw	a1,4(a5)
{
ffffffffc0204ba0:	ec06                	sd	ra,24(sp)
ffffffffc0204ba2:	e822                	sd	s0,16(sp)
ffffffffc0204ba4:	e426                	sd	s1,8(sp)
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204ba6:	df2fb0ef          	jal	ra,ffffffffc0200198 <cprintf>
    size_t len = strlen(name);
ffffffffc0204baa:	00002517          	auipc	a0,0x2
ffffffffc0204bae:	7b650513          	addi	a0,a0,1974 # ffffffffc0207360 <default_pmm_manager+0xd58>
ffffffffc0204bb2:	35b000ef          	jal	ra,ffffffffc020570c <strlen>
...
ffffffffc0204bbc:	12000613          	li	a2,288
    struct trapframe *new_tf = (struct trapframe *)(current->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204bc0:	6b80                	ld	s0,16(a5)
    memcpy(new_tf, old_tf, sizeof(struct trapframe));
ffffffffc0204bc2:	73cc                	ld	a1,160(a5)
    struct trapframe *new_tf = (struct trapframe *)(current->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204bc4:	6789                	lui	a5,0x2
ffffffffc0204bc6:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x8080>
ffffffffc0204bca:	943e                	add	s0,s0,a5
    memcpy(new_tf, old_tf, sizeof(struct trapframe));
ffffffffc0204bcc:	8522                	mv	a0,s0
ffffffffc0204bce:	3f3000ef          	jal	ra,ffffffffc02057c0 <memcpy>
    current->tf = new_tf;
ffffffffc0204bd2:	00093783          	ld	a5,0(s2)
    ret = do_execve(name, len, binary, size);
ffffffffc0204bd6:	3fe07697          	auipc	a3,0x3fe07
ffffffffc0204bda:	b9268693          	addi	a3,a3,-1134 # b768 <_binary_obj___user_priority_out_size>
ffffffffc0204bde:	0007d617          	auipc	a2,0x7d
ffffffffc0204be2:	2e260613          	addi	a2,a2,738 # ffffffffc0281ec0 <_binary_obj___user_priority_out_start>
    current->tf = new_tf;
ffffffffc0204be6:	f3c0                	sd	s0,160(a5)
    ret = do_execve(name, len, binary, size);
ffffffffc0204be8:	85a6                	mv	a1,s1
ffffffffc0204bea:	00002517          	auipc	a0,0x2
ffffffffc0204bee:	77650513          	addi	a0,a0,1910 # ffffffffc0207360 <default_pmm_manager+0xd58>
ffffffffc0204bf2:	a79ff0ef          	jal	ra,ffffffffc020466a <do_execve>
    asm volatile(
ffffffffc0204bf6:	8122                	mv	sp,s0
ffffffffc0204bf8:	a6cfc06f          	j	ffffffffc0200e64 <__trapret>
    panic("user_main execve failed.\n");
ffffffffc0204bfc:	00002617          	auipc	a2,0x2
ffffffffc0204c00:	79c60613          	addi	a2,a2,1948 # ffffffffc0207398 <default_pmm_manager+0xd90>
ffffffffc0204c04:	3eb00593          	li	a1,1003
ffffffffc0204c08:	00002517          	auipc	a0,0x2
ffffffffc0204c0c:	43050513          	addi	a0,a0,1072 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204c10:	883fb0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc0204c14 <do_yield>:
    current->need_resched = 1;
ffffffffc0204c14:	000c2797          	auipc	a5,0xc2
ffffffffc0204c18:	2547b783          	ld	a5,596(a5) # ffffffffc02c6e68 <current>
ffffffffc0204c1c:	4705                	li	a4,1
ffffffffc0204c1e:	ef98                	sd	a4,24(a5)
}
ffffffffc0204c20:	4501                	li	a0,0
ffffffffc0204c22:	8082                	ret

ffffffffc0204c24 <do_wait>:
{
ffffffffc0204c24:	1101                	addi	sp,sp,-32
ffffffffc0204c26:	e822                	sd	s0,16(sp)
ffffffffc0204c28:	e426                	sd	s1,8(sp)
ffffffffc0204c2a:	ec06                	sd	ra,24(sp)
ffffffffc0204c2c:	842e                	mv	s0,a1
ffffffffc0204c2e:	84aa                	mv	s1,a0
    if (code_store != NULL)
ffffffffc0204c30:	c999                	beqz	a1,ffffffffc0204c46 <do_wait+0x22>
    struct mm_struct *mm = current->mm;
ffffffffc0204c32:	000c2797          	auipc	a5,0xc2
ffffffffc0204c36:	2367b783          	ld	a5,566(a5) # ffffffffc02c6e68 <current>
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1))
ffffffffc0204c3a:	7788                	ld	a0,40(a5)
ffffffffc0204c3c:	4685                	li	a3,1
ffffffffc0204c3e:	4611                	li	a2,4
ffffffffc0204c40:	fdbfe0ef          	jal	ra,ffffffffc0203c1a <user_mem_check>
ffffffffc0204c44:	c909                	beqz	a0,ffffffffc0204c56 <do_wait+0x32>
ffffffffc0204c46:	85a2                	mv	a1,s0
}
ffffffffc0204c48:	6442                	ld	s0,16(sp)
ffffffffc0204c4a:	60e2                	ld	ra,24(sp)
ffffffffc0204c4c:	8526                	mv	a0,s1
ffffffffc0204c4e:	64a2                	ld	s1,8(sp)
ffffffffc0204c50:	6105                	addi	sp,sp,32
ffffffffc0204c52:	f22ff06f          	j	ffffffffc0204374 <do_wait.part.0>
ffffffffc0204c56:	60e2                	ld	ra,24(sp)
ffffffffc0204c58:	6442                	ld	s0,16(sp)
ffffffffc0204c5a:	64a2                	ld	s1,8(sp)
ffffffffc0204c5c:	5575                	li	a0,-3
ffffffffc0204c5e:	6105                	addi	sp,sp,32
ffffffffc0204c60:	8082                	ret

ffffffffc0204c62 <do_kill>:
{
ffffffffc0204c62:	1141                	addi	sp,sp,-16
    if (0 < pid && pid < MAX_PID)
ffffffffc0204c64:	6789                	lui	a5,0x2
{
ffffffffc0204c66:	e406                	sd	ra,8(sp)
ffffffffc0204c68:	e022                	sd	s0,0(sp)
    if (0 < pid && pid < MAX_PID)
ffffffffc0204c6a:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204c6e:	17f9                	addi	a5,a5,-2
ffffffffc0204c70:	02e7e963          	bltu	a5,a4,ffffffffc0204ca2 <do_kill+0x40>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204c74:	842a                	mv	s0,a0
ffffffffc0204c76:	45a9                	li	a1,10
ffffffffc0204c78:	2501                	sext.w	a0,a0
ffffffffc0204c7a:	68e000ef          	jal	ra,ffffffffc0205308 <hash32>
ffffffffc0204c7e:	02051793          	slli	a5,a0,0x20
ffffffffc0204c82:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204c86:	000be797          	auipc	a5,0xbe
ffffffffc0204c8a:	14a78793          	addi	a5,a5,330 # ffffffffc02c2dd0 <hash_list>
ffffffffc0204c8e:	953e                	add	a0,a0,a5
ffffffffc0204c90:	87aa                	mv	a5,a0
        while ((le = list_next(le)) != list)
ffffffffc0204c92:	a029                	j	ffffffffc0204c9c <do_kill+0x3a>
            if (proc->pid == pid)
ffffffffc0204c94:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0204c98:	00870b63          	beq	a4,s0,ffffffffc0204cae <do_kill+0x4c>
ffffffffc0204c9c:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0204c9e:	fef51be3          	bne	a0,a5,ffffffffc0204c94 <do_kill+0x32>
    return -E_INVAL;
ffffffffc0204ca2:	5475                	li	s0,-3
}
ffffffffc0204ca4:	60a2                	ld	ra,8(sp)
ffffffffc0204ca6:	8522                	mv	a0,s0
ffffffffc0204ca8:	6402                	ld	s0,0(sp)
ffffffffc0204caa:	0141                	addi	sp,sp,16
ffffffffc0204cac:	8082                	ret
        if (!(proc->flags & PF_EXITING))
ffffffffc0204cae:	fd87a703          	lw	a4,-40(a5)
ffffffffc0204cb2:	00177693          	andi	a3,a4,1
ffffffffc0204cb6:	e295                	bnez	a3,ffffffffc0204cda <do_kill+0x78>
            if (proc->wait_state & WT_INTERRUPTED)
ffffffffc0204cb8:	4bd4                	lw	a3,20(a5)
            proc->flags |= PF_EXITING;
ffffffffc0204cba:	00176713          	ori	a4,a4,1
ffffffffc0204cbe:	fce7ac23          	sw	a4,-40(a5)
            return 0;
ffffffffc0204cc2:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED)
ffffffffc0204cc4:	fe06d0e3          	bgez	a3,ffffffffc0204ca4 <do_kill+0x42>
                wakeup_proc(proc);
ffffffffc0204cc8:	f2878513          	addi	a0,a5,-216
ffffffffc0204ccc:	3ca000ef          	jal	ra,ffffffffc0205096 <wakeup_proc>
}
...
ffffffffc0204cd8:	8082                	ret
        return -E_KILLED;
ffffffffc0204cda:	545d                	li	s0,-9
ffffffffc0204cdc:	b7e1                	j	ffffffffc0204ca4 <do_kill+0x42>

ffffffffc0204cde <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and
//           - create the second kernel thread init_main
void proc_init(void)
{
ffffffffc0204cde:	1101                	addi	sp,sp,-32
ffffffffc0204ce0:	e426                	sd	s1,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0204ce2:	000c2797          	auipc	a5,0xc2
ffffffffc0204ce6:	0ee78793          	addi	a5,a5,238 # ffffffffc02c6dd0 <proc_list>
ffffffffc0204cea:	ec06                	sd	ra,24(sp)
ffffffffc0204cec:	e822                	sd	s0,16(sp)
ffffffffc0204cee:	e04a                	sd	s2,0(sp)
ffffffffc0204cf0:	000be497          	auipc	s1,0xbe
ffffffffc0204cf4:	0e048493          	addi	s1,s1,224 # ffffffffc02c2dd0 <hash_list>
ffffffffc0204cf8:	e79c                	sd	a5,8(a5)
ffffffffc0204cfa:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i++)
ffffffffc0204cfc:	000c2717          	auipc	a4,0xc2
ffffffffc0204d00:	0d470713          	addi	a4,a4,212 # ffffffffc02c6dd0 <proc_list>
ffffffffc0204d04:	87a6                	mv	a5,s1
ffffffffc0204d06:	e79c                	sd	a5,8(a5)
ffffffffc0204d08:	e39c                	sd	a5,0(a5)
ffffffffc0204d0a:	07c1                	addi	a5,a5,16
ffffffffc0204d0c:	fef71de3          	bne	a4,a5,ffffffffc0204d06 <proc_init+0x28>
    {
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL)
ffffffffc0204d10:	fa7fe0ef          	jal	ra,ffffffffc0203cb6 <alloc_proc>
ffffffffc0204d14:	000c2917          	auipc	s2,0xc2
ffffffffc0204d18:	15c90913          	addi	s2,s2,348 # ffffffffc02c6e70 <idleproc>
ffffffffc0204d1c:	00a93023          	sd	a0,0(s2)
ffffffffc0204d20:	0e050f63          	beqz	a0,ffffffffc0204e1e <proc_init+0x140>
    {
...
ffffffffc0204d24:	4789                	li	a5,2
ffffffffc0204d26:	e11c                	sd	a5,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204d28:	00004797          	auipc	a5,0x4
ffffffffc0204d2c:	2d878793          	addi	a5,a5,728 # ffffffffc0209000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204d30:	0b450413          	addi	s0,a0,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0204d34:	e91c                	sd	a5,16(a0)
    idleproc->need_resched = 1;
ffffffffc0204d36:	4785                	li	a5,1
ffffffffc0204d38:	ed1c                	sd	a5,24(a0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204d3a:	4641                	li	a2,16
ffffffffc0204d3c:	4581                	li	a1,0
ffffffffc0204d3e:	8522                	mv	a0,s0
ffffffffc0204d40:	26f000ef          	jal	ra,ffffffffc02057ae <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204d44:	463d                	li	a2,15
ffffffffc0204d46:	00002597          	auipc	a1,0x2
ffffffffc0204d4a:	68a58593          	addi	a1,a1,1674 # ffffffffc02073d0 <default_pmm_manager+0xdc8>
ffffffffc0204d4e:	8522                	mv	a0,s0
ffffffffc0204d50:	271000ef          	jal	ra,ffffffffc02057c0 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process++;
ffffffffc0204d54:	000c2717          	auipc	a4,0xc2
ffffffffc0204d58:	12c70713          	addi	a4,a4,300 # ffffffffc02c6e80 <nr_process>
ffffffffc0204d5c:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc0204d5e:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0204d62:	4601                	li	a2,0
    nr_process++;
ffffffffc0204d64:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0204d66:	4581                	li	a1,0
ffffffffc0204d68:	fffff517          	auipc	a0,0xfffff
ffffffffc0204d6c:	7de50513          	addi	a0,a0,2014 # ffffffffc0204546 <init_main>
    nr_process++;
ffffffffc0204d70:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0204d72:	000c2797          	auipc	a5,0xc2
ffffffffc0204d76:	0ed7bb23          	sd	a3,246(a5) # ffffffffc02c6e68 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0204d7a:	c60ff0ef          	jal	ra,ffffffffc02041da <kernel_thread>
ffffffffc0204d7e:	842a                	mv	s0,a0
    if (pid <= 0)
ffffffffc0204d80:	08a05363          	blez	a0,ffffffffc0204e06 <proc_init+0x128>
    if (0 < pid && pid < MAX_PID)
ffffffffc0204d84:	6789                	lui	a5,0x2
ffffffffc0204d86:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204d8a:	17f9                	addi	a5,a5,-2
ffffffffc0204d8c:	2501                	sext.w	a0,a0
ffffffffc0204d8e:	02e7e363          	bltu	a5,a4,ffffffffc0204db4 <proc_init+0xd6>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc0204d92:	45a9                	li	a1,10
ffffffffc0204d94:	574000ef          	jal	ra,ffffffffc0205308 <hash32>
ffffffffc0204d98:	02051793          	slli	a5,a0,0x20
ffffffffc0204d9c:	01c7d693          	srli	a3,a5,0x1c
ffffffffc0204da0:	96a6                	add	a3,a3,s1
ffffffffc0204da2:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list)
ffffffffc0204da4:	a029                	j	ffffffffc0204dae <proc_init+0xd0>
            if (proc->pid == pid)
ffffffffc0204da6:	f2c7a703          	lw	a4,-212(a5) # 1f2c <_binary_obj___user_faultread_out_size-0x8034>
ffffffffc0204daa:	04870b63          	beq	a4,s0,ffffffffc0204e00 <proc_init+0x122>
    return listelm->next;
ffffffffc0204dae:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list)
ffffffffc0204db0:	fef69be3          	bne	a3,a5,ffffffffc0204da6 <proc_init+0xc8>
    return NULL;
ffffffffc0204db4:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204db6:	0b478493          	addi	s1,a5,180
ffffffffc0204dba:	4641                	li	a2,16
ffffffffc0204dbc:	4581                	li	a1,0
    {
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0204dbe:	000c2417          	auipc	s0,0xc2
ffffffffc0204dc2:	0ba40413          	addi	s0,s0,186 # ffffffffc02c6e78 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204dc6:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc0204dc8:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204dca:	1e5000ef          	jal	ra,ffffffffc02057ae <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204dce:	463d                	li	a2,15
ffffffffc0204dd0:	00002597          	auipc	a1,0x2
ffffffffc0204dd4:	62858593          	addi	a1,a1,1576 # ffffffffc02073f8 <default_pmm_manager+0xdf0>
ffffffffc0204dd8:	8526                	mv	a0,s1
ffffffffc0204dda:	1e7000ef          	jal	ra,ffffffffc02057c0 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204dde:	00093783          	ld	a5,0(s2)
ffffffffc0204de2:	cbb5                	beqz	a5,ffffffffc0204e56 <proc_init+0x178>
ffffffffc0204de4:	43dc                	lw	a5,4(a5)
ffffffffc0204de6:	eba5                	bnez	a5,ffffffffc0204e56 <proc_init+0x178>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204de8:	601c                	ld	a5,0(s0)
ffffffffc0204dea:	c7b1                	beqz	a5,ffffffffc0204e36 <proc_init+0x158>
ffffffffc0204dec:	43d8                	lw	a4,4(a5)
ffffffffc0204dee:	4785                	li	a5,1
ffffffffc0204df0:	04f71363          	bne	a4,a5,ffffffffc0204e36 <proc_init+0x158>
}
ffffffffc0204df4:	60e2                	ld	ra,24(sp)
ffffffffc0204df6:	6442                	ld	s0,16(sp)
ffffffffc0204df8:	64a2                	ld	s1,8(sp)
ffffffffc0204dfa:	6902                	ld	s2,0(sp)
ffffffffc0204dfc:	6105                	addi	sp,sp,32
ffffffffc0204dfe:	8082                	ret
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0204e00:	f2878793          	addi	a5,a5,-216
ffffffffc0204e04:	bf4d                	j	ffffffffc0204db6 <proc_init+0xd8>
        panic("create init_main failed.\n");
ffffffffc0204e06:	00002617          	auipc	a2,0x2
ffffffffc0204e0a:	5d260613          	addi	a2,a2,1490 # ffffffffc02073d8 <default_pmm_manager+0xdd0>
ffffffffc0204e0e:	42700593          	li	a1,1063
ffffffffc0204e12:	00002517          	auipc	a0,0x2
ffffffffc0204e16:	22650513          	addi	a0,a0,550 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204e1a:	e78fb0ef          	jal	ra,ffffffffc0200492 <__panic>
        panic("cannot alloc idleproc.\n");
ffffffffc0204e1e:	00002617          	auipc	a2,0x2
ffffffffc0204e22:	59a60613          	addi	a2,a2,1434 # ffffffffc02073b8 <default_pmm_manager+0xdb0>
ffffffffc0204e26:	41800593          	li	a1,1048
ffffffffc0204e2a:	00002517          	auipc	a0,0x2
ffffffffc0204e2e:	20e50513          	addi	a0,a0,526 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204e32:	e60fb0ef          	jal	ra,ffffffffc0200492 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204e36:	00002697          	auipc	a3,0x2
ffffffffc0204e3a:	5f268693          	addi	a3,a3,1522 # ffffffffc0207428 <default_pmm_manager+0xe20>
ffffffffc0204e3e:	00001617          	auipc	a2,0x1
ffffffffc0204e42:	41a60613          	addi	a2,a2,1050 # ffffffffc0206258 <commands+0x818>
ffffffffc0204e46:	42e00593          	li	a1,1070
ffffffffc0204e4a:	00002517          	auipc	a0,0x2
ffffffffc0204e4e:	1ee50513          	addi	a0,a0,494 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204e52:	e40fb0ef          	jal	ra,ffffffffc0200492 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204e56:	00002697          	auipc	a3,0x2
ffffffffc0204e5a:	5aa68693          	addi	a3,a3,1450 # ffffffffc0207400 <default_pmm_manager+0xdf8>
ffffffffc0204e5e:	00001617          	auipc	a2,0x1
ffffffffc0204e62:	3fa60613          	addi	a2,a2,1018 # ffffffffc0206258 <commands+0x818>
ffffffffc0204e66:	42d00593          	li	a1,1069
ffffffffc0204e6a:	00002517          	auipc	a0,0x2
ffffffffc0204e6e:	1ce50513          	addi	a0,a0,462 # ffffffffc0207038 <default_pmm_manager+0xa30>
ffffffffc0204e72:	e20fb0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc0204e76 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void cpu_idle(void)
{
ffffffffc0204e76:	1141                	addi	sp,sp,-16
ffffffffc0204e78:	e022                	sd	s0,0(sp)
ffffffffc0204e7a:	e406                	sd	ra,8(sp)
ffffffffc0204e7c:	000c2417          	auipc	s0,0xc2
ffffffffc0204e80:	fec40413          	addi	s0,s0,-20 # ffffffffc02c6e68 <current>
    while (1)
    {
        if (current->need_resched)
ffffffffc0204e84:	6018                	ld	a4,0(s0)
ffffffffc0204e86:	6f1c                	ld	a5,24(a4)
ffffffffc0204e88:	dffd                	beqz	a5,ffffffffc0204e86 <cpu_idle+0x10>
        {
            schedule();
ffffffffc0204e8a:	2be000ef          	jal	ra,ffffffffc0205148 <schedule>
ffffffffc0204e8e:	bfdd                	j	ffffffffc0204e84 <cpu_idle+0xe>

ffffffffc0204e90 <lab6_set_priority>:
        }
    }
}
...
ffffffffc0204e94:	85aa                	mv	a1,a0
{
ffffffffc0204e96:	842a                	mv	s0,a0
    cprintf("set priority to %d\n", priority);
ffffffffc0204e98:	00002517          	auipc	a0,0x2
ffffffffc0204e9c:	5b850513          	addi	a0,a0,1464 # ffffffffc0207450 <default_pmm_manager+0xe48>
{
ffffffffc0204ea0:	e406                	sd	ra,8(sp)
    cprintf("set priority to %d\n", priority);
ffffffffc0204ea2:	af6fb0ef          	jal	ra,ffffffffc0200198 <cprintf>
    if (priority == 0)
        current->lab6_priority = 1;
ffffffffc0204ea6:	000c2797          	auipc	a5,0xc2
ffffffffc0204eaa:	fc27b783          	ld	a5,-62(a5) # ffffffffc02c6e68 <current>
    if (priority == 0)
ffffffffc0204eae:	e801                	bnez	s0,ffffffffc0204ebe <lab6_set_priority+0x2e>
    else
        current->lab6_priority = priority;
}
ffffffffc0204eb0:	60a2                	ld	ra,8(sp)
ffffffffc0204eb2:	6402                	ld	s0,0(sp)
        current->lab6_priority = 1;
ffffffffc0204eb4:	4705                	li	a4,1
ffffffffc0204eb6:	14e7a223          	sw	a4,324(a5)
}
ffffffffc0204eba:	0141                	addi	sp,sp,16
ffffffffc0204ebc:	8082                	ret
ffffffffc0204ebe:	60a2                	ld	ra,8(sp)
        current->lab6_priority = priority;
ffffffffc0204ec0:	1487a223          	sw	s0,324(a5)
}
ffffffffc0204ec4:	6402                	ld	s0,0(sp)
ffffffffc0204ec6:	0141                	addi	sp,sp,16
ffffffffc0204ec8:	8082                	ret

ffffffffc0204eca <switch_to>:
.text
...
ffffffffc0204eca:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0204ece:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204ed2:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204ed4:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204ed6:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0204eda:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0204ede:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204ee2:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204ee6:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0204eea:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0204eee:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204ef2:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204ef6:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0204efa:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0204efe:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204f02:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204f06:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204f08:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0204f0a:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0204f0e:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204f12:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0204f16:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0204f1a:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0204f1e:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204f22:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0204f26:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0204f2a:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0204f2e:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0204f32:	8082                	ret

ffffffffc0204f34 <RR_init>:
    elm->prev = elm->next = elm;
ffffffffc0204f34:	e508                	sd	a0,8(a0)
ffffffffc0204f36:	e108                	sd	a0,0(a0)
static void
RR_init(struct run_queue *rq)
{
    ...
    rq->proc_num = 0;
ffffffffc0204f38:	00052823          	sw	zero,16(a0)
}
ffffffffc0204f3c:	8082                	ret

ffffffffc0204f3e <RR_pick_next>:
    return listelm->next;
ffffffffc0204f3e:	651c                	ld	a5,8(a0)
static struct proc_struct *
RR_pick_next(struct run_queue *rq)
{
    ...
    if (le != &(rq->run_list)) {
ffffffffc0204f40:	00f50563          	beq	a0,a5,ffffffffc0204f4a <RR_pick_next+0xc>
        return le2proc(le, run_link);
ffffffffc0204f44:	ef078513          	addi	a0,a5,-272
ffffffffc0204f48:	8082                	ret
    }
    return NULL;
ffffffffc0204f4a:	4501                	li	a0,0
}
ffffffffc0204f4c:	8082                	ret

ffffffffc0204f4e <RR_proc_tick>:
 */
static void
...
ffffffffc0204f4e:	1205a783          	lw	a5,288(a1)
ffffffffc0204f52:	00f05563          	blez	a5,ffffffffc0204f5c <RR_proc_tick+0xe>
        proc->time_slice --;
ffffffffc0204f56:	37fd                	addiw	a5,a5,-1
ffffffffc0204f58:	12f5a023          	sw	a5,288(a1)
    }
    if (proc->time_slice == 0) {
ffffffffc0204f5c:	e399                	bnez	a5,ffffffffc0204f62 <RR_proc_tick+0x14>
        proc->need_resched = 1;
ffffffffc0204f5e:	4785                	li	a5,1
ffffffffc0204f60:	ed9c                	sd	a5,24(a1)
    }
}
ffffffffc0204f62:	8082                	ret

ffffffffc0204f64 <RR_dequeue>:
    return list->next == list;
ffffffffc0204f64:	1185b703          	ld	a4,280(a1)
    assert(!list_empty(&(proc->run_link)) && proc->rq == rq);
ffffffffc0204f68:	11058793          	addi	a5,a1,272
ffffffffc0204f6c:	02e78363          	beq	a5,a4,ffffffffc0204f92 <RR_dequeue+0x2e>
ffffffffc0204f70:	1085b683          	ld	a3,264(a1)
ffffffffc0204f74:	00a69f63          	bne	a3,a0,ffffffffc0204f92 <RR_dequeue+0x2e>
    __list_del(listelm->prev, listelm->next);
ffffffffc0204f78:	1105b503          	ld	a0,272(a1)
    rq->proc_num --;
ffffffffc0204f7c:	4a90                	lw	a2,16(a3)
    prev->next = next;
ffffffffc0204f7e:	e518                	sd	a4,8(a0)
    next->prev = prev;
ffffffffc0204f80:	e308                	sd	a0,0(a4)
    elm->prev = elm->next = elm;
ffffffffc0204f82:	10f5bc23          	sd	a5,280(a1)
ffffffffc0204f86:	10f5b823          	sd	a5,272(a1)
ffffffffc0204f8a:	fff6079b          	addiw	a5,a2,-1
ffffffffc0204f8e:	ca9c                	sw	a5,16(a3)
ffffffffc0204f90:	8082                	ret
{
ffffffffc0204f92:	1141                	addi	sp,sp,-16
    assert(!list_empty(&(proc->run_link)) && proc->rq == rq);
ffffffffc0204f94:	00002697          	auipc	a3,0x2
ffffffffc0204f98:	4d468693          	addi	a3,a3,1236 # ffffffffc0207468 <default_pmm_manager+0xe60>
ffffffffc0204f9c:	00001617          	auipc	a2,0x1
ffffffffc0204fa0:	2bc60613          	addi	a2,a2,700 # ffffffffc0206258 <commands+0x818>
ffffffffc0204fa4:	03c00593          	li	a1,60
ffffffffc0204fa8:	00002517          	auipc	a0,0x2
ffffffffc0204fac:	4f850513          	addi	a0,a0,1272 # ffffffffc02074a0 <default_pmm_manager+0xe98>
{
ffffffffc0204fb0:	e406                	sd	ra,8(sp)
    assert(!list_empty(&(proc->run_link)) && proc->rq == rq);
ffffffffc0204fb2:	ce0fb0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc0204fb6 <RR_enqueue>:
    assert(list_empty(&(proc->run_link)));
ffffffffc0204fb6:	1185b703          	ld	a4,280(a1)
ffffffffc0204fba:	11058793          	addi	a5,a1,272
ffffffffc0204fbe:	02e79d63          	bne	a5,a4,ffffffffc0204ff8 <RR_enqueue+0x42>
    __list_add(elm, listelm->prev, listelm);
ffffffffc0204fc2:	6118                	ld	a4,0(a0)
    if (proc->time_slice == 0 || proc->time_slice > rq->max_time_slice) {
ffffffffc0204fc4:	1205a683          	lw	a3,288(a1)
    prev->next = next->prev = elm;
ffffffffc0204fc8:	e11c                	sd	a5,0(a0)
ffffffffc0204fca:	e71c                	sd	a5,8(a4)
    elm->next = next;
ffffffffc0204fcc:	10a5bc23          	sd	a0,280(a1)
    elm->prev = prev;
ffffffffc0204fd0:	10e5b823          	sd	a4,272(a1)
ffffffffc0204fd4:	495c                	lw	a5,20(a0)
ffffffffc0204fd6:	ea89                	bnez	a3,ffffffffc0204fe8 <RR_enqueue+0x32>
        proc->time_slice = rq->max_time_slice;
ffffffffc0204fd8:	12f5a023          	sw	a5,288(a1)
    rq->proc_num ++;
ffffffffc0204fdc:	491c                	lw	a5,16(a0)
    proc->rq = rq;
ffffffffc0204fde:	10a5b423          	sd	a0,264(a1)
    rq->proc_num ++;
ffffffffc0204fe2:	2785                	addiw	a5,a5,1
ffffffffc0204fe4:	c91c                	sw	a5,16(a0)
ffffffffc0204fe6:	8082                	ret
    if (proc->time_slice == 0 || proc->time_slice > rq->max_time_slice) {
ffffffffc0204fe8:	fed7c8e3          	blt	a5,a3,ffffffffc0204fd8 <RR_enqueue+0x22>
    rq->proc_num ++;
ffffffffc0204fec:	491c                	lw	a5,16(a0)
    proc->rq = rq;
ffffffffc0204fee:	10a5b423          	sd	a0,264(a1)
    rq->proc_num ++;
ffffffffc0204ff2:	2785                	addiw	a5,a5,1
ffffffffc0204ff4:	c91c                	sw	a5,16(a0)
ffffffffc0204ff6:	8082                	ret
{
ffffffffc0204ff8:	1141                	addi	sp,sp,-16
    assert(list_empty(&(proc->run_link)));
ffffffffc0204ffa:	00002697          	auipc	a3,0x2
ffffffffc0204ffe:	4c668693          	addi	a3,a3,1222 # ffffffffc02074c0 <default_pmm_manager+0xeb8>
ffffffffc0205002:	00001617          	auipc	a2,0x1
ffffffffc0205006:	25660613          	addi	a2,a2,598 # ffffffffc0206258 <commands+0x818>
ffffffffc020500a:	02800593          	li	a1,40
ffffffffc020500e:	00002517          	auipc	a0,0x2
ffffffffc0205012:	49250513          	addi	a0,a0,1170 # ffffffffc02074a0 <default_pmm_manager+0xe98>
{
ffffffffc0205016:	e406                	sd	ra,8(sp)
    assert(list_empty(&(proc->run_link)));
ffffffffc0205018:	c7afb0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc020501c <sched_class_proc_tick>:
...
{
    if (proc != idleproc)
ffffffffc020501c:	000c2797          	auipc	a5,0xc2
ffffffffc0205020:	e547b783          	ld	a5,-428(a5) # ffffffffc02c6e70 <idleproc>
{
ffffffffc0205024:	85aa                	mv	a1,a0
    if (proc != idleproc)
ffffffffc0205026:	00a78c63          	beq	a5,a0,ffffffffc020503e <sched_class_proc_tick+0x22>
    {
        sched_class->proc_tick(rq, proc);
ffffffffc020502a:	000c2797          	auipc	a5,0xc2
ffffffffc020502e:	e667b783          	ld	a5,-410(a5) # ffffffffc02c6e90 <sched_class>
ffffffffc0205032:	779c                	ld	a5,40(a5)
ffffffffc0205034:	000c2517          	auipc	a0,0xc2
ffffffffc0205038:	e5453503          	ld	a0,-428(a0) # ffffffffc02c6e88 <rq>
ffffffffc020503c:	8782                	jr	a5
    }
    else
    {
        proc->need_resched = 1;
ffffffffc020503e:	4705                	li	a4,1
ffffffffc0205040:	ef98                	sd	a4,24(a5)
    }
}
ffffffffc0205042:	8082                	ret

ffffffffc0205044 <sched_init>:

static struct run_queue __rq;

void sched_init(void)
{
ffffffffc0205044:	1141                	addi	sp,sp,-16
    list_init(&timer_list);

    //sched_class = &default_sched_class;
    // stride_sched_class
    sched_class = &default_sched_class;
ffffffffc0205046:	000be717          	auipc	a4,0xbe
ffffffffc020504a:	93270713          	addi	a4,a4,-1742 # ffffffffc02c2978 <default_sched_class>
{
ffffffffc020504e:	e022                	sd	s0,0(sp)
ffffffffc0205050:	e406                	sd	ra,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0205052:	000c2797          	auipc	a5,0xc2
ffffffffc0205056:	dae78793          	addi	a5,a5,-594 # ffffffffc02c6e00 <timer_list>
    rq = &__rq;
    rq->max_time_slice = MAX_TIME_SLICE;
    sched_class->init(rq);
ffffffffc020505a:	6714                	ld	a3,8(a4)
    rq = &__rq;
ffffffffc020505c:	000c2517          	auipc	a0,0xc2
ffffffffc0205060:	d8450513          	addi	a0,a0,-636 # ffffffffc02c6de0 <__rq>
ffffffffc0205064:	e79c                	sd	a5,8(a5)
ffffffffc0205066:	e39c                	sd	a5,0(a5)
    rq->max_time_slice = MAX_TIME_SLICE;
ffffffffc0205068:	4795                	li	a5,5
ffffffffc020506a:	c95c                	sw	a5,20(a0)
    sched_class = &default_sched_class;
ffffffffc020506c:	000c2417          	auipc	s0,0xc2
ffffffffc0205070:	e2440413          	addi	s0,s0,-476 # ffffffffc02c6e90 <sched_class>
    rq = &__rq;
ffffffffc0205074:	000c2797          	auipc	a5,0xc2
ffffffffc0205078:	e0a7ba23          	sd	a0,-492(a5) # ffffffffc02c6e88 <rq>
    sched_class = &default_sched_class;
ffffffffc020507c:	e018                	sd	a4,0(s0)
    sched_class->init(rq);
ffffffffc020507e:	9682                	jalr	a3

    cprintf("sched class: %s\n", sched_class->name);
ffffffffc0205080:	601c                	ld	a5,0(s0)
}
ffffffffc0205082:	6402                	ld	s0,0(sp)
ffffffffc0205084:	60a2                	ld	ra,8(sp)
    cprintf("sched class: %s\n", sched_class->name);
ffffffffc0205086:	638c                	ld	a1,0(a5)
ffffffffc0205088:	00002517          	auipc	a0,0x2
ffffffffc020508c:	46850513          	addi	a0,a0,1128 # ffffffffc02074f0 <default_pmm_manager+0xee8>
}
ffffffffc0205090:	0141                	addi	sp,sp,16
    cprintf("sched class: %s\n", sched_class->name);
ffffffffc0205092:	906fb06f          	j	ffffffffc0200198 <cprintf>

ffffffffc0205096 <wakeup_proc>:

void wakeup_proc(struct proc_struct *proc)
{
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205096:	4118                	lw	a4,0(a0)
{
ffffffffc0205098:	1101                	addi	sp,sp,-32
ffffffffc020509a:	ec06                	sd	ra,24(sp)
ffffffffc020509c:	e822                	sd	s0,16(sp)
ffffffffc020509e:	e426                	sd	s1,8(sp)
    assert(proc->state != PROC_ZOMBIE);
ffffffffc02050a0:	478d                	li	a5,3
ffffffffc02050a2:	08f70363          	beq	a4,a5,ffffffffc0205128 <wakeup_proc+0x92>
ffffffffc02050a6:	842a                	mv	s0,a0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02050a8:	100027f3          	csrr	a5,sstatus
ffffffffc02050ac:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc02050ae:	4481                	li	s1,0
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc02050b0:	e7bd                	bnez	a5,ffffffffc020511e <wakeup_proc+0x88>
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        if (proc->state != PROC_RUNNABLE)
ffffffffc02050b2:	4789                	li	a5,2
ffffffffc02050b4:	04f70863          	beq	a4,a5,ffffffffc0205104 <wakeup_proc+0x6e>
        {
            proc->state = PROC_RUNNABLE;
ffffffffc02050b8:	c01c                	sw	a5,0(s0)
            proc->wait_state = 0;
ffffffffc02050ba:	0e042623          	sw	zero,236(s0)
            if (proc != current)
ffffffffc02050be:	000c2797          	auipc	a5,0xc2
ffffffffc02050c2:	daa7b783          	ld	a5,-598(a5) # ffffffffc02c6e68 <current>
ffffffffc02050c6:	02878363          	beq	a5,s0,ffffffffc02050ec <wakeup_proc+0x56>
    if (proc != idleproc)
ffffffffc02050ca:	000c2797          	auipc	a5,0xc2
ffffffffc02050ce:	da67b783          	ld	a5,-602(a5) # ffffffffc02c6e70 <idleproc>
ffffffffc02050d2:	00f40d63          	beq	s0,a5,ffffffffc02050ec <wakeup_proc+0x56>
        sched_class->enqueue(rq, proc);
ffffffffc02050d6:	000c2797          	auipc	a5,0xc2
ffffffffc02050da:	dba7b783          	ld	a5,-582(a5) # ffffffffc02c6e90 <sched_class>
ffffffffc02050de:	6b9c                	ld	a5,16(a5)
ffffffffc02050e0:	85a2                	mv	a1,s0
ffffffffc02050e2:	000c2517          	auipc	a0,0xc2
ffffffffc02050e6:	da653503          	ld	a0,-602(a0) # ffffffffc02c6e88 <rq>
ffffffffc02050ea:	9782                	jalr	a5
    if (flag)
ffffffffc02050ec:	e491                	bnez	s1,ffffffffc02050f8 <wakeup_proc+0x62>
        {
...
ffffffffc02050fe:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205100:	8a9fb06f          	j	ffffffffc02009a8 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205104:	00002617          	auipc	a2,0x2
ffffffffc0205108:	43c60613          	addi	a2,a2,1084 # ffffffffc0207540 <default_pmm_manager+0xf38>
ffffffffc020510c:	05200593          	li	a1,82
ffffffffc0205110:	00002517          	auipc	a0,0x2
ffffffffc0205114:	41850513          	addi	a0,a0,1048 # ffffffffc0207528 <default_pmm_manager+0xf20>
ffffffffc0205118:	be2fb0ef          	jal	ra,ffffffffc02004fa <__warn>
ffffffffc020511c:	bfc1                	j	ffffffffc02050ec <wakeup_proc+0x56>
        intr_disable();
ffffffffc020511e:	891fb0ef          	jal	ra,ffffffffc02009ae <intr_disable>
        if (proc->state != PROC_RUNNABLE)
ffffffffc0205122:	4018                	lw	a4,0(s0)
        return 1;
ffffffffc0205124:	4485                	li	s1,1
ffffffffc0205126:	b771                	j	ffffffffc02050b2 <wakeup_proc+0x1c>
    assert(proc->state != PROC_ZOMBIE);
ffffffffc0205128:	00002697          	auipc	a3,0x2
ffffffffc020512c:	3e068693          	addi	a3,a3,992 # ffffffffc0207508 <default_pmm_manager+0xf00>
ffffffffc0205130:	00001617          	auipc	a2,0x1
ffffffffc0205134:	12860613          	addi	a2,a2,296 # ffffffffc0206258 <commands+0x818>
ffffffffc0205138:	04300593          	li	a1,67
ffffffffc020513c:	00002517          	auipc	a0,0x2
ffffffffc0205140:	3ec50513          	addi	a0,a0,1004 # ffffffffc0207528 <default_pmm_manager+0xf20>
ffffffffc0205144:	b4efb0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc0205148 <schedule>:

void schedule(void)
{
ffffffffc0205148:	7179                	addi	sp,sp,-48
ffffffffc020514a:	f406                	sd	ra,40(sp)
ffffffffc020514c:	f022                	sd	s0,32(sp)
ffffffffc020514e:	ec26                	sd	s1,24(sp)
ffffffffc0205150:	e84a                	sd	s2,16(sp)
ffffffffc0205152:	e44e                	sd	s3,8(sp)
ffffffffc0205154:	e052                	sd	s4,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE)
ffffffffc0205156:	100027f3          	csrr	a5,sstatus
ffffffffc020515a:	8b89                	andi	a5,a5,2
ffffffffc020515c:	4a01                	li	s4,0
ffffffffc020515e:	e3cd                	bnez	a5,ffffffffc0205200 <schedule+0xb8>
    bool intr_flag;
    struct proc_struct *next;
    local_intr_save(intr_flag);
    {
        current->need_resched = 0;
ffffffffc0205160:	000c2497          	auipc	s1,0xc2
ffffffffc0205164:	d0848493          	addi	s1,s1,-760 # ffffffffc02c6e68 <current>
ffffffffc0205168:	608c                	ld	a1,0(s1)
        sched_class->enqueue(rq, proc);
ffffffffc020516a:	000c2997          	auipc	s3,0xc2
ffffffffc020516e:	d2698993          	addi	s3,s3,-730 # ffffffffc02c6e90 <sched_class>
ffffffffc0205172:	000c2917          	auipc	s2,0xc2
ffffffffc0205176:	d1690913          	addi	s2,s2,-746 # ffffffffc02c6e88 <rq>
        if (current->state == PROC_RUNNABLE)
ffffffffc020517a:	4194                	lw	a3,0(a1)
        current->need_resched = 0;
ffffffffc020517c:	0005bc23          	sd	zero,24(a1)
        if (current->state == PROC_RUNNABLE)
ffffffffc0205180:	4709                	li	a4,2
        sched_class->enqueue(rq, proc);
ffffffffc0205182:	0009b783          	ld	a5,0(s3)
ffffffffc0205186:	00093503          	ld	a0,0(s2)
        if (current->state == PROC_RUNNABLE)
ffffffffc020518a:	04e68e63          	beq	a3,a4,ffffffffc02051e6 <schedule+0x9e>
    return sched_class->pick_next(rq);
ffffffffc020518e:	739c                	ld	a5,32(a5)
ffffffffc0205190:	9782                	jalr	a5
ffffffffc0205192:	842a                	mv	s0,a0
        {
            sched_class_enqueue(current);
        }
        if ((next = sched_class_pick_next()) != NULL)
ffffffffc0205194:	c521                	beqz	a0,ffffffffc02051dc <schedule+0x94>
    sched_class->dequeue(rq, proc);
ffffffffc0205196:	0009b783          	ld	a5,0(s3)
ffffffffc020519a:	00093503          	ld	a0,0(s2)
ffffffffc020519e:	85a2                	mv	a1,s0
ffffffffc02051a0:	6f9c                	ld	a5,24(a5)
ffffffffc02051a2:	9782                	jalr	a5
        }
        if (next == NULL)
        {
            next = idleproc;
        ...
        next->runs++;
ffffffffc02051a4:	441c                	lw	a5,8(s0)
        if (next != current)
ffffffffc02051a6:	6098                	ld	a4,0(s1)
        next->runs++;
ffffffffc02051a8:	2785                	addiw	a5,a5,1
ffffffffc02051aa:	c41c                	sw	a5,8(s0)
        if (next != current)
ffffffffc02051ac:	00870563          	beq	a4,s0,ffffffffc02051b6 <schedule+0x6e>
        {
            proc_run(next);
ffffffffc02051b0:	8522                	mv	a0,s0
ffffffffc02051b2:	c1ffe0ef          	jal	ra,ffffffffc0203dd0 <proc_run>
    if (flag)
ffffffffc02051b6:	000a1a63          	bnez	s4,ffffffffc02051ca <schedule+0x82>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc02051ba:	70a2                	ld	ra,40(sp)
ffffffffc02051bc:	7402                	ld	s0,32(sp)
ffffffffc02051be:	64e2                	ld	s1,24(sp)
ffffffffc02051c0:	6942                	ld	s2,16(sp)
ffffffffc02051c2:	69a2                	ld	s3,8(sp)
ffffffffc02051c4:	6a02                	ld	s4,0(sp)
ffffffffc02051c6:	6145                	addi	sp,sp,48
ffffffffc02051c8:	8082                	ret
ffffffffc02051ca:	7402                	ld	s0,32(sp)
ffffffffc02051cc:	70a2                	ld	ra,40(sp)
ffffffffc02051ce:	64e2                	ld	s1,24(sp)
ffffffffc02051d0:	6942                	ld	s2,16(sp)
ffffffffc02051d2:	69a2                	ld	s3,8(sp)
ffffffffc02051d4:	6a02                	ld	s4,0(sp)
ffffffffc02051d6:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc02051d8:	fd0fb06f          	j	ffffffffc02009a8 <intr_enable>
            next = idleproc;
ffffffffc02051dc:	000c2417          	auipc	s0,0xc2
ffffffffc02051e0:	c9443403          	ld	s0,-876(s0) # ffffffffc02c6e70 <idleproc>
ffffffffc02051e4:	b7c1                	j	ffffffffc02051a4 <schedule+0x5c>
    if (proc != idleproc)
ffffffffc02051e6:	000c2717          	auipc	a4,0xc2
ffffffffc02051ea:	c8a73703          	ld	a4,-886(a4) # ffffffffc02c6e70 <idleproc>
ffffffffc02051ee:	fae580e3          	beq	a1,a4,ffffffffc020518e <schedule+0x46>
        sched_class->enqueue(rq, proc);
ffffffffc02051f2:	6b9c                	ld	a5,16(a5)
ffffffffc02051f4:	9782                	jalr	a5
    return sched_class->pick_next(rq);
ffffffffc02051f6:	0009b783          	ld	a5,0(s3)
ffffffffc02051fa:	00093503          	ld	a0,0(s2)
ffffffffc02051fe:	bf41                	j	ffffffffc020518e <schedule+0x46>
        intr_disable();
ffffffffc0205200:	faefb0ef          	jal	ra,ffffffffc02009ae <intr_disable>
        return 1;
ffffffffc0205204:	4a05                	li	s4,1
ffffffffc0205206:	bfa9                	j	ffffffffc0205160 <schedule+0x18>

ffffffffc0205208 <sys_getpid>:
    return do_kill(pid);
}
...
sys_getpid(uint64_t arg[]) {
    return current->pid;
ffffffffc0205208:	000c2797          	auipc	a5,0xc2
ffffffffc020520c:	c607b783          	ld	a5,-928(a5) # ffffffffc02c6e68 <current>
}
ffffffffc0205210:	43c8                	lw	a0,4(a5)
ffffffffc0205212:	8082                	ret

ffffffffc0205214 <sys_pgdir>:
...
ffffffffc0205214:	4501                	li	a0,0
ffffffffc0205216:	8082                	ret

ffffffffc0205218 <sys_gettime>:
static int sys_gettime(uint64_t arg[]){
    return (int)ticks*10;
ffffffffc0205218:	000c2797          	auipc	a5,0xc2
ffffffffc020521c:	c007b783          	ld	a5,-1024(a5) # ffffffffc02c6e18 <ticks>
ffffffffc0205220:	0027951b          	slliw	a0,a5,0x2
ffffffffc0205224:	9d3d                	addw	a0,a0,a5
}
ffffffffc0205226:	0015151b          	slliw	a0,a0,0x1
ffffffffc020522a:	8082                	ret

ffffffffc020522c <sys_lab6_set_priority>:
static int sys_lab6_set_priority(uint64_t arg[]){
    uint64_t priority = (uint64_t)arg[0];
    lab6_set_priority(priority);
ffffffffc020522c:	4108                	lw	a0,0(a0)
static int sys_lab6_set_priority(uint64_t arg[]){
ffffffffc020522e:	1141                	addi	sp,sp,-16
ffffffffc0205230:	e406                	sd	ra,8(sp)
    lab6_set_priority(priority);
ffffffffc0205232:	c5fff0ef          	jal	ra,ffffffffc0204e90 <lab6_set_priority>
    return 0;
}
ffffffffc0205236:	60a2                	ld	ra,8(sp)
ffffffffc0205238:	4501                	li	a0,0
ffffffffc020523a:	0141                	addi	sp,sp,16
ffffffffc020523c:	8082                	ret

ffffffffc020523e <sys_putc>:
    cputchar(c);
ffffffffc020523e:	4108                	lw	a0,0(a0)
sys_putc(uint64_t arg[]) {
ffffffffc0205240:	1141                	addi	sp,sp,-16
ffffffffc0205242:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc0205244:	f8bfa0ef          	jal	ra,ffffffffc02001ce <cputchar>
}
ffffffffc0205248:	60a2                	ld	ra,8(sp)
ffffffffc020524a:	4501                	li	a0,0
ffffffffc020524c:	0141                	addi	sp,sp,16
ffffffffc020524e:	8082                	ret

ffffffffc0205250 <sys_kill>:
    return do_kill(pid);
ffffffffc0205250:	4108                	lw	a0,0(a0)
ffffffffc0205252:	a11ff06f          	j	ffffffffc0204c62 <do_kill>

ffffffffc0205256 <sys_yield>:
    return do_yield();
ffffffffc0205256:	9bfff06f          	j	ffffffffc0204c14 <do_yield>

ffffffffc020525a <sys_exec>:
    return do_execve(name, len, binary, size);
ffffffffc020525a:	6d14                	ld	a3,24(a0)
ffffffffc020525c:	6910                	ld	a2,16(a0)
ffffffffc020525e:	650c                	ld	a1,8(a0)
ffffffffc0205260:	6108                	ld	a0,0(a0)
ffffffffc0205262:	c08ff06f          	j	ffffffffc020466a <do_execve>

ffffffffc0205266 <sys_wait>:
    return do_wait(pid, store);
ffffffffc0205266:	650c                	ld	a1,8(a0)
ffffffffc0205268:	4108                	lw	a0,0(a0)
ffffffffc020526a:	9bbff06f          	j	ffffffffc0204c24 <do_wait>

ffffffffc020526e <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc020526e:	000c2797          	auipc	a5,0xc2
ffffffffc0205272:	bfa7b783          	ld	a5,-1030(a5) # ffffffffc02c6e68 <current>
ffffffffc0205276:	73d0                	ld	a2,160(a5)
    return do_fork(0, stack, tf);
ffffffffc0205278:	4501                	li	a0,0
ffffffffc020527a:	6a0c                	ld	a1,16(a2)
ffffffffc020527c:	bb9fe06f          	j	ffffffffc0203e34 <do_fork>

ffffffffc0205280 <sys_exit>:
    return do_exit(error_code);
ffffffffc0205280:	4108                	lw	a0,0(a0)
ffffffffc0205282:	fa9fe06f          	j	ffffffffc020422a <do_exit>

ffffffffc0205286 <syscall>:
};
...
void
syscall(void) {
ffffffffc0205286:	715d                	addi	sp,sp,-80
ffffffffc0205288:	fc26                	sd	s1,56(sp)
    struct trapframe *tf = current->tf;
ffffffffc020528a:	000c2497          	auipc	s1,0xc2
ffffffffc020528e:	bde48493          	addi	s1,s1,-1058 # ffffffffc02c6e68 <current>
ffffffffc0205292:	6098                	ld	a4,0(s1)
syscall(void) {
ffffffffc0205294:	e0a2                	sd	s0,64(sp)
ffffffffc0205296:	f84a                	sd	s2,48(sp)
    struct trapframe *tf = current->tf;
ffffffffc0205298:	7340                	ld	s0,160(a4)
syscall(void) {
ffffffffc020529a:	e486                	sd	ra,72(sp)
    uint64_t arg[5];
    int num = tf->gpr.a0;
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc020529c:	0ff00793          	li	a5,255
    int num = tf->gpr.a0;
ffffffffc02052a0:	05042903          	lw	s2,80(s0)
    if (num >= 0 && num < NUM_SYSCALLS) {
ffffffffc02052a4:	0327ee63          	bltu	a5,s2,ffffffffc02052e0 <syscall+0x5a>
        if (syscalls[num] != NULL) {
ffffffffc02052a8:	00391713          	slli	a4,s2,0x3
ffffffffc02052ac:	00002797          	auipc	a5,0x2
ffffffffc02052b0:	2fc78793          	addi	a5,a5,764 # ffffffffc02075a8 <syscalls>
ffffffffc02052b4:	97ba                	add	a5,a5,a4
ffffffffc02052b6:	639c                	ld	a5,0(a5)
ffffffffc02052b8:	c785                	beqz	a5,ffffffffc02052e0 <syscall+0x5a>
            arg[0] = tf->gpr.a1;
ffffffffc02052ba:	6c28                	ld	a0,88(s0)
            arg[1] = tf->gpr.a2;
ffffffffc02052bc:	702c                	ld	a1,96(s0)
            arg[2] = tf->gpr.a3;
ffffffffc02052be:	7430                	ld	a2,104(s0)
            arg[3] = tf->gpr.a4;
ffffffffc02052c0:	7834                	ld	a3,112(s0)
            arg[4] = tf->gpr.a5;
ffffffffc02052c2:	7c38                	ld	a4,120(s0)
            arg[0] = tf->gpr.a1;
ffffffffc02052c4:	e42a                	sd	a0,8(sp)
            arg[1] = tf->gpr.a2;
ffffffffc02052c6:	e82e                	sd	a1,16(sp)
            arg[2] = tf->gpr.a3;
ffffffffc02052c8:	ec32                	sd	a2,24(sp)
            arg[3] = tf->gpr.a4;
ffffffffc02052ca:	f036                	sd	a3,32(sp)
            arg[4] = tf->gpr.a5;
ffffffffc02052cc:	f43a                	sd	a4,40(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02052ce:	0028                	addi	a0,sp,8
ffffffffc02052d0:	9782                	jalr	a5
        }
    }
    print_trapframe(tf);
...
ffffffffc02052d2:	60a6                	ld	ra,72(sp)
            tf->gpr.a0 = syscalls[num](arg);
ffffffffc02052d4:	e828                	sd	a0,80(s0)
}
ffffffffc02052d6:	6406                	ld	s0,64(sp)
ffffffffc02052d8:	74e2                	ld	s1,56(sp)
ffffffffc02052da:	7942                	ld	s2,48(sp)
ffffffffc02052dc:	6161                	addi	sp,sp,80
ffffffffc02052de:	8082                	ret
    print_trapframe(tf);
ffffffffc02052e0:	8522                	mv	a0,s0
ffffffffc02052e2:	8bdfb0ef          	jal	ra,ffffffffc0200b9e <print_trapframe>
    panic("undefined syscall %d, pid = %d, name = %s.\n",
ffffffffc02052e6:	609c                	ld	a5,0(s1)
ffffffffc02052e8:	86ca                	mv	a3,s2
ffffffffc02052ea:	00002617          	auipc	a2,0x2
ffffffffc02052ee:	27660613          	addi	a2,a2,630 # ffffffffc0207560 <default_pmm_manager+0xf58>
ffffffffc02052f2:	43d8                	lw	a4,4(a5)
ffffffffc02052f4:	06c00593          	li	a1,108
ffffffffc02052f8:	0b478793          	addi	a5,a5,180
ffffffffc02052fc:	00002517          	auipc	a0,0x2
ffffffffc0205300:	29450513          	addi	a0,a0,660 # ffffffffc0207590 <default_pmm_manager+0xf88>
ffffffffc0205304:	98efb0ef          	jal	ra,ffffffffc0200492 <__panic>

ffffffffc0205308 <hash32>:
 *
...
ffffffffc0205308:	9e3707b7          	lui	a5,0x9e370
ffffffffc020530c:	2785                	addiw	a5,a5,1
ffffffffc020530e:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0205312:	02000793          	li	a5,32
ffffffffc0205316:	9f8d                	subw	a5,a5,a1
}
ffffffffc0205318:	00f5553b          	srlw	a0,a0,a5
ffffffffc020531c:	8082                	ret

ffffffffc020531e <printnum>:
 * */
static void
...
ffffffffc020531e:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0205322:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0205324:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0205328:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc020532a:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020532e:	f022                	sd	s0,32(sp)
ffffffffc0205330:	ec26                	sd	s1,24(sp)
ffffffffc0205332:	e84a                	sd	s2,16(sp)
ffffffffc0205334:	f406                	sd	ra,40(sp)
ffffffffc0205336:	e44e                	sd	s3,8(sp)
ffffffffc0205338:	84aa                	mv	s1,a0
ffffffffc020533a:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc020533c:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0205340:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0205342:	03067e63          	bgeu	a2,a6,ffffffffc020537e <printnum+0x60>
ffffffffc0205346:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0205348:	00805763          	blez	s0,ffffffffc0205356 <printnum+0x38>
ffffffffc020534c:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc020534e:	85ca                	mv	a1,s2
ffffffffc0205350:	854e                	mv	a0,s3
ffffffffc0205352:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0205354:	fc65                	bnez	s0,ffffffffc020534c <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205356:	1a02                	slli	s4,s4,0x20
ffffffffc0205358:	00003797          	auipc	a5,0x3
ffffffffc020535c:	a5078793          	addi	a5,a5,-1456 # ffffffffc0207da8 <syscalls+0x800>
ffffffffc0205360:	020a5a13          	srli	s4,s4,0x20
ffffffffc0205364:	9a3e                	add	s4,s4,a5
...
ffffffffc0205366:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205368:	000a4503          	lbu	a0,0(s4)
}
ffffffffc020536c:	70a2                	ld	ra,40(sp)
ffffffffc020536e:	69a2                	ld	s3,8(sp)
ffffffffc0205370:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0205372:	85ca                	mv	a1,s2
ffffffffc0205374:	87a6                	mv	a5,s1
}
ffffffffc0205376:	6942                	ld	s2,16(sp)
ffffffffc0205378:	64e2                	ld	s1,24(sp)
ffffffffc020537a:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020537c:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc020537e:	03065633          	divu	a2,a2,a6
ffffffffc0205382:	8722                	mv	a4,s0
ffffffffc0205384:	f9bff0ef          	jal	ra,ffffffffc020531e <printnum>
ffffffffc0205388:	b7f9                	j	ffffffffc0205356 <printnum+0x38>

ffffffffc020538a <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc020538a:	7119                	addi	sp,sp,-128
ffffffffc020538c:	f4a6                	sd	s1,104(sp)
ffffffffc020538e:	f0ca                	sd	s2,96(sp)
ffffffffc0205390:	ecce                	sd	s3,88(sp)
ffffffffc0205392:	e8d2                	sd	s4,80(sp)
ffffffffc0205394:	e4d6                	sd	s5,72(sp)
ffffffffc0205396:	e0da                	sd	s6,64(sp)
ffffffffc0205398:	fc5e                	sd	s7,56(sp)
ffffffffc020539a:	f06a                	sd	s10,32(sp)
ffffffffc020539c:	fc86                	sd	ra,120(sp)
ffffffffc020539e:	f8a2                	sd	s0,112(sp)
ffffffffc02053a0:	f862                	sd	s8,48(sp)
ffffffffc02053a2:	f466                	sd	s9,40(sp)
ffffffffc02053a4:	ec6e                	sd	s11,24(sp)
ffffffffc02053a6:	892a                	mv	s2,a0
ffffffffc02053a8:	84ae                	mv	s1,a1
ffffffffc02053aa:	8d32                	mv	s10,a2
ffffffffc02053ac:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc02053ae:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02053b2:	5b7d                	li	s6,-1
ffffffffc02053b4:	00003a97          	auipc	s5,0x3
ffffffffc02053b8:	a20a8a93          	addi	s5,s5,-1504 # ffffffffc0207dd4 <syscalls+0x82c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc02053bc:	00003b97          	auipc	s7,0x3
ffffffffc02053c0:	c34b8b93          	addi	s7,s7,-972 # ffffffffc0207ff0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02053c4:	000d4503          	lbu	a0,0(s10)
ffffffffc02053c8:	001d0413          	addi	s0,s10,1
ffffffffc02053cc:	01350a63          	beq	a0,s3,ffffffffc02053e0 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc02053d0:	c121                	beqz	a0,ffffffffc0205410 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc02053d2:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02053d4:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc02053d6:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02053d8:	fff44503          	lbu	a0,-1(s0)
ffffffffc02053dc:	ff351ae3          	bne	a0,s3,ffffffffc02053d0 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02053e0:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc02053e4:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc02053e8:	4c81                	li	s9,0
ffffffffc02053ea:	4881                	li	a7,0
        width = precision = -1;
ffffffffc02053ec:	5c7d                	li	s8,-1
ffffffffc02053ee:	5dfd                	li	s11,-1
ffffffffc02053f0:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc02053f4:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02053f6:	fdd6059b          	addiw	a1,a2,-35
ffffffffc02053fa:	0ff5f593          	zext.b	a1,a1
ffffffffc02053fe:	00140d13          	addi	s10,s0,1
ffffffffc0205402:	04b56263          	bltu	a0,a1,ffffffffc0205446 <vprintfmt+0xbc>
ffffffffc0205406:	058a                	slli	a1,a1,0x2
ffffffffc0205408:	95d6                	add	a1,a1,s5
ffffffffc020540a:	4194                	lw	a3,0(a1)
ffffffffc020540c:	96d6                	add	a3,a3,s5
ffffffffc020540e:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0205410:	70e6                	ld	ra,120(sp)
ffffffffc0205412:	7446                	ld	s0,112(sp)
ffffffffc0205414:	74a6                	ld	s1,104(sp)
ffffffffc0205416:	7906                	ld	s2,96(sp)
ffffffffc0205418:	69e6                	ld	s3,88(sp)
ffffffffc020541a:	6a46                	ld	s4,80(sp)
ffffffffc020541c:	6aa6                	ld	s5,72(sp)
ffffffffc020541e:	6b06                	ld	s6,64(sp)
ffffffffc0205420:	7be2                	ld	s7,56(sp)
ffffffffc0205422:	7c42                	ld	s8,48(sp)
ffffffffc0205424:	7ca2                	ld	s9,40(sp)
ffffffffc0205426:	7d02                	ld	s10,32(sp)
ffffffffc0205428:	6de2                	ld	s11,24(sp)
ffffffffc020542a:	6109                	addi	sp,sp,128
ffffffffc020542c:	8082                	ret
            padc = '0';
ffffffffc020542e:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0205430:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205434:	846a                	mv	s0,s10
ffffffffc0205436:	00140d13          	addi	s10,s0,1
ffffffffc020543a:	fdd6059b          	addiw	a1,a2,-35
ffffffffc020543e:	0ff5f593          	zext.b	a1,a1
ffffffffc0205442:	fcb572e3          	bgeu	a0,a1,ffffffffc0205406 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0205446:	85a6                	mv	a1,s1
ffffffffc0205448:	02500513          	li	a0,37
ffffffffc020544c:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020544e:	fff44783          	lbu	a5,-1(s0)
ffffffffc0205452:	8d22                	mv	s10,s0
ffffffffc0205454:	f73788e3          	beq	a5,s3,ffffffffc02053c4 <vprintfmt+0x3a>
ffffffffc0205458:	ffed4783          	lbu	a5,-2(s10)
ffffffffc020545c:	1d7d                	addi	s10,s10,-1
ffffffffc020545e:	ff379de3          	bne	a5,s3,ffffffffc0205458 <vprintfmt+0xce>
ffffffffc0205462:	b78d                	j	ffffffffc02053c4 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0205464:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0205468:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020546c:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc020546e:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0205472:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0205476:	02d86463          	bltu	a6,a3,ffffffffc020549e <vprintfmt+0x114>
                ch = *fmt;
ffffffffc020547a:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc020547e:	002c169b          	slliw	a3,s8,0x2
ffffffffc0205482:	0186873b          	addw	a4,a3,s8
ffffffffc0205486:	0017171b          	slliw	a4,a4,0x1
ffffffffc020548a:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc020548c:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0205490:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0205492:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0205496:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc020549a:	fed870e3          	bgeu	a6,a3,ffffffffc020547a <vprintfmt+0xf0>
            if (width < 0)
ffffffffc020549e:	f40ddce3          	bgez	s11,ffffffffc02053f6 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc02054a2:	8de2                	mv	s11,s8
ffffffffc02054a4:	5c7d                	li	s8,-1
ffffffffc02054a6:	bf81                	j	ffffffffc02053f6 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc02054a8:	fffdc693          	not	a3,s11
ffffffffc02054ac:	96fd                	srai	a3,a3,0x3f
ffffffffc02054ae:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02054b2:	00144603          	lbu	a2,1(s0)
ffffffffc02054b6:	2d81                	sext.w	s11,s11
ffffffffc02054b8:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02054ba:	bf35                	j	ffffffffc02053f6 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc02054bc:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc02054c8:	bfd9                	j	ffffffffc020549e <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc02054ca:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02054cc:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02054d0:	01174463          	blt	a4,a7,ffffffffc02054d8 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc02054d4:	1a088e63          	beqz	a7,ffffffffc0205690 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc02054d8:	000a3603          	ld	a2,0(s4)
ffffffffc02054dc:	46c1                	li	a3,16
ffffffffc02054de:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc02054e0:	2781                	sext.w	a5,a5
ffffffffc02054e2:	876e                	mv	a4,s11
ffffffffc02054e4:	85a6                	mv	a1,s1
ffffffffc02054e6:	854a                	mv	a0,s2
ffffffffc02054e8:	e37ff0ef          	jal	ra,ffffffffc020531e <printnum>
            break;
ffffffffc02054ec:	bde1                	j	ffffffffc02053c4 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc02054ee:	000a2503          	lw	a0,0(s4)
ffffffffc02054f2:	85a6                	mv	a1,s1
ffffffffc02054f4:	0a21                	addi	s4,s4,8
ffffffffc02054f6:	9902                	jalr	s2
            break;
ffffffffc02054f8:	b5f1                	j	ffffffffc02053c4 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02054fa:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02054fc:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0205500:	01174463          	blt	a4,a7,ffffffffc0205508 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0205504:	18088163          	beqz	a7,ffffffffc0205686 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0205508:	000a3603          	ld	a2,0(s4)
ffffffffc020550c:	46a9                	li	a3,10
ffffffffc020550e:	8a2e                	mv	s4,a1
ffffffffc0205510:	bfc1                	j	ffffffffc02054e0 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205512:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0205516:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205518:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020551a:	bdf1                	j	ffffffffc02053f6 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc020551c:	85a6                	mv	a1,s1
ffffffffc020551e:	02500513          	li	a0,37
ffffffffc0205522:	9902                	jalr	s2
            break;
ffffffffc0205524:	b545                	j	ffffffffc02053c4 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0205526:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc020552a:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020552c:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020552e:	b5e1                	j	ffffffffc02053f6 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0205530:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0205532:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0205536:	01174463          	blt	a4,a7,ffffffffc020553e <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc020553a:	14088163          	beqz	a7,ffffffffc020567c <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc020553e:	000a3603          	ld	a2,0(s4)
ffffffffc0205542:	46a1                	li	a3,8
ffffffffc0205544:	8a2e                	mv	s4,a1
ffffffffc0205546:	bf69                	j	ffffffffc02054e0 <vprintfmt+0x156>
            putch('0', putdat);
...
ffffffffc0205554:	07800513          	li	a0,120
...
ffffffffc020555e:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0205560:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0205564:	bfb5                	j	ffffffffc02054e0 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0205566:	000a3403          	ld	s0,0(s4)
ffffffffc020556a:	008a0713          	addi	a4,s4,8
ffffffffc020556e:	e03a                	sd	a4,0(sp)
ffffffffc0205570:	14040263          	beqz	s0,ffffffffc02056b4 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0205574:	0fb05763          	blez	s11,ffffffffc0205662 <vprintfmt+0x2d8>
ffffffffc0205578:	02d00693          	li	a3,45
ffffffffc020557c:	0cd79163          	bne	a5,a3,ffffffffc020563e <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205580:	00044783          	lbu	a5,0(s0)
ffffffffc0205584:	0007851b          	sext.w	a0,a5
ffffffffc0205588:	cf85                	beqz	a5,ffffffffc02055c0 <vprintfmt+0x236>
ffffffffc020558a:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020558e:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205592:	000c4563          	bltz	s8,ffffffffc020559c <vprintfmt+0x212>
ffffffffc0205596:	3c7d                	addiw	s8,s8,-1
ffffffffc0205598:	036c0263          	beq	s8,s6,ffffffffc02055bc <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc020559c:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020559e:	0e0c8e63          	beqz	s9,ffffffffc020569a <vprintfmt+0x310>
ffffffffc02055a2:	3781                	addiw	a5,a5,-32
ffffffffc02055a4:	0ef47b63          	bgeu	s0,a5,ffffffffc020569a <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc02055a8:	03f00513          	li	a0,63
ffffffffc02055ac:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02055ae:	000a4783          	lbu	a5,0(s4)
ffffffffc02055b2:	3dfd                	addiw	s11,s11,-1
ffffffffc02055b4:	0a05                	addi	s4,s4,1
ffffffffc02055b6:	0007851b          	sext.w	a0,a5
ffffffffc02055ba:	ffe1                	bnez	a5,ffffffffc0205592 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc02055bc:	01b05963          	blez	s11,ffffffffc02055ce <vprintfmt+0x244>
ffffffffc02055c0:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc02055c2:	85a6                	mv	a1,s1
ffffffffc02055c4:	02000513          	li	a0,32
ffffffffc02055c8:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02055ca:	fe0d9be3          	bnez	s11,ffffffffc02055c0 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc02055ce:	6a02                	ld	s4,0(sp)
ffffffffc02055d0:	bbd5                	j	ffffffffc02053c4 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02055d2:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02055d4:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc02055d8:	01174463          	blt	a4,a7,ffffffffc02055e0 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc02055dc:	08088d63          	beqz	a7,ffffffffc0205676 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc02055e0:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc02055e4:	0a044d63          	bltz	s0,ffffffffc020569e <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc02055e8:	8622                	mv	a2,s0
ffffffffc02055ea:	8a66                	mv	s4,s9
ffffffffc02055ec:	46a9                	li	a3,10
ffffffffc02055ee:	bdcd                	j	ffffffffc02054e0 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc02055f0:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02055f4:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02055f6:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc02055f8:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02055fc:	8fb5                	xor	a5,a5,a3
ffffffffc02055fe:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0205602:	02d74163          	blt	a4,a3,ffffffffc0205624 <vprintfmt+0x29a>
ffffffffc0205606:	00369793          	slli	a5,a3,0x3
ffffffffc020560a:	97de                	add	a5,a5,s7
ffffffffc020560c:	639c                	ld	a5,0(a5)
ffffffffc020560e:	cb99                	beqz	a5,ffffffffc0205624 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0205610:	86be                	mv	a3,a5
ffffffffc0205612:	00000617          	auipc	a2,0x0
ffffffffc0205616:	1ee60613          	addi	a2,a2,494 # ffffffffc0205800 <etext+0x28>
ffffffffc020561a:	85a6                	mv	a1,s1
ffffffffc020561c:	854a                	mv	a0,s2
ffffffffc020561e:	0ce000ef          	jal	ra,ffffffffc02056ec <printfmt>
ffffffffc0205622:	b34d                	j	ffffffffc02053c4 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0205624:	00002617          	auipc	a2,0x2
ffffffffc0205628:	7a460613          	addi	a2,a2,1956 # ffffffffc0207dc8 <syscalls+0x820>
ffffffffc020562c:	85a6                	mv	a1,s1
ffffffffc020562e:	854a                	mv	a0,s2
ffffffffc0205630:	0bc000ef          	jal	ra,ffffffffc02056ec <printfmt>
ffffffffc0205634:	bb41                	j	ffffffffc02053c4 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0205636:	00002417          	auipc	s0,0x2
ffffffffc020563a:	78a40413          	addi	s0,s0,1930 # ffffffffc0207dc0 <syscalls+0x818>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020563e:	85e2                	mv	a1,s8
ffffffffc0205640:	8522                	mv	a0,s0
ffffffffc0205642:	e43e                	sd	a5,8(sp)
ffffffffc0205644:	0e2000ef          	jal	ra,ffffffffc0205726 <strnlen>
ffffffffc0205648:	40ad8dbb          	subw	s11,s11,a0
ffffffffc020564c:	01b05b63          	blez	s11,ffffffffc0205662 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0205650:	67a2                	ld	a5,8(sp)
ffffffffc0205652:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0205656:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0205658:	85a6                	mv	a1,s1
ffffffffc020565a:	8552                	mv	a0,s4
ffffffffc020565c:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020565e:	fe0d9ce3          	bnez	s11,ffffffffc0205656 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0205662:	00044783          	lbu	a5,0(s0)
ffffffffc0205666:	00140a13          	addi	s4,s0,1
ffffffffc020566a:	0007851b          	sext.w	a0,a5
ffffffffc020566e:	d3a5                	beqz	a5,ffffffffc02055ce <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0205670:	05e00413          	li	s0,94
ffffffffc0205674:	bf39                	j	ffffffffc0205592 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0205676:	000a2403          	lw	s0,0(s4)
ffffffffc020567a:	b7ad                	j	ffffffffc02055e4 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc020567c:	000a6603          	lwu	a2,0(s4)
ffffffffc0205680:	46a1                	li	a3,8
ffffffffc0205682:	8a2e                	mv	s4,a1
ffffffffc0205684:	bdb1                	j	ffffffffc02054e0 <vprintfmt+0x156>
ffffffffc0205686:	000a6603          	lwu	a2,0(s4)
ffffffffc020568a:	46a9                	li	a3,10
ffffffffc020568c:	8a2e                	mv	s4,a1
ffffffffc020568e:	bd89                	j	ffffffffc02054e0 <vprintfmt+0x156>
ffffffffc0205690:	000a6603          	lwu	a2,0(s4)
ffffffffc0205694:	46c1                	li	a3,16
ffffffffc0205696:	8a2e                	mv	s4,a1
ffffffffc0205698:	b5a1                	j	ffffffffc02054e0 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc020569a:	9902                	jalr	s2
ffffffffc020569c:	bf09                	j	ffffffffc02055ae <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc020569e:	85a6                	mv	a1,s1
ffffffffc02056a0:	02d00513          	li	a0,45
ffffffffc02056a4:	e03e                	sd	a5,0(sp)
ffffffffc02056a6:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02056a8:	6782                	ld	a5,0(sp)
ffffffffc02056aa:	8a66                	mv	s4,s9
ffffffffc02056ac:	40800633          	neg	a2,s0
ffffffffc02056b0:	46a9                	li	a3,10
ffffffffc02056b2:	b53d                	j	ffffffffc02054e0 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc02056b4:	03b05163          	blez	s11,ffffffffc02056d6 <vprintfmt+0x34c>
ffffffffc02056b8:	02d00693          	li	a3,45
ffffffffc02056bc:	f6d79de3          	bne	a5,a3,ffffffffc0205636 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc02056c0:	00002417          	auipc	s0,0x2
ffffffffc02056c4:	70040413          	addi	s0,s0,1792 # ffffffffc0207dc0 <syscalls+0x818>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02056c8:	02800793          	li	a5,40
ffffffffc02056cc:	02800513          	li	a0,40
ffffffffc02056d0:	00140a13          	addi	s4,s0,1
ffffffffc02056d4:	bd6d                	j	ffffffffc020558e <vprintfmt+0x204>
ffffffffc02056d6:	00002a17          	auipc	s4,0x2
ffffffffc02056da:	6eba0a13          	addi	s4,s4,1771 # ffffffffc0207dc1 <syscalls+0x819>
ffffffffc02056de:	02800513          	li	a0,40
ffffffffc02056e2:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02056e6:	05e00413          	li	s0,94
ffffffffc02056ea:	b565                	j	ffffffffc0205592 <vprintfmt+0x208>

ffffffffc02056ec <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02056ec:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc02056ee:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02056f2:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc02056f4:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc02056f6:	ec06                	sd	ra,24(sp)
ffffffffc02056f8:	f83a                	sd	a4,48(sp)
ffffffffc02056fa:	fc3e                	sd	a5,56(sp)
ffffffffc02056fc:	e0c2                	sd	a6,64(sp)
ffffffffc02056fe:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0205700:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0205702:	c89ff0ef          	jal	ra,ffffffffc020538a <vprintfmt>
}
ffffffffc0205706:	60e2                	ld	ra,24(sp)
ffffffffc0205708:	6161                	addi	sp,sp,80
ffffffffc020570a:	8082                	ret

ffffffffc020570c <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc020570c:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0205710:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0205712:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0205714:	cb81                	beqz	a5,ffffffffc0205724 <strlen+0x18>
        cnt ++;
ffffffffc0205716:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0205718:	00a707b3          	add	a5,a4,a0
ffffffffc020571c:	0007c783          	lbu	a5,0(a5)
ffffffffc0205720:	fbfd                	bnez	a5,ffffffffc0205716 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0205726:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0205728:	e589                	bnez	a1,ffffffffc0205732 <strnlen+0xc>
ffffffffc020572a:	a811                	j	ffffffffc020573e <strnlen+0x18>
        cnt ++;
ffffffffc020572c:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020572e:	00f58863          	beq	a1,a5,ffffffffc020573e <strnlen+0x18>
ffffffffc0205732:	00f50733          	add	a4,a0,a5
ffffffffc0205736:	00074703          	lbu	a4,0(a4)
ffffffffc020573a:	fb6d                	bnez	a4,ffffffffc020572c <strnlen+0x6>
ffffffffc020573c:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020573e:	852e                	mv	a0,a1
ffffffffc0205740:	8082                	ret

ffffffffc0205742 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0205742:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0205744:	0005c703          	lbu	a4,0(a1)
ffffffffc0205748:	0785                	addi	a5,a5,1
ffffffffc020574a:	0585                	addi	a1,a1,1
ffffffffc020574c:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0205750:	fb75                	bnez	a4,ffffffffc0205744 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0205758:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc020575c:	cb89                	beqz	a5,ffffffffc020576e <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc020575e:	0505                	addi	a0,a0,1
ffffffffc0205760:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0205762:	fee789e3          	beq	a5,a4,ffffffffc0205754 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
...
ffffffffc0205770:	bfed                	j	ffffffffc020576a <strcmp+0x16>

ffffffffc0205772 <strncmp>:
...
ffffffffc0205772:	c20d                	beqz	a2,ffffffffc0205794 <strncmp+0x22>
ffffffffc0205774:	962e                	add	a2,a2,a1
ffffffffc0205776:	a031                	j	ffffffffc0205782 <strncmp+0x10>
        n --, s1 ++, s2 ++;
ffffffffc0205778:	0505                	addi	a0,a0,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc020577a:	00e79a63          	bne	a5,a4,ffffffffc020578e <strncmp+0x1c>
ffffffffc020577e:	00b60b63          	beq	a2,a1,ffffffffc0205794 <strncmp+0x22>
ffffffffc0205782:	00054783          	lbu	a5,0(a0)
        n --, s1 ++, s2 ++;
ffffffffc0205786:	0585                	addi	a1,a1,1
    while (n > 0 && *s1 != '\0' && *s1 == *s2) {
ffffffffc0205788:	fff5c703          	lbu	a4,-1(a1)
ffffffffc020578c:	f7f5                	bnez	a5,ffffffffc0205778 <strncmp+0x6>
    }
    return (n == 0) ? 0 : (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc020578e:	40e7853b          	subw	a0,a5,a4
}
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0205798:	00054783          	lbu	a5,0(a0)
ffffffffc020579c:	c799                	beqz	a5,ffffffffc02057aa <strchr+0x12>
        if (*s == c) {
ffffffffc020579e:	00f58763          	beq	a1,a5,ffffffffc02057ac <strchr+0x14>
    while (*s != '\0') {
ffffffffc02057a2:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02057a6:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02057a8:	fbfd                	bnez	a5,ffffffffc020579e <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02057ae:	ca01                	beqz	a2,ffffffffc02057be <memset+0x10>
ffffffffc02057b0:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02057b2:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02057b4:	0785                	addi	a5,a5,1
ffffffffc02057b6:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02057ba:	fec79de3          	bne	a5,a2,ffffffffc02057b4 <memset+0x6>
    }
    return s;
...
ffffffffc02057c0 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02057c0:	ca19                	beqz	a2,ffffffffc02057d6 <memcpy+0x16>
ffffffffc02057c2:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02057c4:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02057c6:	0005c703          	lbu	a4,0(a1)
ffffffffc02057ca:	0585                	addi	a1,a1,1
ffffffffc02057cc:	0785                	addi	a5,a5,1
ffffffffc02057ce:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02057d2:	fec59ae3          	bne	a1,a2,ffffffffc02057c6 <memcpy+0x6>
    }
    return dst;
